...
**TARGET FOLDER:** `Apex Arbitrage Multichain bot/config`
...
```powershell
try {
    $path = "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\Apex Arbitrage Multichain bot"
