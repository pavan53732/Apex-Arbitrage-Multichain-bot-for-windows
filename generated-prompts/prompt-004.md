...
- You MUST document all 118 files with 20-30 word descriptions
...
**TARGET FOLDER:** Apex Arbitrage Multichain bot\benchmarks
**FULL PATH:** C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\benchmarks
...
- **Reason:** Benchmarks folder contains performance testing and quality assurance files
- **Feature Type:** OWNER FEATURE
- **NO ANALYSIS REQUIRED** - Route directly to quality.md
...
5. ✅ Count existing "## Feature X:" headings in quality.md and use the next number
6. ✅ APPEND to quality.md ONLY
...
❌ Create new .md files (only append to quality.md)
❌ Create standalone documentation (append to quality.md)
...
```powershell
try {
    $path = "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\benchmarks"
...
Analyze all files in the benchmarks/ folder and prepare documentation for quality.md.
...
**After Writing Files:**
- [ ] quality.md updated with new feature
