...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard/plugins/social-impact/tests"
...
]*", "Recent Completions: Prompt 513 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 513/842") {
