...
```
dashboard\\plugins\\social-impact\\tests
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\plugins\\social-impact\\tests"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\plugins\\social-impact\\tests
