...
try {
    ...
    $targetPath = Join-Path $basePath "Apex Arbitrage Multichain bot/examples/simulation-runs"
...
Legacy Path: Apex Arbitrage multi-chain bot/Apex Arbitrage Multichain bot/Apex Arbitrage Multichain bot/examples/simulation-runs
...
PATH-TO-FEATURE MAPPER
Legacy Path: Apex Arbitrage multi-chain bot/Apex Arbitrage Multichain bot/examples/simulation-runs
