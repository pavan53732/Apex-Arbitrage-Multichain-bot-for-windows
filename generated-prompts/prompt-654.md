...
try {
    ...
    $targetPath = Join-Path $basePath "deploy/kubernetes/overlays/testnet"
...
]*", "Recent Completions: Prompt 654 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 654/842") {
