...
```
deploy\\kubernetes\\overlays\\testnet
```
...
try {
    ...
    $targetPath = Join-Path $basePath "deploy\\kubernetes\\overlays\\testnet"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\deploy\\kubernetes\\overlays\\testnet
