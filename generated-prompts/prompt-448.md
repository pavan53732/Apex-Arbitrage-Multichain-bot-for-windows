...
```
dashboard\\extensions\\integration
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\extensions\\integration"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\extensions\\integration
