...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard/deploy/terraform/scripts"
...
]*", "Recent Completions: Prompt 427 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 427/842") {
