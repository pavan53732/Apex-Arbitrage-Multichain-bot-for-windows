...
```
dashboard\\deploy\\ansible\\group\_vars
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\deploy\\ansible\\group\_vars"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\deploy\\ansible\\group\_vars
