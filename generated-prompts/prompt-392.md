...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard/deploy/ansible/group_vars"
...
]*", "Recent Completions: Prompt 392 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 392/842") {
