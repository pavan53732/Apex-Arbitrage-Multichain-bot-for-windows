...
```
dashboard\\data\\simulation-snapshots
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\data\\simulation-snapshots"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\data\\simulation-snapshots
