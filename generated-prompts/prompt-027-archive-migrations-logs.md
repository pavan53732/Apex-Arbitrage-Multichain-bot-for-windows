...
2. Search for "Prompt 027: Executed" in the Execution Log
...
Execute using executeBash tool:
```powershell
Get-ChildItem -Path "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\archive/migrations-logs" -Recurse -File | Select-Object FullName
```
...
Legacy Path: Apex Arbitrage multi-chain bot/archive/migrations-logs
...
4. Update "Recent Completions" to: Prompt 027 (Feature: [Feature Name])
5. Append to Execution Log:
   ```
   Prompt 027: Executed - Added 'Feature: [Feature Name]' to features/[owner].md
   ```
