...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard/plugins/intent-solvers/tests"
...
]*", "Recent Completions: Prompt 503 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 503/842") {
