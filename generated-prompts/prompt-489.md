...
```
dashboard\\plugins\\compliance\\docs
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\plugins\\compliance\\docs"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\plugins\\compliance\\docs
