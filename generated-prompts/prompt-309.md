...
```
dashboard\\ai\\models\\weights\\old-weights
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\ai\\models\\weights\\old-weights"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\ai\\models\\weights\\old-weights
