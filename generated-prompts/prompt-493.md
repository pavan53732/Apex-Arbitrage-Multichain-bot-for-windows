...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard/plugins/dex-adapters/tests"
...
]*", "Recent Completions: Prompt 493 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 493/842") {
