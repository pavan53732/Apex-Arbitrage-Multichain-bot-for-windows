...
```
backend\\plugins\\intent-solvers
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\plugins\\intent-solvers"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\plugins\\intent-solvers
