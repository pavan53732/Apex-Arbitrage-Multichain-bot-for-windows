...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard/api/routes/__mocks__"
...
]*", "Recent Completions: Prompt 335 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 335/842") {
