...
```
dashboard\\deploy\\terraform\\modules\\vpc
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\deploy\\terraform\\modules\\vpc"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\deploy\\terraform\\modules\\vpc
