...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard/deploy/terraform/modules/vpc"
...
]*", "Recent Completions: Prompt 426 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 426/842") {
