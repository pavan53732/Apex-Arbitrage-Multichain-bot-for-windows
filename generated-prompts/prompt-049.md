...
try {
    ...
    $targetPath = Join-Path $basePath "backend/core/tests"
...
$newContent = $progressContent -replace "Completed: \d+/842", "Completed: 049/842"
$newContent = $newContent -replace "Last Updated: [^
]*", "Last Updated: $(Get-Date -Format 'MMMM dd, yyyy')"
$newContent = $newContent -replace "Recent Completions: [^
]*", "Recent Completions: Prompt 049 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 049/842") {
