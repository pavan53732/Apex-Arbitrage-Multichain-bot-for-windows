...
```
vendor\\dex-liquidity-snapshots
```
...
try {
    ...
    $targetPath = Join-Path $basePath "vendor\\dex-liquidity-snapshots"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\vendor\\dex-liquidity-snapshots
