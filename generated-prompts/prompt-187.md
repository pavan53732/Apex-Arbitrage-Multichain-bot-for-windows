...
```
backend\\storage\\forensic-archive
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\storage\\forensic-archive"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\storage\\forensic-archive
