...
```
ai-modules\\models\\trainingOutputs
```
...
try {
    ...
    $targetPath = Join-Path $basePath "ai-modules\\models\\trainingOutputs"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\ai-modules\\models\\trainingOutputs
