...
- PowerShell will show you 36 files and 9 folders
- You MUST document all 36 files with 20-30 word descriptions
...
```powershell
try {
    $path = "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\migrations"
