...
2. Search for "Prompt 309: Executed" in the Execution Log
...
Execute using executeBash tool:
```powershell
Get-ChildItem -Path "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard/ai/models/weights/old-weights" -Recurse -File | Select-Object FullName
```
...
Legacy Path: Apex Arbitrage multi-chain bot/dashboard/ai/models/weights/old-weights
...
4. Update "Recent Completions" to: Prompt 309 (Feature: [Feature Name])
5. Append to Execution Log:
   ```
   Prompt 309: Executed - Added 'Feature: [Feature Name]' to features/[owner].md
   ```
