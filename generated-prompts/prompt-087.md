...
try {
    ...
    $targetPath = Join-Path $basePath "backend/engine/tests"
...
$newContent = $progressContent -replace "Completed: \d+/842", "Completed: 087/842"
$newContent = $newContent -replace "Last Updated: [^
]*", "Last Updated: $(Get-Date -Format 'MMMM dd, yyyy')"
$newContent = $newContent -replace "Recent Completions: [^
]*", "Recent Completions: Prompt 087 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 087/842") {
