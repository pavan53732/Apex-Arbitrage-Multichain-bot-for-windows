...
```
backend\\plugins\\alpha-signal\\tests
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\plugins\\alpha-signal\\tests"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\plugins\\alpha-signal\\tests
