...
```
backend\\engine\\data\\batch-logs
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\engine\\data\\batch-logs"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\engine\\data\\batch-logs
