...
try {
    ...
    $targetPath = Join-Path $basePath "backend/engine/tests/modules"
...
$newContent = $progressContent -replace "Completed: \d+/842", "Completed: 088/842"
$newContent = $newContent -replace "Last Updated: [^
]*", "Last Updated: $(Get-Date -Format 'MMMM dd, yyyy')"
$newContent = $newContent -replace "Recent Completions: [^
]*", "Recent Completions: Prompt 088 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 088/842") {
