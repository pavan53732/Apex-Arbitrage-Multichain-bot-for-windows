...
```
dashboard\\plugins\\alpha-signal
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\plugins\\alpha-signal"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\plugins\\alpha-signal
