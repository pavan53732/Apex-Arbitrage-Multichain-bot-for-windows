...
```
dashboard\\deploy\\ansible\\roles
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\deploy\\ansible\\roles"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\deploy\\ansible\\roles
