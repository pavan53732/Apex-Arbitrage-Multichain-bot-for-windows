...
```
dashboard\\deploy\\docker-compose
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\deploy\\docker-compose"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\deploy\\docker-compose
