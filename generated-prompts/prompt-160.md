...
```
backend\\plugins\\model-marketplace
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\plugins\\model-marketplace"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\plugins\\model-marketplace
