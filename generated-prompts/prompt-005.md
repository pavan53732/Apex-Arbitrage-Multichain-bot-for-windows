...
**ROUTING MODE:** FLOW-AWARE (Dashboard → Backend → CI)

**WHAT YOU MUST DO:**
1. ✅ Analyze ALL files under the target folder
2. ✅ Partition by OWNER and FLOW before writing
   - OWNER (ci → platform.md): list ONLY CI files as an owner feature in platform.md
   - FLOW (anchored in backend.md): list ONLY backend files; reference CI counts and links
