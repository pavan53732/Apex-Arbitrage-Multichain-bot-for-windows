...
```
deploy\\terraform\\modules\\storage
```
...
try {
    ...
    $targetPath = Join-Path $basePath "deploy\\terraform\\modules\\storage"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\deploy\\terraform\\modules\\storage
