...
try {
    ...
    $targetPath = Join-Path $basePath "deploy/terraform/modules/storage"
...
]*", "Recent Completions: Prompt 662 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 662/842") {
