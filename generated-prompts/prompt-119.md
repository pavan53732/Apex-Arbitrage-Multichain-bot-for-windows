...
try {
    ...
    $targetPath = Join-Path $basePath "backend/notebooks/explainability"
...
]*", "Recent Completions: Prompt 119 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 119/842") {
