...
```
dashboard\\analytics\\explainability
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\analytics\\explainability"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\analytics\\explainability
