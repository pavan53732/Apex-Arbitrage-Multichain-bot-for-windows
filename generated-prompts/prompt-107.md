...
```
backend\\migrations\\db\\rollback
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\migrations\\db\\rollback"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\migrations\\db\\rollback
