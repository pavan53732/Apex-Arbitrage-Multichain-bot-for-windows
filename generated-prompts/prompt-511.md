...
```
dashboard\\plugins\\social-impact
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\plugins\\social-impact"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\plugins\\social-impact
