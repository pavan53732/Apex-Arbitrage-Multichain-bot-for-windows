...
```
ai-modules\\models\\modelWeights
```
...
try {
    ...
    $targetPath = Join-Path $basePath "ai-modules\\models\\modelWeights"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\ai-modules\\models\\modelWeights
