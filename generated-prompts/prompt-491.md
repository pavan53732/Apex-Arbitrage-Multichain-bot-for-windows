...
```
dashboard\\plugins\\dex-adapters
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\plugins\\dex-adapters"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\plugins\\dex-adapters
