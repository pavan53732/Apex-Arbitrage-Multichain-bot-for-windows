...
try {
    ...
    $targetPath = Join-Path $basePath "Apex Arbitrage Multichain bot/tests/reports"
...
Legacy Path: Apex Arbitrage multi-chain bot/Apex Arbitrage Multichain bot/Apex Arbitrage Multichain bot/tests/reports
...
PATH-TO-FEATURE MAPPER
Legacy Path: Apex Arbitrage multi-chain bot/Apex Arbitrage Multichain bot/tests/reports
