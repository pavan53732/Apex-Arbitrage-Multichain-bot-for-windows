...
try {
    ...
    $targetPath = Join-Path $basePath "344. C:\\Users\\Pavan pc\\Desktop\\Apex Arbitrage Multichain bot for windows\\Apex-Arbitrage-Multichain-bot-for-windows\\Apex Arbitrage Multichain bot\\dashboard\\ar\\context"
...
$newContent = $progressContent -replace "Completed: \d+/842", "Completed: 344/842"
$newContent = $newContent -replace "Last Updated: [^\r\n]*", "Last Updated: $(Get-Date -Format 'MMMM dd, yyyy')"

# Add execution log entry
$logEntry = "`nPrompt 344: Executed - Added 'Feature: [Feature Name]' to features/[owner].md"
