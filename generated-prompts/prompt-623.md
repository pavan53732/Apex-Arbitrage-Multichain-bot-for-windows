...
```
data\\simulation-results\\mainnet-fork
```
...
try {
    ...
    $targetPath = Join-Path $basePath "data\\simulation-results\\mainnet-fork"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\data\\simulation-results\\mainnet-fork
