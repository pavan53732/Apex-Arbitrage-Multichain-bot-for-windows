...
`powershell
# Use executeBash tool with this EXACT PowerShell command:
try {
    ...
    $targetPath = Join-Path $basePath "[FOLDER-PATH-HERE]"
    ...
    $folders = Get-ChildItem -Path $targetPath -Recurse -Directory -Force
...
$logEntry = "
prompt-397: Executed - Added 'Feature: [Feature Name]' to features/[owner].md"
