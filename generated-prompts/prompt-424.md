...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard/deploy/terraform/modules/k8s"
...
]*", "Recent Completions: Prompt 424 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 424/842") {
