...
try {
    ...
    $targetPath = Join-Path $basePath "backend/tests/coverage/.nyc_output"
...
]*", "Recent Completions: Prompt 200 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 200/842") {
