...
- PowerShell will show you 38 files and 5 folders
- You MUST document all 38 files with 20-30 word descriptions
...
2. ✅ Partition by OWNER and FLOW before writing
   - OWNER (storage → backend.md): list ONLY storage files as an owner feature in backend.md
   - FLOW (anchored in backend.md): list ONLY backend files; reference Storage counts and links
