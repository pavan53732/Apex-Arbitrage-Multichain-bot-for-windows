...
```
archive\\docs\\deprecation-notices
```
...
try {
    ...
    $targetPath = Join-Path $basePath "archive\\docs\\deprecation-notices"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\archive\\docs\\deprecation-notices
