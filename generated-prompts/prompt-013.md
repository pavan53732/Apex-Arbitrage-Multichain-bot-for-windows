...
- **Reason:** Manifest folder contains application manifest files
- **Feature Type:** OWNER FEATURE
- **NO ANALYSIS REQUIRED** - Route directly to platform.md (Dashboard → Backend → Manifest)
...
Analyze all files in the manifest/ folder and prepare documentation for platform.md.
