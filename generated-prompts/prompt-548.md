...
```
dashboard\\tests\\coverage\\.nyc\_output
```
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\tests\\coverage\\.nyc\_output
