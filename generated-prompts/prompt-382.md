...
```
dashboard\\data\\compliance-archive
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\data\\compliance-archive"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\data\\compliance-archive
