...
```
backend\\plugins\\insurance\\docs
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\plugins\\insurance\\docs"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\plugins\\insurance\\docs
