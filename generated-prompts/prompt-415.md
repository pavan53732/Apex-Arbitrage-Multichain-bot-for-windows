...
try {
    ...
    $targetPath = Join-Path $basePath "Apex Arbitrage Multichain bot/dashboard/deploy/kubernetes/overlays/staging"
...
Legacy Path: Apex Arbitrage multi-chain bot/Apex Arbitrage Multichain bot/Apex Arbitrage Multichain bot/dashboard/deploy/kubernetes/overlays/staging
...
PATH-TO-FEATURE MAPPER
Legacy Path: Apex Arbitrage multi-chain bot/Apex Arbitrage Multichain bot/dashboard/deploy/kubernetes/overlays/staging
