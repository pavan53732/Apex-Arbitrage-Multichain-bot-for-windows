...
```
dashboard\\deploy\\kubernetes\\overlays\\staging
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\deploy\\kubernetes\\overlays\\staging"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\deploy\\kubernetes\\overlays\\staging
