...
- **Reason:** Data folder contains data storage, databases, and data management files
- **Feature Type:** OWNER FEATURE
- **NO ANALYSIS REQUIRED** - Route directly to platform.md
...
Analyze all files in the data/ folder and prepare documentation for platform.md.
