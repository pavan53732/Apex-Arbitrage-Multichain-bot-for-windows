...
- PowerShell will show you 153 files and 39 folders
- You MUST document all 153 files with 20-30 word descriptions
...
**TARGET FOLDER:** Apex Arbitrage Multichain bot\data
**FULL PATH:** C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\data
**ANALYSIS MODE:** PROJECT ANALYSIS
**ROUTING MODE:** FLOW-AWARE (Dashboard → Backend → Data)

**WHAT YOU MUST DO:**
1. ✅ Analyze ALL files under the target folder
2. ✅ Partition by OWNER and FLOW before writing
   - OWNER (data → platform.md): list ONLY data files as an owner feature in platform.md
   - FLOW (anchored in backend.md): list ONLY backend files; reference Data counts and links
...
```powershell
try {
    $path = "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\data"
