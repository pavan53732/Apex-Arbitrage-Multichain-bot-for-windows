...
- PowerShell will show you 53 files and 7 folders
- You MUST document all 53 files with 20-30 word descriptions
...
**TARGET FOLDER:** Apex Arbitrage Multichain bot\scripts
**FULL PATH:** C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\scripts
...
- **Reason:** Scripts folder contains automation and utility scripts
- **Feature Type:** OWNER FEATURE
- **NO ANALYSIS REQUIRED** - Route directly to platform.md (Dashboard → Backend → Scripts)

**WHAT YOU MUST DO:**
1. ✅ Analyze ALL files under the target folder
2. ✅ Partition by OWNER and FLOW before writing
   - OWNER (scripts → platform.md): list ONLY scripts files as an owner feature in platform.md
   - FLOW (anchored in backend.md): list ONLY backend files; reference Scripts counts and links
...
```powershell
try {
    $path = "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\scripts"
