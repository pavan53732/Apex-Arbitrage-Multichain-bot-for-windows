...
```
dashboard\\deploy\\ansible\\roles\\backend
```
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\deploy\\ansible\\roles\\backend
