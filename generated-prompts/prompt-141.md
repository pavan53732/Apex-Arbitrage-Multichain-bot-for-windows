...
try {
    ...
    $targetPath = Join-Path $basePath "backend/plugins/bridge-adapters/tests"
...
]*", "Recent Completions: Prompt 141 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 141/842") {
