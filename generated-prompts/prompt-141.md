...
```
backend\\plugins\\bridge-adapters\\tests
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\plugins\\bridge-adapters\\tests"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\plugins\\bridge-adapters\\tests
