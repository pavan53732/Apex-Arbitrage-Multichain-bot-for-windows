...
- PowerShell will show you 54 files and 10 folders
...
**ROUTING MODE:** FLOW-AWARE (Dashboard → Backend → AI Modules)

**WHAT YOU MUST DO:**
1. ✅ Analyze ALL files under the target folder
2. ✅ Partition by OWNER and FLOW before writing
   - OWNER (ai-modules → backend.md): list ONLY AI module files as an owner feature in backend.md
   - FLOW (anchored in backend.md): list ONLY backend files; reference AI Modules counts and links
