...
- PowerShell will show you 54 files
- You MUST document all 54 files with 20-30 word descriptions
...
**ROUTING MODE:** OWNER FEATURE (Pure Backend)

🔒 **HARDCODED ROUTING FOR THIS PATH:**
- **ALL FILES** in ai-modules/ → **backend.md**
- **REASON:** AI/ML modules are backend-owned components
- **FEATURE TYPE:** Owner Feature (single owner, no cross-references needed)
- **NO ANALYSIS REQUIRED:** Route everything to backend.md directly
...
5. ✅ Count existing "## Feature X:" headings in backend.md and use the next number
6. ✅ APPEND to backend.md file
...
- ✅ Write to backend.md (hardcoded routing)
...
2. **Count total files**
3. **Confirm routing: ALL files → backend.md**
4. **Proceed with documentation**

**ROUTING CONFIRMATION OUTPUT:**
```
ROUTING CONFIRMED:
- Target Path: ai-modules/
- Total Files: [Count from PowerShell]
- Destination: backend.md (AI/ML Backend Feature)
...
- "Which MD file OWNS this FEATURE?" → backend.md (AI/ML modules)
- "HOW TO IMPLEMENT" →
