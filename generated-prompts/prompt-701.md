...
try {
    ...
    $targetPath = Join-Path $basePath "Apex Arbitrage Multichain bot/manifest/inventory"
...
Legacy Path: Apex Arbitrage multi-chain bot/Apex Arbitrage Multichain bot/Apex Arbitrage Multichain bot/manifest/inventory
...
PATH-TO-FEATURE MAPPER
Legacy Path: Apex Arbitrage multi-chain bot/Apex Arbitrage Multichain bot/manifest/inventory
