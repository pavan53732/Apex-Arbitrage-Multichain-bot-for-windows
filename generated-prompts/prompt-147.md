...
```
backend\\plugins\\dex-adapters\\tests
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\\plugins\\dex-adapters\\tests"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\\plugins\\dex-adapters\\tests
