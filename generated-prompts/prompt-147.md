...
try {
    ...
    $targetPath = Join-Path $basePath "backend/plugins/dex-adapters/tests"
...
]*", "Recent Completions: Prompt 147 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 147/842") {
