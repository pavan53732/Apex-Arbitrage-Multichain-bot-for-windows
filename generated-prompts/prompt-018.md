...
- PowerShell will show you 68 files and 11 folders
- You MUST document all 68 files with 20-30 word descriptions
...
**TARGET FOLDER:** Apex Arbitrage Multichain bot\research
**FULL PATH:** C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\research
...
- **Reason:** Research folder contains documentation and research materials
- **Feature Type:** OWNER FEATURE
- **NO ANALYSIS REQUIRED** - Route directly to platform.md (Dashboard → Backend → Research)

**WHAT YOU MUST DO:**
1. ✅ Analyze ALL files under the target folder
2. ✅ Partition by OWNER and FLOW before writing
   - OWNER (research → platform.md): list ONLY research files as an owner feature in platform.md
   - FLOW (anchored in backend.md): list ONLY backend files; reference Research counts and links
...
```powershell
try {
    $path = "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\research"
