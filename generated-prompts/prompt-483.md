...
```
dashboard\\plugins\\alpha-signal\\docs
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\\plugins\\alpha-signal\\docs"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\\plugins\\alpha-signal\\docs
