...
```
data\\backups\\compliance-snapshots
```
...
try {
    ...
    $targetPath = Join-Path $basePath "data\\backups\\compliance-snapshots"
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\data\\backups\\compliance-snapshots
