...
try {
    ...
    $targetPath = Join-Path $basePath "backend/contracts/src/test"
...
$newContent = $progressContent -replace "Completed: \d+/842", "Completed: 043/842"
$newContent = $newContent -replace "Last Updated: [^
]*", "Last Updated: $(Get-Date -Format 'MMMM dd, yyyy')"
$newContent = $newContent -replace "Recent Completions: [^
]*", "Recent Completions: Prompt 043 (Feature: [Feature Name])"
...
if ($verifyContent -match "Completed: 043/842") {
