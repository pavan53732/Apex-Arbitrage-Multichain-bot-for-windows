...
- PowerShell will show you 29 files and 4 folders
- You MUST document all 29 files with 20-30 word descriptions
...
2. ✅ Partition by OWNER and FLOW before writing
   - OWNER (wall-of-fame → platform.md): list ONLY wall-of-fame files as an owner feature in platform.md
   - FLOW (anchored in backend.md): list ONLY backend files; reference Wall-of-Fame counts and links
...
```powershell
try {
    $path = "C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\wall-of-fame"
...
- In quality.md: "Backend tests → see backend.md for tested components"
...
| Security | security/, auth/, encryption/ | quality.md | Security and authentication |
| Documentation | docs/, *.md, README* | platform.md | Project documentation |
