...
owner: AI Team
version: 1.0.0
canonical_source: docs/product-specification/ai/memory/context-priority-matrix.md
related_concepts:
  - CONCEPT-0108
dependencies: []
consumers: []
...
Context segments are injected in strict order (see `../prompts/prompt-lifecycle.md` for assembly pipeline):
