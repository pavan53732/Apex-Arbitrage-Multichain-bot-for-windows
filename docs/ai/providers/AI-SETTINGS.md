...
canonical_source: docs/ai/providers/AI-SETTINGS.md
---
...
- Provider enablement, ordering, and cost caps must match `ai/runtime/AI-PIPELINE.md` and `CLOUD-AI-INTEGRATION.md`.
...
## Validation
- Validate provider enablement against `ai/providers/AI-PROVIDER-MANAGER.md`.
...
- Provider lifecycle details remain owned by `ai/providers/AI-PROVIDER-MANAGER.md`.
