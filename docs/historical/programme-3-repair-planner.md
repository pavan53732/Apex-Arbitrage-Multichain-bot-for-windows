...
title: Programme 3 Repair Planner
...
- Root: `../product-specification/ai/orchestration/ai-orchestration.md`.
- Dimension: `EVENT`.
- Document: `../product-specification/ai/runtime/ai-gateway.md`.
