...
title: Github Copilot Cli Agent Profile
...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/github-copilot-cli.md
related_concepts:
  - CONCEPT-0029
dependencies:
  - DOC-0001
...
type: REFERENCE
purpose: GITHUB-COPILOT-CLI AI tool documentation.
scope: GITHUB-COPILOT-CLI reference.
---
...
## Purpose
Guidance for GITHUB COPILOT CLI coding agents contributing to this repository.
