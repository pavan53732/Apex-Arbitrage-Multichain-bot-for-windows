...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/aider.md
related_concepts:
  - CONCEPT-0020
dependencies:
  - DOC-0001
...
## Purpose
Guidance for AIDER-based coding agents contributing to this repository.
