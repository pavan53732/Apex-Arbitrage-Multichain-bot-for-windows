...
title: Perplexity Agent Profile
...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/perplexity.md
related_concepts:
  - CONCEPT-0035
dependencies:
  - DOC-0001
...
type: REFERENCE
purpose: PERPLEXITY AI tool documentation.
scope: PERPLEXITY reference.
---
...
## Purpose
Guidance for PERPLEXITY coding agents contributing to this repository.
