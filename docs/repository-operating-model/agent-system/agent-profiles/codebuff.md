...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/codebuff.md
related_concepts:
  - CONCEPT-0025
dependencies:
  - DOC-0001
...
type: REFERENCE
purpose: CODEBUFF AI tool documentation.
scope: CODEBUFF reference.
---
...
## Purpose
Guidance for CODEBUFF-based coding agents contributing to this repository.
