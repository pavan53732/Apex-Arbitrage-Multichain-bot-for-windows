...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/qwen.md
related_concepts:
  - CONCEPT-0037
dependencies:
  - DOC-0001
...
type: REFERENCE
purpose: QWEN AI tool documentation.
scope: QWEN reference.
---
...
## Purpose
Guidance for QWEN coding agents contributing to this repository.
