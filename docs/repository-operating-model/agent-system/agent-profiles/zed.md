...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/zed.md
related_concepts:
  - CONCEPT-0043
dependencies:
  - DOC-0001
...
type: REFERENCE
purpose: ZED AI tool documentation.
scope: ZED reference.
---
...
## Purpose
Guidance for ZED-based coding agents contributing to this repository.
