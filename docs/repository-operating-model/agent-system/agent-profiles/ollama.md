...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/ollama.md
related_concepts:
  - CONCEPT-0033
dependencies:
  - DOC-0001
...
## Purpose
Guidance for OLLAMA coding agents contributing to this repository.
