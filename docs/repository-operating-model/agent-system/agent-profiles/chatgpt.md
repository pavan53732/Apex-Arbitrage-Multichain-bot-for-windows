...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/chatgpt.md
related_concepts:
  - CONCEPT-0022
dependencies:
  - DOC-0001
...
## Purpose
Guidance for CHATGPT coding agents contributing to this repository.
