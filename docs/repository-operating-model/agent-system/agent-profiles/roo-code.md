...
owner: AI Team
version: 1.0.0
canonical_source: docs/repository-operating-model/agent-system/agent-profiles/roo-code.md
related_concepts:
  - CONCEPT-0039
dependencies:
  - DOC-0001
...
type: REFERENCE
purpose: ROO-CODE AI tool documentation.
scope: ROO-CODE reference.
---
...
## Purpose
Guidance for ROO CODE-based coding agents contributing to this repository.
