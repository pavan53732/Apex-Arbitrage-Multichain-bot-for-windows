...
document_id: DOC-0057
title: Documentation Status Review Workflow
...
version: 1.0.0
canonical_source: docs/repository-operating-model/documentation-lifecycle/documentation-status-review-workflow.md
related_concepts:
  - CONCEPT-0057
dependencies: []
consumers: []
...
## Version
**Version:** 1.0.0 | **Status:** Active | **Last Updated:** 2026-07-27 | **Owner:** Architecture Team
...
stateDiagram-v2
  ...
  APPROVED --> ACTIVE: publication accepted
  REVIEW --> DRAFT: review rejected (needs revision)
  ACTIVE --> DEPRECATED: superseded by new document
  ACTIVE --> ACTIVE: substantive update (version bump)
...
| **Active** | Approved and active; authority is recorded separately as Canonical, Derived, Reference, Historical, or Generated | Yes (with version bump) | Architecture owner | Yes (for substantive changes) |
...
| **Status** | Yes | `Draft`, `Review`, `Approved`, `Active`, `Deprecated`, `Archived`, `Superseded`, `Experimental` | Current lifecycle status |
...
4. If all gates pass → Status: Active (document unlocked for future MINOR/PATCH).
