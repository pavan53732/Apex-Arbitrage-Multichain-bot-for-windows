...
owner: Runtime Team
version: 1.0.0
canonical_source: docs/apex-app-docs/windows/WINDOWS-DESKTOP-ENHANCED.md
related_concepts:
  - CONCEPT-0398
dependencies: []
consumers: []
...
1. **Project-Level**: docs/apex-app-docs/reference/enhancements/APEX-ENHANCEMENT-SUMMARY.md (this file)
