...
owner: Runtime Team
version: 1.0.0
canonical_source: docs/apex-app-docs/ai/memory/ai-memory-system.md
related_concepts:
  - CONCEPT-0120
dependencies:
  - DOC-0120
...
2. AI context window flushed to archive (see `../prompts/prompt-lifecycle.md`).
