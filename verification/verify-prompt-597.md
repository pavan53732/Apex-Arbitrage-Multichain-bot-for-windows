# Verification Prompt for Prompt 597

## Your Task: Verify Execution of Prompt 597

You are verifying that **Prompt 597** was executed correctly.

### What Prompt 597 Should Have Done:

**Folder Analyzed:** `data\\analytics\\performance`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 597:"
```
**Expected:** Should find entry like "Prompt 597: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\analytics\\performance`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Performance"
```
**Expected:** Should find feature section with name containing "Performance"
...
```
VERIFICATION REPORT - PROMPT 597
================================
...
Confirm: "Prompt 597 executed correctly. Ready for Prompt 598."
