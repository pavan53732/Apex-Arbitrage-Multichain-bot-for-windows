# Verification for Prompt 597

## Task: Verify that Prompt 597 executed correctly

**Folder that was processed:** `data\\analytics\\performance`
...
- Does it contain "Prompt 597: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\analytics\\performance`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 597: Executed"
...
## If PASSED
Say: "✅ Prompt 597 verified successfully. Ready for Prompt 598."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 597.
