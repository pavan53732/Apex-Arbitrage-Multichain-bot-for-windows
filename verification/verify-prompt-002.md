...
## Task: Verify that Prompt 2 executed correctly

**Folder that was processed:** `ai-modules\\datasets`
...
- Does it contain "Prompt 2: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules\\datasets`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 2: Executed"
...
## If PASSED
Say: "✅ Prompt 2 verified successfully. Ready for Prompt 3."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 2.
