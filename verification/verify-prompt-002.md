# Verification Prompt for Prompt 2

## Your Task: Verify Execution of Prompt 2

You are verifying that **Prompt 2** was executed correctly.

### What Prompt 2 Should Have Done:

**Folder Analyzed:** `ai-modules\\datasets`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 2:"
```
**Expected:** Should find entry like "Prompt 2: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ai-modules\\datasets`, determine which .md file should own this feature:
...
Confirm: "Prompt 2 executed correctly. Ready for Prompt 3."
