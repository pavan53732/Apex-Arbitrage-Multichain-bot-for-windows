# Verification for Prompt 738

## Task: Verify that Prompt 738 executed correctly

**Folder that was processed:** `presets\\operator`
...
- Does it contain "Prompt 738: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `presets\\operator`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 738: Executed"
...
## If PASSED
Say: "✅ Prompt 738 verified successfully. Ready for Prompt 739."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 738.
