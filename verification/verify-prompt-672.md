# Verification for Prompt 672

## Task: Verify that Prompt 672 executed correctly

**Folder that was processed:** `docs\\onboarding`
...
- Does it contain "Prompt 672: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `docs\\onboarding`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 672: Executed"
...
## If PASSED
Say: "✅ Prompt 672 verified successfully. Ready for Prompt 673."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 672.
