# Verification for Prompt 774

## Task: Verify that Prompt 774 executed correctly

**Folder that was processed:** `scripts\\quickstart`
...
- Does it contain "Prompt 774: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `scripts\\quickstart`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 774: Executed"
...
## If PASSED
Say: "✅ Prompt 774 verified successfully. Ready for Prompt 775."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 774.
