# Verification for Prompt 261

## Task: Verify that Prompt 261 executed correctly

**Folder that was processed:** `config`
...
- Does it contain "Prompt 261: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 261: Executed"
...
## If PASSED
Say: "✅ Prompt 261 verified successfully. Ready for Prompt 262."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 261.
