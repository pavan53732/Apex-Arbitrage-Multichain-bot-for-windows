# Verification Prompt for Prompt 311

## Your Task: Verify Execution of Prompt 311

You are verifying that **Prompt 311** was executed correctly.

### What Prompt 311 Should Have Done:

**Folder Analyzed:** `dashboard\\ai\\scoring`
**Expected Feature Name:** `Scoring`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 311:"
```
**Expected:** Should find entry like "Prompt 311: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\ai\\scoring`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Scoring"
```
**Expected:** Should find feature section with name containing "Scoring"
...
```
VERIFICATION REPORT - PROMPT 311
================================
...
Confirm: "Prompt 311 executed correctly. Ready for Prompt 312."
