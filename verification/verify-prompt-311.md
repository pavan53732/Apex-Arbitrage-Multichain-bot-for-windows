# Verification for Prompt 311

## Task: Verify that Prompt 311 executed correctly

**Folder that was processed:** `dashboard\\ai\\scoring`
...
- Does it contain "Prompt 311: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\scoring`, determine the owner:
...
- Does the feature name match or relate to "Scoring"?
...
✅/❌ Progress.md contains "Prompt 311: Executed"
...
## If PASSED
Say: "✅ Prompt 311 verified successfully. Ready for Prompt 312."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 311.
