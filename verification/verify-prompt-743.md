# Verification for Prompt 743

## Task: Verify that Prompt 743 executed correctly

**Folder that was processed:** `public`
...
- Does it contain "Prompt 743: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `public`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 743: Executed"
...
## If PASSED
Say: "✅ Prompt 743 verified successfully. Ready for Prompt 744."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 743.
