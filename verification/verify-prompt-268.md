# Verification for Prompt 268

## Task: Verify that Prompt 268 executed correctly

**Folder that was processed:** `config\\custom`
...
- Does it contain "Prompt 268: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\custom`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 268: Executed"
...
## If PASSED
Say: "✅ Prompt 268 verified successfully. Ready for Prompt 269."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 268.
