# Verification for Prompt 394

## Task: Verify that Prompt 394 executed correctly

**Folder that was processed:** `dashboard\\deploy\\ansible\\roles\\ai-modules`
...
- Does it contain "Prompt 394: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\ansible\\roles\\ai-modules`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 394: Executed"
...
## If PASSED
Say: "✅ Prompt 394 verified successfully. Ready for Prompt 395."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 394.
