...
## Task: Verify that Prompt 1 executed correctly
...
- Does it contain "Prompt 1: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 1: Executed"
...
## If PASSED
Say: "✅ Prompt 1 verified successfully. Ready for Prompt 2."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 1.
