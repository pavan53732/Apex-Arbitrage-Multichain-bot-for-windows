# Verification Prompt for Prompt 635

## Your Task: Verify Execution of Prompt 635

You are verifying that **Prompt 635** was executed correctly.

### What Prompt 635 Should Have Done:

**Folder Analyzed:** `deploy\\ansible\\roles\\backend`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 635:"
```
**Expected:** Should find entry like "Prompt 635: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `deploy\\ansible\\roles\\backend`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 635
================================
...
Confirm: "Prompt 635 executed correctly. Ready for Prompt 636."
