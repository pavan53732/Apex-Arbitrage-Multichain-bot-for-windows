# Verification Prompt for Prompt 625

## Your Task: Verify Execution of Prompt 625

You are verifying that **Prompt 625** was executed correctly.

### What Prompt 625 Should Have Done:

**Folder Analyzed:** `data\\simulation-results\\scenarios`
**Expected Feature Name:** `Scenarios`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 625:"
```
**Expected:** Should find entry like "Prompt 625: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\simulation-results\\scenarios`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Scenarios"
```
**Expected:** Should find feature section with name containing "Scenarios"
...
```
VERIFICATION REPORT - PROMPT 625
================================
...
Confirm: "Prompt 625 executed correctly. Ready for Prompt 626."
