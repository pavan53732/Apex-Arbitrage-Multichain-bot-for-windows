# Verification for Prompt 436

## Task: Verify that Prompt 436 executed correctly

**Folder that was processed:** `dashboard\\docs\\legacy`
...
- Does it contain "Prompt 436: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\docs\\legacy`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 436: Executed"
...
## If PASSED
Say: "✅ Prompt 436 verified successfully. Ready for Prompt 437."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 436.
