# Verification for Prompt 638

## Task: Verify that Prompt 638 executed correctly

**Folder that was processed:** `deploy\\ansible\\scripts`
...
- Does it contain "Prompt 638: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\ansible\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 638: Executed"
...
## If PASSED
Say: "✅ Prompt 638 verified successfully. Ready for Prompt 639."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 638.
