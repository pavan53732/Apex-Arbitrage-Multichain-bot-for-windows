# Verification for Prompt 665

## Task: Verify that Prompt 665 executed correctly

**Folder that was processed:** `docs`
...
- Does it contain "Prompt 665: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 665: Executed"
...
## If PASSED
Say: "✅ Prompt 665 verified successfully. Ready for Prompt 666."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 665.
