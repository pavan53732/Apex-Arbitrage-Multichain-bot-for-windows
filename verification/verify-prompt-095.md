# Verification for Prompt 95

## Task: Verify that Prompt 95 executed correctly

**Folder that was processed:** `backend\\examples\\mainnet-tx-samples`
...
- Does it contain "Prompt 95: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\examples\\mainnet-tx-samples`, determine the owner:
...
- Does the feature name match or relate to "Mainnet Tx Samples"?
...
✅/❌ Progress.md contains "Prompt 95: Executed"
...
## If PASSED
Say: "✅ Prompt 95 verified successfully. Ready for Prompt 96."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 95.
