# Verification Prompt for Prompt 95

## Your Task: Verify Execution of Prompt 95

You are verifying that **Prompt 95** was executed correctly.

### What Prompt 95 Should Have Done:

**Folder Analyzed:** `backend\\examples\\mainnet-tx-samples`
**Expected Feature Name:** `Mainnet Tx Samples`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 95:"
```
**Expected:** Should find entry like "Prompt 95: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\examples\\mainnet-tx-samples`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Mainnet Tx Samples"
```
**Expected:** Should find feature section with name containing "Mainnet Tx Samples"
...
Confirm: "Prompt 95 executed correctly. Ready for Prompt 96."
