# Verification for Prompt 15

## Task: Verify that Prompt 15 executed correctly

**Folder that was processed:** `archive\\deprecated-modules`
...
- Does it contain "Prompt 15: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\deprecated-modules`, determine the owner:
...
- Does the feature name match or relate to "Deprecated Modules"?
...
✅/❌ Progress.md contains "Prompt 15: Executed"
...
## If PASSED
Say: "✅ Prompt 15 verified successfully. Ready for Prompt 16."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 15.
