# Verification Prompt for Prompt 15

## Your Task: Verify Execution of Prompt 15

You are verifying that **Prompt 15** was executed correctly.

### What Prompt 15 Should Have Done:

**Folder Analyzed:** `archive\\deprecated-modules`
**Expected Feature Name:** `Deprecated Modules`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 15:"
```
**Expected:** Should find entry like "Prompt 15: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\deprecated-modules`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Deprecated Modules"
```
**Expected:** Should find feature section with name containing "Deprecated Modules"
...
Confirm: "Prompt 15 executed correctly. Ready for Prompt 16."
