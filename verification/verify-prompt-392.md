# Verification for Prompt 392

## Task: Verify that Prompt 392 executed correctly

**Folder that was processed:** `dashboard\\deploy\\ansible\\group\_vars`
...
- Does it contain "Prompt 392: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\ansible\\group\_vars`, determine the owner:
...
- Does the feature name match or relate to "Group\ Vars"?
...
✅/❌ Progress.md contains "Prompt 392: Executed"
...
## If PASSED
Say: "✅ Prompt 392 verified successfully. Ready for Prompt 393."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 392.
