# Verification Prompt for Prompt 392

## Your Task: Verify Execution of Prompt 392

You are verifying that **Prompt 392** was executed correctly.

### What Prompt 392 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\ansible\\group\_vars`
**Expected Feature Name:** `Group\ Vars`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 392:"
```
**Expected:** Should find entry like "Prompt 392: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\ansible\\group\_vars`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Group\ Vars"
```
**Expected:** Should find feature section with name containing "Group\ Vars"
...
```
VERIFICATION REPORT - PROMPT 392
================================
...
Confirm: "Prompt 392 executed correctly. Ready for Prompt 393."
