# Verification for Prompt 33

## Task: Verify that Prompt 33 executed correctly

**Folder that was processed:** `backend\\contracts\\docs`
...
- Does it contain "Prompt 33: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\contracts\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 33: Executed"
...
## If PASSED
Say: "✅ Prompt 33 verified successfully. Ready for Prompt 34."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 33.
