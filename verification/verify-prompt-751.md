# Verification for Prompt 751

## Task: Verify that Prompt 751 executed correctly

**Folder that was processed:** `public\\icons\\ui`
...
- Does it contain "Prompt 751: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `public\\icons\\ui`, determine the owner:
...
- Does the feature name match or relate to "Ui"?
...
✅/❌ Progress.md contains "Prompt 751: Executed"
...
## If PASSED
Say: "✅ Prompt 751 verified successfully. Ready for Prompt 752."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 751.
