# Verification for Prompt 595

## Task: Verify that Prompt 595 executed correctly

**Folder that was processed:** `data\\analytics\\anomaly`
...
- Does it contain "Prompt 595: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\analytics\\anomaly`, determine the owner:
...
- Does the feature name match or relate to "Anomaly"?
...
✅/❌ Progress.md contains "Prompt 595: Executed"
...
## If PASSED
Say: "✅ Prompt 595 verified successfully. Ready for Prompt 596."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 595.
