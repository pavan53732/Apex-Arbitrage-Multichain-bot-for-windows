# Verification Prompt for Prompt 595

## Your Task: Verify Execution of Prompt 595

You are verifying that **Prompt 595** was executed correctly.

### What Prompt 595 Should Have Done:

**Folder Analyzed:** `data\\analytics\\anomaly`
**Expected Feature Name:** `Anomaly`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 595:"
```
**Expected:** Should find entry like "Prompt 595: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\analytics\\anomaly`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Anomaly"
```
**Expected:** Should find feature section with name containing "Anomaly"
...
```
VERIFICATION REPORT - PROMPT 595
================================
...
Confirm: "Prompt 595 executed correctly. Ready for Prompt 596."
