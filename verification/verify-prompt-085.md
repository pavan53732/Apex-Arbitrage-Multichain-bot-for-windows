# Verification Prompt for Prompt 85

## Your Task: Verify Execution of Prompt 85

You are verifying that **Prompt 85** was executed correctly.

### What Prompt 85 Should Have Done:

**Folder Analyzed:** `backend\\engine\\jobs`
**Expected Feature Name:** `Jobs`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 85:"
```
**Expected:** Should find entry like "Prompt 85: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\engine\\jobs`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Jobs"
```
**Expected:** Should find feature section with name containing "Jobs"
...
Confirm: "Prompt 85 executed correctly. Ready for Prompt 86."
