# Verification Prompt for Prompt 220

## Your Task: Verify Execution of Prompt 220

You are verifying that **Prompt 220** was executed correctly.

### What Prompt 220 Should Have Done:

**Folder Analyzed:** `backend\\watchdog\\data`
**Expected Feature Name:** `Data`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 220:"
```
**Expected:** Should find entry like "Prompt 220: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\watchdog\\data`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Data"
```
**Expected:** Should find feature section with name containing "Data"
...
```
VERIFICATION REPORT - PROMPT 220
================================
...
Confirm: "Prompt 220 executed correctly. Ready for Prompt 221."
