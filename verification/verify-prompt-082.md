# Verification for Prompt 82

## Task: Verify that Prompt 82 executed correctly

**Folder that was processed:** `backend\\engine\\data\\snapshots`
...
- Does it contain "Prompt 82: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\engine\\data\\snapshots`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 82: Executed"
...
## If PASSED
Say: "✅ Prompt 82 verified successfully. Ready for Prompt 83."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 82.
