# Verification for Prompt 30

## Task: Verify that Prompt 30 executed correctly
...
- Does it contain "Prompt 30: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 30: Executed"
...
## If PASSED
Say: "✅ Prompt 30 verified successfully. Ready for Prompt 31."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 30.
