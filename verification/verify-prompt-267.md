# Verification for Prompt 267

## Task: Verify that Prompt 267 executed correctly

**Folder that was processed:** `config\\compliance`
...
- Does it contain "Prompt 267: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\compliance`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 267: Executed"
...
## If PASSED
Say: "✅ Prompt 267 verified successfully. Ready for Prompt 268."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 267.
