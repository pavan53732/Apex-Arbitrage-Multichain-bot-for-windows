# Verification Prompt for Prompt 238

## Your Task: Verify Execution of Prompt 238

You are verifying that **Prompt 238** was executed correctly.

### What Prompt 238 Should Have Done:

**Folder Analyzed:** `benchmarks\\results`
**Expected Feature Name:** `Results`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 238:"
```
**Expected:** Should find entry like "Prompt 238: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `benchmarks\\results`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Results"
```
**Expected:** Should find feature section with name containing "Results"
...
```
VERIFICATION REPORT - PROMPT 238
================================
...
Confirm: "Prompt 238 executed correctly. Ready for Prompt 239."
