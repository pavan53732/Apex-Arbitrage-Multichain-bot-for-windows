# Verification for Prompt 238

## Task: Verify that Prompt 238 executed correctly

**Folder that was processed:** `benchmarks\\results`
...
- Does it contain "Prompt 238: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `benchmarks\\results`, determine the owner:
...
- Does the feature name match or relate to "Results"?
...
✅/❌ Progress.md contains "Prompt 238: Executed"
...
## If PASSED
Say: "✅ Prompt 238 verified successfully. Ready for Prompt 239."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 238.
