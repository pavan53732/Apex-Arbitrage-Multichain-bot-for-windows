# Verification for Prompt 612

## Task: Verify that Prompt 612 executed correctly

**Folder that was processed:** `data\\forensics`
...
- Does it contain "Prompt 612: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\forensics`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 612: Executed"
...
## If PASSED
Say: "✅ Prompt 612 verified successfully. Ready for Prompt 613."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 612.
