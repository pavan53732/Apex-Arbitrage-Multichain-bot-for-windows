# Verification for Prompt 396

## Task: Verify that Prompt 396 executed correctly

**Folder that was processed:** `dashboard\\deploy\\ansible\\roles\\ai-modules\\dashboard`
...
- Does it contain "Prompt 396: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\ansible\\roles\\ai-modules\\dashboard`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 396: Executed"
...
## If PASSED
Say: "✅ Prompt 396 verified successfully. Ready for Prompt 397."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 396.
