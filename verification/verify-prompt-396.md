# Verification Prompt for Prompt 396

## Your Task: Verify Execution of Prompt 396

You are verifying that **Prompt 396** was executed correctly.

### What Prompt 396 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\ansible\\roles\\ai-modules\\dashboard`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 396:"
```
**Expected:** Should find entry like "Prompt 396: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\ansible\\roles\\ai-modules\\dashboard`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 396
================================
...
Confirm: "Prompt 396 executed correctly. Ready for Prompt 397."
