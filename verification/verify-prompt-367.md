# Verification Prompt for Prompt 367

## Your Task: Verify Execution of Prompt 367

You are verifying that **Prompt 367** was executed correctly.

### What Prompt 367 Should Have Done:

**Folder Analyzed:** `dashboard\\components\\loaders`
**Expected Feature Name:** `Loaders`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 367:"
```
**Expected:** Should find entry like "Prompt 367: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\components\\loaders`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Loaders"
```
**Expected:** Should find feature section with name containing "Loaders"
...
```
VERIFICATION REPORT - PROMPT 367
================================
...
Confirm: "Prompt 367 executed correctly. Ready for Prompt 368."
