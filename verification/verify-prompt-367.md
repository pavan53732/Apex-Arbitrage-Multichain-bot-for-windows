# Verification for Prompt 367

## Task: Verify that Prompt 367 executed correctly

**Folder that was processed:** `dashboard\\components\\loaders`
...
- Does it contain "Prompt 367: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\loaders`, determine the owner:
...
- Does the feature name match or relate to "Loaders"?
...
✅/❌ Progress.md contains "Prompt 367: Executed"
...
## If PASSED
Say: "✅ Prompt 367 verified successfully. Ready for Prompt 368."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 367.
