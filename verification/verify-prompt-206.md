# Verification for Prompt 206

## Task: Verify that Prompt 206 executed correctly

**Folder that was processed:** `backend\\tests\\legacy`
...
- Does it contain "Prompt 206: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\tests\\legacy`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 206: Executed"
...
## If PASSED
Say: "✅ Prompt 206 verified successfully. Ready for Prompt 207."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 206.
