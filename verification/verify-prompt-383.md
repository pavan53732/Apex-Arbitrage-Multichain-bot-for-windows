# Verification Prompt for Prompt 383

## Your Task: Verify Execution of Prompt 383

You are verifying that **Prompt 383** was executed correctly.

### What Prompt 383 Should Have Done:

**Folder Analyzed:** `dashboard\\data\\export`
**Expected Feature Name:** `Export`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 383:"
```
**Expected:** Should find entry like "Prompt 383: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\data\\export`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Export"
```
**Expected:** Should find feature section with name containing "Export"
...
```
VERIFICATION REPORT - PROMPT 383
================================
...
Confirm: "Prompt 383 executed correctly. Ready for Prompt 384."
