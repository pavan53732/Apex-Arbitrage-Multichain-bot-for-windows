# Verification for Prompt 383

## Task: Verify that Prompt 383 executed correctly

**Folder that was processed:** `dashboard\\data\\export`
...
- Does it contain "Prompt 383: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\export`, determine the owner:
...
- Does the feature name match or relate to "Export"?
...
✅/❌ Progress.md contains "Prompt 383: Executed"
...
## If PASSED
Say: "✅ Prompt 383 verified successfully. Ready for Prompt 384."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 383.
