# Verification for Prompt 724

## Task: Verify that Prompt 724 executed correctly

**Folder that was processed:** `overlays\\incident`
...
- Does it contain "Prompt 724: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `overlays\\incident`, determine the owner:
...
- Does the feature name match or relate to "Incident"?
...
✅/❌ Progress.md contains "Prompt 724: Executed"
...
## If PASSED
Say: "✅ Prompt 724 verified successfully. Ready for Prompt 725."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 724.
