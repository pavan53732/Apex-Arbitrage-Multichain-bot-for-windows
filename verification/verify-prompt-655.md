# Verification for Prompt 655

## Task: Verify that Prompt 655 executed correctly

**Folder that was processed:** `deploy\\migration`
...
- Does it contain "Prompt 655: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\migration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 655: Executed"
...
## If PASSED
Say: "✅ Prompt 655 verified successfully. Ready for Prompt 656."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 655.
