# Verification for Prompt 564

## Task: Verify that Prompt 564 executed correctly

**Folder that was processed:** `dashboard\\tests\\runner`
...
- Does it contain "Prompt 564: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\runner`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 564: Executed"
...
## If PASSED
Say: "✅ Prompt 564 verified successfully. Ready for Prompt 565."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 564.
