# Verification for Prompt 583

## Task: Verify that Prompt 583 executed correctly

**Folder that was processed:** `dashboard\\utils`
...
- Does it contain "Prompt 583: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\utils`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 583: Executed"
...
## If PASSED
Say: "✅ Prompt 583 verified successfully. Ready for Prompt 584."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 583.
