# Verification for Prompt 445

## Task: Verify that Prompt 445 executed correctly

**Folder that was processed:** `dashboard\\extensions\\community`
...
- Does it contain "Prompt 445: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\extensions\\community`, determine the owner:
...
- Does the feature name match or relate to "Community"?
...
✅/❌ Progress.md contains "Prompt 445: Executed"
...
## If PASSED
Say: "✅ Prompt 445 verified successfully. Ready for Prompt 446."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 445.
