# Verification Prompt for Prompt 445

## Your Task: Verify Execution of Prompt 445

You are verifying that **Prompt 445** was executed correctly.

### What Prompt 445 Should Have Done:

**Folder Analyzed:** `dashboard\\extensions\\community`
**Expected Feature Name:** `Community`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 445:"
```
**Expected:** Should find entry like "Prompt 445: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\extensions\\community`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Community"
```
**Expected:** Should find feature section with name containing "Community"
...
```
VERIFICATION REPORT - PROMPT 445
================================
...
Confirm: "Prompt 445 executed correctly. Ready for Prompt 446."
