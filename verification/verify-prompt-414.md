# Verification Prompt for Prompt 414

## Your Task: Verify Execution of Prompt 414

You are verifying that **Prompt 414** was executed correctly.

### What Prompt 414 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\kubernetes\\overlays\\prod`
**Expected Feature Name:** `Prod`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 414:"
```
**Expected:** Should find entry like "Prompt 414: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\kubernetes\\overlays\\prod`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Prod"
```
**Expected:** Should find feature section with name containing "Prod"
...
```
VERIFICATION REPORT - PROMPT 414
================================
...
Confirm: "Prompt 414 executed correctly. Ready for Prompt 415."
