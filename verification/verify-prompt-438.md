# Verification Prompt for Prompt 438

## Your Task: Verify Execution of Prompt 438

You are verifying that **Prompt 438** was executed correctly.

### What Prompt 438 Should Have Done:

**Folder Analyzed:** `dashboard\\docs\\onboarding`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 438:"
```
**Expected:** Should find entry like "Prompt 438: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\docs\\onboarding`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 438
================================
...
Confirm: "Prompt 438 executed correctly. Ready for Prompt 439."
