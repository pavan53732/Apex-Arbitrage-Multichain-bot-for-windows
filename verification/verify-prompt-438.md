# Verification for Prompt 438

## Task: Verify that Prompt 438 executed correctly

**Folder that was processed:** `dashboard\\docs\\onboarding`
...
- Does it contain "Prompt 438: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\docs\\onboarding`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 438: Executed"
...
## If PASSED
Say: "✅ Prompt 438 verified successfully. Ready for Prompt 439."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 438.
