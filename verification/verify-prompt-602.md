# Verification for Prompt 602

## Task: Verify that Prompt 602 executed correctly

**Folder that was processed:** `data\\backups`
...
- Does it contain "Prompt 602: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\backups`, determine the owner:
...
- Does the feature name match or relate to "Backups"?
...
✅/❌ Progress.md contains "Prompt 602: Executed"
...
## If PASSED
Say: "✅ Prompt 602 verified successfully. Ready for Prompt 603."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 602.
