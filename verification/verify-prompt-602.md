# Verification Prompt for Prompt 602

## Your Task: Verify Execution of Prompt 602

You are verifying that **Prompt 602** was executed correctly.

### What Prompt 602 Should Have Done:

**Folder Analyzed:** `data\\backups`
**Expected Feature Name:** `Backups`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 602:"
```
**Expected:** Should find entry like "Prompt 602: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\backups`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Backups"
```
**Expected:** Should find feature section with name containing "Backups"
...
```
VERIFICATION REPORT - PROMPT 602
================================
...
Confirm: "Prompt 602 executed correctly. Ready for Prompt 603."
