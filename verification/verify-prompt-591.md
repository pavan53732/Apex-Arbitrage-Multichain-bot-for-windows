# Verification for Prompt 591

## Task: Verify that Prompt 591 executed correctly

**Folder that was processed:** `data\\ai-feedback`
...
- Does it contain "Prompt 591: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\ai-feedback`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 591: Executed"
...
## If PASSED
Say: "✅ Prompt 591 verified successfully. Ready for Prompt 592."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 591.
