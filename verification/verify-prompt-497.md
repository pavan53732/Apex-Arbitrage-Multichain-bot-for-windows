# Verification for Prompt 497

## Task: Verify that Prompt 497 executed correctly

**Folder that was processed:** `dashboard\\plugins\\flashloan\\tests`
...
- Does it contain "Prompt 497: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\flashloan\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 497: Executed"
...
## If PASSED
Say: "✅ Prompt 497 verified successfully. Ready for Prompt 498."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 497.
