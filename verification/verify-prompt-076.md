# Verification for Prompt 76

## Task: Verify that Prompt 76 executed correctly

**Folder that was processed:** `backend\\docs\\risk`
...
- Does it contain "Prompt 76: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\docs\\risk`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 76: Executed"
...
## If PASSED
Say: "✅ Prompt 76 verified successfully. Ready for Prompt 77."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 76.
