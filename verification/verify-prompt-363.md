# Verification Prompt for Prompt 363

## Your Task: Verify Execution of Prompt 363

You are verifying that **Prompt 363** was executed correctly.

### What Prompt 363 Should Have Done:

**Folder Analyzed:** `dashboard\\components\\charts`
**Expected Feature Name:** `Charts`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 363:"
```
**Expected:** Should find entry like "Prompt 363: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\components\\charts`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Charts"
```
**Expected:** Should find feature section with name containing "Charts"
...
```
VERIFICATION REPORT - PROMPT 363
================================
...
Confirm: "Prompt 363 executed correctly. Ready for Prompt 364."
