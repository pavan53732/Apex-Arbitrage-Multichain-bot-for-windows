# Verification for Prompt 363

## Task: Verify that Prompt 363 executed correctly

**Folder that was processed:** `dashboard\\components\\charts`
...
- Does it contain "Prompt 363: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\charts`, determine the owner:
...
- Does the feature name match or relate to "Charts"?
...
✅/❌ Progress.md contains "Prompt 363: Executed"
...
## If PASSED
Say: "✅ Prompt 363 verified successfully. Ready for Prompt 364."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 363.
