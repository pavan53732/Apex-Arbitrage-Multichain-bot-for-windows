# Verification for Prompt 557

## Task: Verify that Prompt 557 executed correctly

**Folder that was processed:** `dashboard\\tests\\migration`
...
- Does it contain "Prompt 557: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\migration`, determine the owner:
...
- Does the feature name match or relate to "Migration"?
...
✅/❌ Progress.md contains "Prompt 557: Executed"
...
## If PASSED
Say: "✅ Prompt 557 verified successfully. Ready for Prompt 558."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 557.
