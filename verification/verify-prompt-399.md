# Verification Prompt for Prompt 399

## Your Task: Verify Execution of Prompt 399

You are verifying that **Prompt 399** was executed correctly.

### What Prompt 399 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\ansible\\roles\\dashboard`
**Expected Feature Name:** `Dashboard`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 399:"
```
**Expected:** Should find entry like "Prompt 399: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\ansible\\roles\\dashboard`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Dashboard"
```
**Expected:** Should find feature section with name containing "Dashboard"
...
```
VERIFICATION REPORT - PROMPT 399
================================
...
Confirm: "Prompt 399 executed correctly. Ready for Prompt 400."
