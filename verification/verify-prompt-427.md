# Verification for Prompt 427

## Task: Verify that Prompt 427 executed correctly

**Folder that was processed:** `dashboard\\deploy\\terraform\\scripts`
...
- Does it contain "Prompt 427: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\terraform\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 427: Executed"
...
## If PASSED
Say: "✅ Prompt 427 verified successfully. Ready for Prompt 428."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 427.
