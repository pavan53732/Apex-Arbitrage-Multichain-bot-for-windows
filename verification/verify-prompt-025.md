# Verification for Prompt 25

## Task: Verify that Prompt 25 executed correctly

**Folder that was processed:** `archive\\docs\\playbooks`
...
- Does it contain "Prompt 25: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\docs\\playbooks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 25: Executed"
...
## If PASSED
Say: "✅ Prompt 25 verified successfully. Ready for Prompt 26."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 25.
