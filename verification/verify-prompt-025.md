# Verification Prompt for Prompt 25

## Your Task: Verify Execution of Prompt 25

You are verifying that **Prompt 25** was executed correctly.

### What Prompt 25 Should Have Done:

**Folder Analyzed:** `archive\\docs\\playbooks`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 25:"
```
**Expected:** Should find entry like "Prompt 25: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\docs\\playbooks`, determine which .md file should own this feature:
...
Confirm: "Prompt 25 executed correctly. Ready for Prompt 26."
