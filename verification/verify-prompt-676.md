# Verification for Prompt 676

## Task: Verify that Prompt 676 executed correctly

**Folder that was processed:** `examples\\audit-qa`
...
- Does it contain "Prompt 676: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `examples\\audit-qa`, determine the owner:
...
- Does the feature name match or relate to "Audit Qa"?
...
✅/❌ Progress.md contains "Prompt 676: Executed"
...
## If PASSED
Say: "✅ Prompt 676 verified successfully. Ready for Prompt 677."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 676.
