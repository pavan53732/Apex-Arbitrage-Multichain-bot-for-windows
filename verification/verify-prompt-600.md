# Verification for Prompt 600

## Task: Verify that Prompt 600 executed correctly

**Folder that was processed:** `data\\analytics\\trade-metrics`
...
- Does it contain "Prompt 600: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\analytics\\trade-metrics`, determine the owner:
...
- Does the feature name match or relate to "Trade Metrics"?
...
✅/❌ Progress.md contains "Prompt 600: Executed"
...
## If PASSED
Say: "✅ Prompt 600 verified successfully. Ready for Prompt 601."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 600.
