# Verification Prompt for Prompt 600

## Your Task: Verify Execution of Prompt 600

You are verifying that **Prompt 600** was executed correctly.

### What Prompt 600 Should Have Done:

**Folder Analyzed:** `data\\analytics\\trade-metrics`
**Expected Feature Name:** `Trade Metrics`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 600:"
```
**Expected:** Should find entry like "Prompt 600: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\analytics\\trade-metrics`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Trade Metrics"
```
**Expected:** Should find feature section with name containing "Trade Metrics"
...
```
VERIFICATION REPORT - PROMPT 600
================================
...
Confirm: "Prompt 600 executed correctly. Ready for Prompt 601."
