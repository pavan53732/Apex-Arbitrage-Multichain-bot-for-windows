# Verification for Prompt 409

## Task: Verify that Prompt 409 executed correctly

**Folder that was processed:** `dashboard\\deploy\\kubernetes`
...
- Does it contain "Prompt 409: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\kubernetes`, determine the owner:
...
- Does the feature name match or relate to "Kubernetes"?
...
✅/❌ Progress.md contains "Prompt 409: Executed"
...
## If PASSED
Say: "✅ Prompt 409 verified successfully. Ready for Prompt 410."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 409.
