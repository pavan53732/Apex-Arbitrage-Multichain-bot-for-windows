# Verification Prompt for Prompt 409

## Your Task: Verify Execution of Prompt 409

You are verifying that **Prompt 409** was executed correctly.

### What Prompt 409 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\kubernetes`
**Expected Feature Name:** `Kubernetes`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 409:"
```
**Expected:** Should find entry like "Prompt 409: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\kubernetes`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Kubernetes"
```
**Expected:** Should find feature section with name containing "Kubernetes"
...
```
VERIFICATION REPORT - PROMPT 409
================================
...
Confirm: "Prompt 409 executed correctly. Ready for Prompt 410."
