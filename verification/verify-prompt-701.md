# Verification for Prompt 701

## Task: Verify that Prompt 701 executed correctly

**Folder that was processed:** `manifest\\inventory`
...
- Does it contain "Prompt 701: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `manifest\\inventory`, determine the owner:
...
- Does the feature name match or relate to "Inventory"?
...
✅/❌ Progress.md contains "Prompt 701: Executed"
...
## If PASSED
Say: "✅ Prompt 701 verified successfully. Ready for Prompt 702."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 701.
