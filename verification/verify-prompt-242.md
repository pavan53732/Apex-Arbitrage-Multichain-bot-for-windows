# Verification for Prompt 242

## Task: Verify that Prompt 242 executed correctly

**Folder that was processed:** `ci\\buildkite`
...
- Does it contain "Prompt 242: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\buildkite`, determine the owner:
...
- Does the feature name match or relate to "Buildkite"?
...
✅/❌ Progress.md contains "Prompt 242: Executed"
...
## If PASSED
Say: "✅ Prompt 242 verified successfully. Ready for Prompt 243."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 242.
