# Verification for Prompt 712

## Task: Verify that Prompt 712 executed correctly

**Folder that was processed:** `migrations\\prisma`
...
- Does it contain "Prompt 712: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `migrations\\prisma`, determine the owner:
...
- Does the feature name match or relate to "Prisma"?
...
✅/❌ Progress.md contains "Prompt 712: Executed"
...
## If PASSED
Say: "✅ Prompt 712 verified successfully. Ready for Prompt 713."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 712.
