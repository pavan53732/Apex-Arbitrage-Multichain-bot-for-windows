# Verification for Prompt 377

## Task: Verify that Prompt 377 executed correctly

**Folder that was processed:** `dashboard\\context`
...
- Does it contain "Prompt 377: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\context`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 377: Executed"
...
## If PASSED
Say: "✅ Prompt 377 verified successfully. Ready for Prompt 378."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 377.
