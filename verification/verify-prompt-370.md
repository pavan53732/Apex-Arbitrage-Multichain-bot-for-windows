# Verification for Prompt 370

## Task: Verify that Prompt 370 executed correctly

**Folder that was processed:** `dashboard\\components\\overlays`
...
- Does it contain "Prompt 370: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\overlays`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 370: Executed"
...
## If PASSED
Say: "✅ Prompt 370 verified successfully. Ready for Prompt 371."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 370.
