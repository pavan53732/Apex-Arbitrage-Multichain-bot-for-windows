# Verification Prompt for Prompt 252

## Your Task: Verify Execution of Prompt 252

You are verifying that **Prompt 252** was executed correctly.

### What Prompt 252 Should Have Done:

**Folder Analyzed:** `ci\\jenkins`
**Expected Feature Name:** `Jenkins`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 252:"
```
**Expected:** Should find entry like "Prompt 252: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ci\\jenkins`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Jenkins"
```
**Expected:** Should find feature section with name containing "Jenkins"
...
```
VERIFICATION REPORT - PROMPT 252
================================
...
Confirm: "Prompt 252 executed correctly. Ready for Prompt 253."
