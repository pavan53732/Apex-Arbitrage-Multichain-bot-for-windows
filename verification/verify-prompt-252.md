# Verification for Prompt 252

## Task: Verify that Prompt 252 executed correctly

**Folder that was processed:** `ci\\jenkins`
...
- Does it contain "Prompt 252: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\jenkins`, determine the owner:
...
- Does the feature name match or relate to "Jenkins"?
...
✅/❌ Progress.md contains "Prompt 252: Executed"
...
## If PASSED
Say: "✅ Prompt 252 verified successfully. Ready for Prompt 253."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 252.
