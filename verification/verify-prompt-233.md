# Verification for Prompt 233

## Task: Verify that Prompt 233 executed correctly

**Folder that was processed:** `benchmarks\\docs`
...
- Does it contain "Prompt 233: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `benchmarks\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 233: Executed"
...
## If PASSED
Say: "✅ Prompt 233 verified successfully. Ready for Prompt 234."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 233.
