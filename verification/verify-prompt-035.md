# Verification for Prompt 35

## Task: Verify that Prompt 35 executed correctly

**Folder that was processed:** `backend\\contracts\\scripts`
...
- Does it contain "Prompt 35: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\contracts\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 35: Executed"
...
## If PASSED
Say: "✅ Prompt 35 verified successfully. Ready for Prompt 36."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 35.
