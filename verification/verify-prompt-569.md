# Verification for Prompt 569

## Task: Verify that Prompt 569 executed correctly

**Folder that was processed:** `dashboard\\theme`
...
- Does it contain "Prompt 569: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\theme`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 569: Executed"
...
## If PASSED
Say: "✅ Prompt 569 verified successfully. Ready for Prompt 570."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 569.
