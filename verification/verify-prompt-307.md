# Verification Prompt for Prompt 307

## Your Task: Verify Execution of Prompt 307

You are verifying that **Prompt 307** was executed correctly.

### What Prompt 307 Should Have Done:

**Folder Analyzed:** `dashboard\\ai\\models`
**Expected Feature Name:** `Models`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 307:"
```
**Expected:** Should find entry like "Prompt 307: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\ai\\models`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Models"
```
**Expected:** Should find feature section with name containing "Models"
...
```
VERIFICATION REPORT - PROMPT 307
================================
...
Confirm: "Prompt 307 executed correctly. Ready for Prompt 308."
