# Verification for Prompt 307

## Task: Verify that Prompt 307 executed correctly

**Folder that was processed:** `dashboard\\ai\\models`
...
- Does it contain "Prompt 307: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\models`, determine the owner:
...
- Does the feature name match or relate to "Models"?
...
✅/❌ Progress.md contains "Prompt 307: Executed"
...
## If PASSED
Say: "✅ Prompt 307 verified successfully. Ready for Prompt 308."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 307.
