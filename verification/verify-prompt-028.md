# Verification for Prompt 28

## Task: Verify that Prompt 28 executed correctly

**Folder that was processed:** `archive\\old-configs`
...
- Does it contain "Prompt 28: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\old-configs`, determine the owner:
...
- Does the feature name match or relate to "Old Configs"?
...
✅/❌ Progress.md contains "Prompt 28: Executed"
...
## If PASSED
Say: "✅ Prompt 28 verified successfully. Ready for Prompt 29."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 28.
