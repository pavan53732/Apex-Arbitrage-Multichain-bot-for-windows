# Verification for Prompt 757

## Task: Verify that Prompt 757 executed correctly

**Folder that was processed:** `public\\themes`
...
- Does it contain "Prompt 757: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `public\\themes`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 757: Executed"
...
## If PASSED
Say: "✅ Prompt 757 verified successfully. Ready for Prompt 758."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 757.
