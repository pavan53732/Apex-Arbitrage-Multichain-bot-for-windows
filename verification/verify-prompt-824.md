# Verification Prompt for Prompt 824

## Your Task: Verify Execution of Prompt 824

You are verifying that **Prompt 824** was executed correctly.

### What Prompt 824 Should Have Done:

**Folder Analyzed:** `utils\\parser`
**Expected Feature Name:** `Parser`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 824:"
```
**Expected:** Should find entry like "Prompt 824: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `utils\\parser`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Parser"
```
**Expected:** Should find feature section with name containing "Parser"
...
```
VERIFICATION REPORT - PROMPT 824
================================
...
Confirm: "Prompt 824 executed correctly. Ready for Prompt 825."
