# Verification for Prompt 824

## Task: Verify that Prompt 824 executed correctly

**Folder that was processed:** `utils\\parser`
...
- Does it contain "Prompt 824: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `utils\\parser`, determine the owner:
...
- Does the feature name match or relate to "Parser"?
...
✅/❌ Progress.md contains "Prompt 824: Executed"
...
## If PASSED
Say: "✅ Prompt 824 verified successfully. Ready for Prompt 825."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 824.
