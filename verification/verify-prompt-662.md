# Verification for Prompt 662

## Task: Verify that Prompt 662 executed correctly

**Folder that was processed:** `deploy\\terraform\\modules\\storage`
...
- Does it contain "Prompt 662: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\terraform\\modules\\storage`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 662: Executed"
...
## If PASSED
Say: "✅ Prompt 662 verified successfully. Ready for Prompt 663."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 662.
