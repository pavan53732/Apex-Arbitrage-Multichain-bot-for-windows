# Verification for Prompt 316

## Task: Verify that Prompt 316 executed correctly

**Folder that was processed:** `dashboard\\analytics\\charts`
...
- Does it contain "Prompt 316: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\charts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 316: Executed"
...
## If PASSED
Say: "✅ Prompt 316 verified successfully. Ready for Prompt 317."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 316.
