# Verification for Prompt 425

## Task: Verify that Prompt 425 executed correctly

**Folder that was processed:** `dashboard\\deploy\\terraform\\modules\\storage`
...
- Does it contain "Prompt 425: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\terraform\\modules\\storage`, determine the owner:
...
- Does the feature name match or relate to "Storage"?
...
✅/❌ Progress.md contains "Prompt 425: Executed"
...
## If PASSED
Say: "✅ Prompt 425 verified successfully. Ready for Prompt 426."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 425.
