# Verification Prompt for Prompt 425

## Your Task: Verify Execution of Prompt 425

You are verifying that **Prompt 425** was executed correctly.

### What Prompt 425 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\terraform\\modules\\storage`
**Expected Feature Name:** `Storage`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 425:"
```
**Expected:** Should find entry like "Prompt 425: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\terraform\\modules\\storage`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Storage"
```
**Expected:** Should find feature section with name containing "Storage"
...
```
VERIFICATION REPORT - PROMPT 425
================================
...
Confirm: "Prompt 425 executed correctly. Ready for Prompt 426."
