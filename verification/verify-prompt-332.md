# Verification for Prompt 332

## Task: Verify that Prompt 332 executed correctly

**Folder that was processed:** `dashboard\\api\\integration`
...
- Does it contain "Prompt 332: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\api\\integration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 332: Executed"
...
## If PASSED
Say: "✅ Prompt 332 verified successfully. Ready for Prompt 333."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 332.
