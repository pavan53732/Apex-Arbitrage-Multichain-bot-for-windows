# Verification for Prompt 620

## Task: Verify that Prompt 620 executed correctly

**Folder that was processed:** `data\\overlays`
...
- Does it contain "Prompt 620: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\overlays`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 620: Executed"
...
## If PASSED
Say: "✅ Prompt 620 verified successfully. Ready for Prompt 621."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 620.
