# Verification for Prompt 633

## Task: Verify that Prompt 633 executed correctly

**Folder that was processed:** `deploy\\ansible\\roles`
...
- Does it contain "Prompt 633: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\ansible\\roles`, determine the owner:
...
- Does the feature name match or relate to "Roles"?
...
✅/❌ Progress.md contains "Prompt 633: Executed"
...
## If PASSED
Say: "✅ Prompt 633 verified successfully. Ready for Prompt 634."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 633.
