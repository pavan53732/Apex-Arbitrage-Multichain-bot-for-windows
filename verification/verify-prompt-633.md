# Verification Prompt for Prompt 633

## Your Task: Verify Execution of Prompt 633

You are verifying that **Prompt 633** was executed correctly.

### What Prompt 633 Should Have Done:

**Folder Analyzed:** `deploy\\ansible\\roles`
**Expected Feature Name:** `Roles`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 633:"
```
**Expected:** Should find entry like "Prompt 633: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `deploy\\ansible\\roles`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Roles"
```
**Expected:** Should find feature section with name containing "Roles"
...
```
VERIFICATION REPORT - PROMPT 633
================================
...
Confirm: "Prompt 633 executed correctly. Ready for Prompt 634."
