# Verification for Prompt 225

## Task: Verify that Prompt 225 executed correctly

**Folder that was processed:** `backend\\watchdog\\tests\\hooks`
...
- Does it contain "Prompt 225: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\watchdog\\tests\\hooks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 225: Executed"
...
## If PASSED
Say: "✅ Prompt 225 verified successfully. Ready for Prompt 226."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 225.
