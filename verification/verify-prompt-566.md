# Verification for Prompt 566

## Task: Verify that Prompt 566 executed correctly

**Folder that was processed:** `dashboard\\tests\\state`
...
- Does it contain "Prompt 566: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\state`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 566: Executed"
...
## If PASSED
Say: "✅ Prompt 566 verified successfully. Ready for Prompt 567."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 566.
