# Verification for Prompt 371

## Task: Verify that Prompt 371 executed correctly

**Folder that was processed:** `dashboard\\components\\plugin`
...
- Does it contain "Prompt 371: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\plugin`, determine the owner:
...
- Does the feature name match or relate to "Plugin"?
...
✅/❌ Progress.md contains "Prompt 371: Executed"
...
## If PASSED
Say: "✅ Prompt 371 verified successfully. Ready for Prompt 372."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 371.
