# Verification Prompt for Prompt 371

## Your Task: Verify Execution of Prompt 371

You are verifying that **Prompt 371** was executed correctly.

### What Prompt 371 Should Have Done:

**Folder Analyzed:** `dashboard\\components\\plugin`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 371:"
```
**Expected:** Should find entry like "Prompt 371: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\components\\plugin`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 371
================================
...
Confirm: "Prompt 371 executed correctly. Ready for Prompt 372."
