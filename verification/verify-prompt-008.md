# Verification for Prompt 8

## Task: Verify that Prompt 8 executed correctly

**Folder that was processed:** `ai-modules\\notebooks`
...
- Does it contain "Prompt 8: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules\\notebooks`, determine the owner:
...
- Does the feature name match or relate to "Notebooks"?
...
✅/❌ Progress.md contains "Prompt 8: Executed"
...
## If PASSED
Say: "✅ Prompt 8 verified successfully. Ready for Prompt 9."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 8.
