# Verification Prompt for Prompt 389

## Your Task: Verify Execution of Prompt 389

You are verifying that **Prompt 389** was executed correctly.

### What Prompt 389 Should Have Done:

**Folder Analyzed:** `dashboard\\data\\synthetic-datasets`
**Expected Feature Name:** `Synthetic Datasets`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 389:"
```
**Expected:** Should find entry like "Prompt 389: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\data\\synthetic-datasets`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Synthetic Datasets"
```
**Expected:** Should find feature section with name containing "Synthetic Datasets"
...
```
VERIFICATION REPORT - PROMPT 389
================================
...
Confirm: "Prompt 389 executed correctly. Ready for Prompt 390."
