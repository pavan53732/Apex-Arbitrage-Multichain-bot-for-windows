# Verification for Prompt 389

## Task: Verify that Prompt 389 executed correctly

**Folder that was processed:** `dashboard\\data\\synthetic-datasets`
...
- Does it contain "Prompt 389: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\synthetic-datasets`, determine the owner:
...
- Does the feature name match or relate to "Synthetic Datasets"?
...
✅/❌ Progress.md contains "Prompt 389: Executed"
...
## If PASSED
Say: "✅ Prompt 389 verified successfully. Ready for Prompt 390."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 389.
