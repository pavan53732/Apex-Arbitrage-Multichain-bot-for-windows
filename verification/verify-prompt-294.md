# Verification for Prompt 294

## Task: Verify that Prompt 294 executed correctly

**Folder that was processed:** `config\\tokens`
...
- Does it contain "Prompt 294: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\tokens`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 294: Executed"
...
## If PASSED
Say: "✅ Prompt 294 verified successfully. Ready for Prompt 295."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 294.
