# Verification for Prompt 725

## Task: Verify that Prompt 725 executed correctly

**Folder that was processed:** `overlays\\incident\\demo`
...
- Does it contain "Prompt 725: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `overlays\\incident\\demo`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 725: Executed"
...
## If PASSED
Say: "✅ Prompt 725 verified successfully. Ready for Prompt 726."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 725.
