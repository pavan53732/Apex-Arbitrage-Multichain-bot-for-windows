# Verification Prompt for Prompt 11

## Your Task: Verify Execution of Prompt 11

You are verifying that **Prompt 11** was executed correctly.

### What Prompt 11 Should Have Done:

**Folder Analyzed:** `ai-modules\\train`
**Expected Feature Name:** `Train`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 11:"
```
**Expected:** Should find entry like "Prompt 11: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ai-modules\\train`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Train"
```
**Expected:** Should find feature section with name containing "Train"
...
Confirm: "Prompt 11 executed correctly. Ready for Prompt 12."
