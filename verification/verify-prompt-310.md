# Verification for Prompt 310

## Task: Verify that Prompt 310 executed correctly

**Folder that was processed:** `dashboard\\ai\\presets`
...
- Does it contain "Prompt 310: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\presets`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 310: Executed"
...
## If PASSED
Say: "✅ Prompt 310 verified successfully. Ready for Prompt 311."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 310.
