# Verification for Prompt 299

## Task: Verify that Prompt 299 executed correctly

**Folder that was processed:** `dashboard\\ai\\automation`
...
- Does it contain "Prompt 299: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\automation`, determine the owner:
...
- Does the feature name match or relate to "Automation"?
...
✅/❌ Progress.md contains "Prompt 299: Executed"
...
## If PASSED
Say: "✅ Prompt 299 verified successfully. Ready for Prompt 300."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 299.
