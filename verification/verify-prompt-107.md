# Verification for Prompt 107

## Task: Verify that Prompt 107 executed correctly

**Folder that was processed:** `backend\\migrations\\db\\rollback`
...
- Does it contain "Prompt 107: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\migrations\\db\\rollback`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 107: Executed"
...
## If PASSED
Say: "✅ Prompt 107 verified successfully. Ready for Prompt 108."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 107.
