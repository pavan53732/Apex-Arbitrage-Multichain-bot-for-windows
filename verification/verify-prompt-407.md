# Verification Prompt for Prompt 407

## Your Task: Verify Execution of Prompt 407

You are verifying that **Prompt 407** was executed correctly.

### What Prompt 407 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\helm\\apex-protocol`
**Expected Feature Name:** `Apex Protocol`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 407:"
```
**Expected:** Should find entry like "Prompt 407: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\helm\\apex-protocol`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Apex Protocol"
```
**Expected:** Should find feature section with name containing "Apex Protocol"
...
```
VERIFICATION REPORT - PROMPT 407
================================
...
Confirm: "Prompt 407 executed correctly. Ready for Prompt 408."
