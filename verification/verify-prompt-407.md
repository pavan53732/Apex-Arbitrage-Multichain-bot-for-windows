# Verification for Prompt 407

## Task: Verify that Prompt 407 executed correctly

**Folder that was processed:** `dashboard\\deploy\\helm\\apex-protocol`
...
- Does it contain "Prompt 407: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\helm\\apex-protocol`, determine the owner:
...
- Does the feature name match or relate to "Apex Protocol"?
...
✅/❌ Progress.md contains "Prompt 407: Executed"
...
## If PASSED
Say: "✅ Prompt 407 verified successfully. Ready for Prompt 408."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 407.
