# Verification for Prompt 810

## Task: Verify that Prompt 810 executed correctly

**Folder that was processed:** `types\\abi`
...
- Does it contain "Prompt 810: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `types\\abi`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 810: Executed"
...
## If PASSED
Say: "✅ Prompt 810 verified successfully. Ready for Prompt 811."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 810.
