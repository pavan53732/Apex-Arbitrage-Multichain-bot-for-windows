# Verification for Prompt 608

## Task: Verify that Prompt 608 executed correctly

**Folder that was processed:** `data\\backups\\monthly`
...
- Does it contain "Prompt 608: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\backups\\monthly`, determine the owner:
...
- Does the feature name match or relate to "Monthly"?
...
✅/❌ Progress.md contains "Prompt 608: Executed"
...
## If PASSED
Say: "✅ Prompt 608 verified successfully. Ready for Prompt 609."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 608.
