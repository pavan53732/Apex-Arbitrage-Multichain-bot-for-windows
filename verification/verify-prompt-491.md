# Verification for Prompt 491

## Task: Verify that Prompt 491 executed correctly

**Folder that was processed:** `dashboard\\plugins\\dex-adapters`
...
- Does it contain "Prompt 491: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\dex-adapters`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 491: Executed"
...
## If PASSED
Say: "✅ Prompt 491 verified successfully. Ready for Prompt 492."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 491.
