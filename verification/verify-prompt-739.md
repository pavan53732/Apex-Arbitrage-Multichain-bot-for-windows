# Verification for Prompt 739

## Task: Verify that Prompt 739 executed correctly

**Folder that was processed:** `presets\\quickstart`
...
- Does it contain "Prompt 739: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `presets\\quickstart`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 739: Executed"
...
## If PASSED
Say: "✅ Prompt 739 verified successfully. Ready for Prompt 740."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 739.
