# Verification Prompt for Prompt 262

## Your Task: Verify Execution of Prompt 262

You are verifying that **Prompt 262** was executed correctly.

### What Prompt 262 Should Have Done:

**Folder Analyzed:** `config\\.meta`
**Expected Feature Name:** `.Meta`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 262:"
```
**Expected:** Should find entry like "Prompt 262: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `config\\.meta`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*.Meta"
```
**Expected:** Should find feature section with name containing ".Meta"
...
```
VERIFICATION REPORT - PROMPT 262
================================
...
Confirm: "Prompt 262 executed correctly. Ready for Prompt 263."
