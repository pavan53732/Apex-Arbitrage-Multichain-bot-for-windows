# Verification for Prompt 262

## Task: Verify that Prompt 262 executed correctly

**Folder that was processed:** `config\\.meta`
...
- Does it contain "Prompt 262: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\.meta`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 262: Executed"
...
## If PASSED
Say: "✅ Prompt 262 verified successfully. Ready for Prompt 263."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 262.
