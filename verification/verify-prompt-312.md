# Verification for Prompt 312

## Task: Verify that Prompt 312 executed correctly

**Folder that was processed:** `dashboard\\ai\\tests`
...
- Does it contain "Prompt 312: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 312: Executed"
...
## If PASSED
Say: "✅ Prompt 312 verified successfully. Ready for Prompt 313."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 312.
