# Verification for Prompt 298

## Task: Verify that Prompt 298 executed correctly

**Folder that was processed:** `dashboard\\ai`
...
- Does it contain "Prompt 298: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 298: Executed"
...
## If PASSED
Say: "✅ Prompt 298 verified successfully. Ready for Prompt 299."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 298.
