# Verification for Prompt 768

## Task: Verify that Prompt 768 executed correctly

**Folder that was processed:** `research\\results`
...
- Does it contain "Prompt 768: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `research\\results`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 768: Executed"
...
## If PASSED
Say: "✅ Prompt 768 verified successfully. Ready for Prompt 769."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 768.
