# Verification for Prompt 643

## Task: Verify that Prompt 643 executed correctly

**Folder that was processed:** `deploy\\helm`
...
- Does it contain "Prompt 643: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\helm`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 643: Executed"
...
## If PASSED
Say: "✅ Prompt 643 verified successfully. Ready for Prompt 644."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 643.
