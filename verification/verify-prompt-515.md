# Verification for Prompt 515

## Task: Verify that Prompt 515 executed correctly

**Folder that was processed:** `dashboard\\plugins\\tests`
...
- Does it contain "Prompt 515: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 515: Executed"
...
## If PASSED
Say: "✅ Prompt 515 verified successfully. Ready for Prompt 516."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 515.
