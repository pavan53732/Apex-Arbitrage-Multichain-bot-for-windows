# Verification for Prompt 709

## Task: Verify that Prompt 709 executed correctly

**Folder that was processed:** `migrations\\data`
...
- Does it contain "Prompt 709: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `migrations\\data`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 709: Executed"
...
## If PASSED
Say: "✅ Prompt 709 verified successfully. Ready for Prompt 710."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 709.
