# Verification for Prompt 126

## Task: Verify that Prompt 126 executed correctly

**Folder that was processed:** `backend\\operator`
...
- Does it contain "Prompt 126: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\operator`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 126: Executed"
...
## If PASSED
Say: "✅ Prompt 126 verified successfully. Ready for Prompt 127."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 126.
