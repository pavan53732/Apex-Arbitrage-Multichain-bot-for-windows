# Verification for Prompt 96

## Task: Verify that Prompt 96 executed correctly

**Folder that was processed:** `backend\\examples\\research-demos`
...
- Does it contain "Prompt 96: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\examples\\research-demos`, determine the owner:
...
- Does the feature name match or relate to "Research Demos"?
...
✅/❌ Progress.md contains "Prompt 96: Executed"
...
## If PASSED
Say: "✅ Prompt 96 verified successfully. Ready for Prompt 97."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 96.
