# Verification Prompt for Prompt 96

## Your Task: Verify Execution of Prompt 96

You are verifying that **Prompt 96** was executed correctly.

### What Prompt 96 Should Have Done:

**Folder Analyzed:** `backend\\examples\\research-demos`
**Expected Feature Name:** `Research Demos`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 96:"
```
**Expected:** Should find entry like "Prompt 96: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\examples\\research-demos`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Research Demos"
```
**Expected:** Should find feature section with name containing "Research Demos"
...
Confirm: "Prompt 96 executed correctly. Ready for Prompt 97."
