# Verification for Prompt 660

## Task: Verify that Prompt 660 executed correctly

**Folder that was processed:** `deploy\\terraform\\modules\\db`
...
- Does it contain "Prompt 660: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\terraform\\modules\\db`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 660: Executed"
...
## If PASSED
Say: "✅ Prompt 660 verified successfully. Ready for Prompt 661."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 660.
