# Verification for Prompt 504

## Task: Verify that Prompt 504 executed correctly

**Folder that was processed:** `dashboard\\plugins\\internal`
...
- Does it contain "Prompt 504: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\internal`, determine the owner:
...
- Does the feature name match or relate to "Internal"?
...
✅/❌ Progress.md contains "Prompt 504: Executed"
...
## If PASSED
Say: "✅ Prompt 504 verified successfully. Ready for Prompt 505."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 504.
