# Verification for Prompt 611

## Task: Verify that Prompt 611 executed correctly

**Folder that was processed:** `data\\export`
...
- Does it contain "Prompt 611: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\export`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 611: Executed"
...
## If PASSED
Say: "✅ Prompt 611 verified successfully. Ready for Prompt 612."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 611.
