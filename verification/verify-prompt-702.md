# Verification for Prompt 702

## Task: Verify that Prompt 702 executed correctly

**Folder that was processed:** `manifest\\metadata`
...
- Does it contain "Prompt 702: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `manifest\\metadata`, determine the owner:
...
- Does the feature name match or relate to "Metadata"?
...
✅/❌ Progress.md contains "Prompt 702: Executed"
...
## If PASSED
Say: "✅ Prompt 702 verified successfully. Ready for Prompt 703."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 702.
