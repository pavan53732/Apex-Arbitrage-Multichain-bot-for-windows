# Verification for Prompt 842

## Task: Verify that Prompt 842 executed correctly

**Folder that was processed:** `watchdog`
...
- Does it contain "Prompt 842: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `watchdog`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 842: Executed"
...
## If PASSED
Say: "✅ Prompt 842 verified successfully. Ready for Prompt 843."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 842.
