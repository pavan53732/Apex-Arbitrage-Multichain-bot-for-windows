# Verification for Prompt 605

## Task: Verify that Prompt 605 executed correctly

**Folder that was processed:** `data\\backups\\config-dump`
...
- Does it contain "Prompt 605: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\backups\\config-dump`, determine the owner:
...
- Does the feature name match or relate to "Config Dump"?
...
✅/❌ Progress.md contains "Prompt 605: Executed"
...
## If PASSED
Say: "✅ Prompt 605 verified successfully. Ready for Prompt 606."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 605.
