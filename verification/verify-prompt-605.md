# Verification Prompt for Prompt 605

## Your Task: Verify Execution of Prompt 605

You are verifying that **Prompt 605** was executed correctly.

### What Prompt 605 Should Have Done:

**Folder Analyzed:** `data\\backups\\config-dump`
**Expected Feature Name:** `Config Dump`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 605:"
```
**Expected:** Should find entry like "Prompt 605: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\backups\\config-dump`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Config Dump"
```
**Expected:** Should find feature section with name containing "Config Dump"
...
```
VERIFICATION REPORT - PROMPT 605
================================
...
Confirm: "Prompt 605 executed correctly. Ready for Prompt 606."
