# Verification for Prompt 640

## Task: Verify that Prompt 640 executed correctly

**Folder that was processed:** `deploy\\docker`
...
- Does it contain "Prompt 640: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\docker`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 640: Executed"
...
## If PASSED
Say: "✅ Prompt 640 verified successfully. Ready for Prompt 641."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 640.
