# Verification for Prompt 223

## Task: Verify that Prompt 223 executed correctly

**Folder that was processed:** `backend\\watchdog\\hooks`
...
- Does it contain "Prompt 223: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\watchdog\\hooks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 223: Executed"
...
## If PASSED
Say: "✅ Prompt 223 verified successfully. Ready for Prompt 224."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 223.
