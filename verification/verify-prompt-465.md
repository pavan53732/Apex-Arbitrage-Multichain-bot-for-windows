# Verification for Prompt 465

## Task: Verify that Prompt 465 executed correctly

**Folder that was processed:** `dashboard\\hooks`
...
- Does it contain "Prompt 465: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\hooks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 465: Executed"
...
## If PASSED
Say: "✅ Prompt 465 verified successfully. Ready for Prompt 466."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 465.
