# Verification for Prompt 624

## Task: Verify that Prompt 624 executed correctly

**Folder that was processed:** `data\\simulation-results\\regression`
...
- Does it contain "Prompt 624: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\simulation-results\\regression`, determine the owner:
...
```
VERIFICATION REPORT - PROMPT 624
==========================================

✅/❌ Progress.md contains "Prompt 624: Executed"
...
## If PASSED
Say: "✅ Prompt 624 verified successfully. Ready for Prompt 625."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 624.
