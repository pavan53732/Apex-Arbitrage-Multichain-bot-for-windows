# Verification for Prompt 699

## Task: Verify that Prompt 699 executed correctly

**Folder that was processed:** `manifest\\diffs`
...
- Does it contain "Prompt 699: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `manifest\\diffs`, determine the owner:
...
- Does the feature name match or relate to "Diffs"?
...
✅/❌ Progress.md contains "Prompt 699: Executed"
...
## If PASSED
Say: "✅ Prompt 699 verified successfully. Ready for Prompt 700."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 699.
