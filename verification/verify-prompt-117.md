# Verification Prompt for Prompt 117

## Your Task: Verify Execution of Prompt 117

You are verifying that **Prompt 117** was executed correctly.

### What Prompt 117 Should Have Done:

**Folder Analyzed:** `backend\\notebooks\\data-demo`
**Expected Feature Name:** `Data Demo`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 117:"
```
**Expected:** Should find entry like "Prompt 117: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\notebooks\\data-demo`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Data Demo"
```
**Expected:** Should find feature section with name containing "Data Demo"
...
```
VERIFICATION REPORT - PROMPT 117
================================
...
Confirm: "Prompt 117 executed correctly. Ready for Prompt 118."
