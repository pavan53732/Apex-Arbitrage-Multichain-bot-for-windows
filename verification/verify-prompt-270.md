# Verification for Prompt 270

## Task: Verify that Prompt 270 executed correctly

**Folder that was processed:** `config\\dashboards`
...
- Does it contain "Prompt 270: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\dashboards`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 270: Executed"
...
## If PASSED
Say: "✅ Prompt 270 verified successfully. Ready for Prompt 271."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 270.
