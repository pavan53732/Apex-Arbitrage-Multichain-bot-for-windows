# Verification Prompt for Prompt 809

## Your Task: Verify Execution of Prompt 809

You are verifying that **Prompt 809** was executed correctly.

### What Prompt 809 Should Have Done:

**Folder Analyzed:** `types`
**Expected Feature Name:** `Types`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 809:"
```
**Expected:** Should find entry like "Prompt 809: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `types`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Types"
```
**Expected:** Should find feature section with name containing "Types"
...
```
VERIFICATION REPORT - PROMPT 809
================================
...
Confirm: "Prompt 809 executed correctly. Ready for Prompt 810."
