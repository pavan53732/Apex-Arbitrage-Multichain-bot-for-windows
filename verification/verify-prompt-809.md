# Verification for Prompt 809

## Task: Verify that Prompt 809 executed correctly

**Folder that was processed:** `types`
...
- Does it contain "Prompt 809: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `types`, determine the owner:
...
- Does the feature name match or relate to "Types"?
...
✅/❌ Progress.md contains "Prompt 809: Executed"
...
## If PASSED
Say: "✅ Prompt 809 verified successfully. Ready for Prompt 810."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 809.
