# Verification for Prompt 736

## Task: Verify that Prompt 736 executed correctly

**Folder that was processed:** `presets\\export`
...
- Does it contain "Prompt 736: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `presets\\export`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 736: Executed"
...
## If PASSED
Say: "✅ Prompt 736 verified successfully. Ready for Prompt 737."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 736.
