# Verification for Prompt 426

## Task: Verify that Prompt 426 executed correctly

**Folder that was processed:** `dashboard\\deploy\\terraform\\modules\\vpc`
...
- Does it contain "Prompt 426: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\terraform\\modules\\vpc`, determine the owner:
...
- Does the feature name match or relate to "Vpc"?
...
✅/❌ Progress.md contains "Prompt 426: Executed"
...
## If PASSED
Say: "✅ Prompt 426 verified successfully. Ready for Prompt 427."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 426.
