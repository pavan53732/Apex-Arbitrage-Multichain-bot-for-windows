# Verification for Prompt 34

## Task: Verify that Prompt 34 executed correctly

**Folder that was processed:** `backend\\contracts\\interfaces`
...
- Does it contain "Prompt 34: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\contracts\\interfaces`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 34: Executed"
...
## If PASSED
Say: "✅ Prompt 34 verified successfully. Ready for Prompt 35."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 34.
