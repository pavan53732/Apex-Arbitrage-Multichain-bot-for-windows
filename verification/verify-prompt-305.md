# Verification for Prompt 305

## Task: Verify that Prompt 305 executed correctly

**Folder that was processed:** `dashboard\\ai\\feedback`
...
- Does it contain "Prompt 305: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\feedback`, determine the owner:
...
- Does the feature name match or relate to "Feedback"?
...
✅/❌ Progress.md contains "Prompt 305: Executed"
...
## If PASSED
Say: "✅ Prompt 305 verified successfully. Ready for Prompt 306."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 305.
