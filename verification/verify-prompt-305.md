# Verification Prompt for Prompt 305

## Your Task: Verify Execution of Prompt 305

You are verifying that **Prompt 305** was executed correctly.

### What Prompt 305 Should Have Done:

**Folder Analyzed:** `dashboard\\ai\\feedback`
**Expected Feature Name:** `Feedback`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 305:"
```
**Expected:** Should find entry like "Prompt 305: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\ai\\feedback`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Feedback"
```
**Expected:** Should find feature section with name containing "Feedback"
...
```
VERIFICATION REPORT - PROMPT 305
================================
...
Confirm: "Prompt 305 executed correctly. Ready for Prompt 306."
