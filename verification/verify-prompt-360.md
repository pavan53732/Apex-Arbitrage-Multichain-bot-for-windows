# Verification Prompt for Prompt 360

## Your Task: Verify Execution of Prompt 360

You are verifying that **Prompt 360** was executed correctly.

### What Prompt 360 Should Have Done:

**Folder Analyzed:** `dashboard\\components`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 360:"
```
**Expected:** Should find entry like "Prompt 360: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\components`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 360
================================
...
Confirm: "Prompt 360 executed correctly. Ready for Prompt 361."
