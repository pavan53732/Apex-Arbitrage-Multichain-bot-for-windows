# Verification for Prompt 360

## Task: Verify that Prompt 360 executed correctly

**Folder that was processed:** `dashboard\\components`
...
- Does it contain "Prompt 360: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 360: Executed"
...
## If PASSED
Say: "✅ Prompt 360 verified successfully. Ready for Prompt 361."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 360.
