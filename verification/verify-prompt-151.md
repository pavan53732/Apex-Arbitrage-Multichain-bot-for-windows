# Verification for Prompt 151

## Task: Verify that Prompt 151 executed correctly

**Folder that was processed:** `backend\\plugins\\flashloan\\tests`
...
- Does it contain "Prompt 151: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\plugins\\flashloan\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 151: Executed"
...
## If PASSED
Say: "✅ Prompt 151 verified successfully. Ready for Prompt 152."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 151.
