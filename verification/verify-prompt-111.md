# Verification for Prompt 111

## Task: Verify that Prompt 111 executed correctly

**Folder that was processed:** `backend\\migrations\\plugin`
...
- Does it contain "Prompt 111: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\migrations\\plugin`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 111: Executed"
...
## If PASSED
Say: "✅ Prompt 111 verified successfully. Ready for Prompt 112."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 111.
