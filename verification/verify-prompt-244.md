# Verification for Prompt 244

## Task: Verify that Prompt 244 executed correctly

**Folder that was processed:** `ci\\buildkite\\scripts`
...
- Does it contain "Prompt 244: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\buildkite\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 244: Executed"
...
## If PASSED
Say: "✅ Prompt 244 verified successfully. Ready for Prompt 245."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 244.
