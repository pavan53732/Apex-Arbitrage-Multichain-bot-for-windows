# Verification for Prompt 393

## Task: Verify that Prompt 393 executed correctly

**Folder that was processed:** `dashboard\\deploy\\ansible\\roles`
...
- Does it contain "Prompt 393: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\ansible\\roles`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 393: Executed"
...
## If PASSED
Say: "✅ Prompt 393 verified successfully. Ready for Prompt 394."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 393.
