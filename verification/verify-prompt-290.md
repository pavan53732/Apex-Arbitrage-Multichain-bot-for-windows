# Verification for Prompt 290

## Task: Verify that Prompt 290 executed correctly

**Folder that was processed:** `config\\schema`
...
- Does it contain "Prompt 290: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\schema`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 290: Executed"
...
## If PASSED
Say: "✅ Prompt 290 verified successfully. Ready for Prompt 291."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 290.
