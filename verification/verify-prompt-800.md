# Verification Prompt for Prompt 800

## Your Task: Verify Execution of Prompt 800

You are verifying that **Prompt 800** was executed correctly.

### What Prompt 800 Should Have Done:

**Folder Analyzed:** `third-party`
**Expected Feature Name:** `Third Party`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 800:"
```
**Expected:** Should find entry like "Prompt 800: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `third-party`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Third Party"
```
**Expected:** Should find feature section with name containing "Third Party"
...
```
VERIFICATION REPORT - PROMPT 800
================================
...
Confirm: "Prompt 800 executed correctly. Ready for Prompt 801."
