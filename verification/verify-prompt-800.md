# Verification for Prompt 800

## Task: Verify that Prompt 800 executed correctly

**Folder that was processed:** `third-party`
...
- Does it contain "Prompt 800: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `third-party`, determine the owner:
...
- Does the feature name match or relate to "Third Party"?
...
✅/❌ Progress.md contains "Prompt 800: Executed"
...
## If PASSED
Say: "✅ Prompt 800 verified successfully. Ready for Prompt 801."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 800.
