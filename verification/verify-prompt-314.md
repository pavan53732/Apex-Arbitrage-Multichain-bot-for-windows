# Verification Prompt for Prompt 314

## Your Task: Verify Execution of Prompt 314

You are verifying that **Prompt 314** was executed correctly.

### What Prompt 314 Should Have Done:

**Folder Analyzed:** `dashboard\\analytics`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 314:"
```
**Expected:** Should find entry like "Prompt 314: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\analytics`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 314
================================
...
Confirm: "Prompt 314 executed correctly. Ready for Prompt 315."
