# Verification for Prompt 314

## Task: Verify that Prompt 314 executed correctly

**Folder that was processed:** `dashboard\\analytics`
...
- Does it contain "Prompt 314: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 314: Executed"
...
## If PASSED
Say: "✅ Prompt 314 verified successfully. Ready for Prompt 315."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 314.
