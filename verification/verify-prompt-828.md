# Verification for Prompt 828

## Task: Verify that Prompt 828 executed correctly

**Folder that was processed:** `vendor`
...
- Does it contain "Prompt 828: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `vendor`, determine the owner:
...
- Does the feature name match or relate to "Vendor"?
...
✅/❌ Progress.md contains "Prompt 828: Executed"
...
## If PASSED
Say: "✅ Prompt 828 verified successfully. Ready for Prompt 829."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 828.
