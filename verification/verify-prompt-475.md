# Verification for Prompt 475

## Task: Verify that Prompt 475 executed correctly

**Folder that was processed:** `dashboard\\notifications`
...
- Does it contain "Prompt 475: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\notifications`, determine the owner:
...
- Does the feature name match or relate to "Notifications"?
...
✅/❌ Progress.md contains "Prompt 475: Executed"
...
## If PASSED
Say: "✅ Prompt 475 verified successfully. Ready for Prompt 476."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 475.
