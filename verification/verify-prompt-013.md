# Verification Prompt for Prompt 13

## Your Task: Verify Execution of Prompt 13

You are verifying that **Prompt 13** was executed correctly.

### What Prompt 13 Should Have Done:

**Folder Analyzed:** `archive\\archived-tests`
**Expected Feature Name:** `Archived Tests`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 13:"
```
**Expected:** Should find entry like "Prompt 13: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\archived-tests`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Archived Tests"
```
**Expected:** Should find feature section with name containing "Archived Tests"
...
Confirm: "Prompt 13 executed correctly. Ready for Prompt 14."
