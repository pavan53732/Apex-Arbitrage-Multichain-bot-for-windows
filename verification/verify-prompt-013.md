# Verification for Prompt 13

## Task: Verify that Prompt 13 executed correctly

**Folder that was processed:** `archive\\archived-tests`
...
- Does it contain "Prompt 13: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\archived-tests`, determine the owner:
...
- Does the feature name match or relate to "Archived Tests"?
...
✅/❌ Progress.md contains "Prompt 13: Executed"
...
## If PASSED
Say: "✅ Prompt 13 verified successfully. Ready for Prompt 14."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 13.
