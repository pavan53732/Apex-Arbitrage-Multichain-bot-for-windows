# Verification for Prompt 770

## Task: Verify that Prompt 770 executed correctly

**Folder that was processed:** `scripts`
...
- Does it contain "Prompt 770: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 770: Executed"
...
## If PASSED
Say: "✅ Prompt 770 verified successfully. Ready for Prompt 771."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 770.
