# Verification for Prompt 514

## Task: Verify that Prompt 514 executed correctly

**Folder that was processed:** `dashboard\\plugins\\template`
...
- Does it contain "Prompt 514: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\template`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 514: Executed"
...
## If PASSED
Say: "✅ Prompt 514 verified successfully. Ready for Prompt 515."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 514.
