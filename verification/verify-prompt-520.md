# Verification Prompt for Prompt 520

## Your Task: Verify Execution of Prompt 520

You are verifying that **Prompt 520** was executed correctly.

### What Prompt 520 Should Have Done:

**Folder Analyzed:** `dashboard\\public`
**Expected Feature Name:** `Public`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 520:"
```
**Expected:** Should find entry like "Prompt 520: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\public`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Public"
```
**Expected:** Should find feature section with name containing "Public"
...
```
VERIFICATION REPORT - PROMPT 520
================================
...
Confirm: "Prompt 520 executed correctly. Ready for Prompt 521."
