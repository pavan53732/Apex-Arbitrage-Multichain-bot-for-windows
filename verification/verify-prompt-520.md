# Verification for Prompt 520

## Task: Verify that Prompt 520 executed correctly

**Folder that was processed:** `dashboard\\public`
...
- Does it contain "Prompt 520: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\public`, determine the owner:
...
- Does the feature name match or relate to "Public"?
...
✅/❌ Progress.md contains "Prompt 520: Executed"
...
## If PASSED
Say: "✅ Prompt 520 verified successfully. Ready for Prompt 521."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 520.
