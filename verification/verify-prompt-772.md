# Verification for Prompt 772

## Task: Verify that Prompt 772 executed correctly

**Folder that was processed:** `scripts\\operator`
...
- Does it contain "Prompt 772: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `scripts\\operator`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 772: Executed"
...
## If PASSED
Say: "✅ Prompt 772 verified successfully. Ready for Prompt 773."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 772.
