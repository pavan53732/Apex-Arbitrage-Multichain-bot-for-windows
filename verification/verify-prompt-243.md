# Verification for Prompt 243

## Task: Verify that Prompt 243 executed correctly

**Folder that was processed:** `ci\\buildkite\\agent-hooks`
...
- Does it contain "Prompt 243: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\buildkite\\agent-hooks`, determine the owner:
...
- Does the feature name match or relate to "Agent Hooks"?
...
✅/❌ Progress.md contains "Prompt 243: Executed"
...
## If PASSED
Say: "✅ Prompt 243 verified successfully. Ready for Prompt 244."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 243.
