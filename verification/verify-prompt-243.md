# Verification Prompt for Prompt 243

## Your Task: Verify Execution of Prompt 243

You are verifying that **Prompt 243** was executed correctly.

### What Prompt 243 Should Have Done:

**Folder Analyzed:** `ci\\buildkite\\agent-hooks`
**Expected Feature Name:** `Agent Hooks`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 243:"
```
**Expected:** Should find entry like "Prompt 243: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ci\\buildkite\\agent-hooks`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Agent Hooks"
```
**Expected:** Should find feature section with name containing "Agent Hooks"
...
```
VERIFICATION REPORT - PROMPT 243
================================
...
Confirm: "Prompt 243 executed correctly. Ready for Prompt 244."
