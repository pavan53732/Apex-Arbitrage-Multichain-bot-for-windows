# Verification for Prompt 750

## Task: Verify that Prompt 750 executed correctly

**Folder that was processed:** `public\\icons\\tokens`
...
- Does it contain "Prompt 750: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `public\\icons\\tokens`, determine the owner:
...
- Does the feature name match or relate to "Tokens"?
...
✅/❌ Progress.md contains "Prompt 750: Executed"
...
## If PASSED
Say: "✅ Prompt 750 verified successfully. Ready for Prompt 751."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 750.
