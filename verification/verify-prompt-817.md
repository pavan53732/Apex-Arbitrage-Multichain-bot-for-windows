# Verification Prompt for Prompt 817

## Your Task: Verify Execution of Prompt 817

You are verifying that **Prompt 817** was executed correctly.

### What Prompt 817 Should Have Done:

**Folder Analyzed:** `utils\\converter`
**Expected Feature Name:** `Converter`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 817:"
```
**Expected:** Should find entry like "Prompt 817: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `utils\\converter`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Converter"
```
**Expected:** Should find feature section with name containing "Converter"
...
```
VERIFICATION REPORT - PROMPT 817
================================
...
Confirm: "Prompt 817 executed correctly. Ready for Prompt 818."
