# Verification for Prompt 355

## Task: Verify that Prompt 355 executed correctly

**Folder that was processed:** `dashboard\\ar\\utils`
...
- Does it contain "Prompt 355: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\utils`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 355: Executed"
...
## If PASSED
Say: "✅ Prompt 355 verified successfully. Ready for Prompt 356."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 355.
