# Verification for Prompt 246

## Task: Verify that Prompt 246 executed correctly

**Folder that was processed:** `ci\\circleci\\scripts`
...
- Does it contain "Prompt 246: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\circleci\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 246: Executed"
...
## If PASSED
Say: "✅ Prompt 246 verified successfully. Ready for Prompt 247."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 246.
