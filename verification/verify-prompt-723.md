# Verification for Prompt 723

## Task: Verify that Prompt 723 executed correctly

**Folder that was processed:** `overlays\\extension`
...
- Does it contain "Prompt 723: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `overlays\\extension`, determine the owner:
...
- Does the feature name match or relate to "Extension"?
...
✅/❌ Progress.md contains "Prompt 723: Executed"
...
## If PASSED
Say: "✅ Prompt 723 verified successfully. Ready for Prompt 724."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 723.
