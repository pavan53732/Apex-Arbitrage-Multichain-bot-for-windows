# Verification Prompt for Prompt 250

## Your Task: Verify Execution of Prompt 250

You are verifying that **Prompt 250** was executed correctly.

### What Prompt 250 Should Have Done:

**Folder Analyzed:** `ci\\gitlab`
**Expected Feature Name:** `Gitlab`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 250:"
```
**Expected:** Should find entry like "Prompt 250: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ci\\gitlab`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Gitlab"
```
**Expected:** Should find feature section with name containing "Gitlab"
...
```
VERIFICATION REPORT - PROMPT 250
================================
...
Confirm: "Prompt 250 executed correctly. Ready for Prompt 251."
