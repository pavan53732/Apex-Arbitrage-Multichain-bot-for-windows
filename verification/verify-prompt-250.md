# Verification for Prompt 250

## Task: Verify that Prompt 250 executed correctly

**Folder that was processed:** `ci\\gitlab`
...
- Does it contain "Prompt 250: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\gitlab`, determine the owner:
...
- Does the feature name match or relate to "Gitlab"?
...
✅/❌ Progress.md contains "Prompt 250: Executed"
...
## If PASSED
Say: "✅ Prompt 250 verified successfully. Ready for Prompt 251."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 250.
