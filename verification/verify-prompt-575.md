# Verification for Prompt 575

## Task: Verify that Prompt 575 executed correctly

**Folder that was processed:** `dashboard\\uploads\\csv`
...
- Does it contain "Prompt 575: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\uploads\\csv`, determine the owner:
...
- Does the feature name match or relate to "Csv"?
...
✅/❌ Progress.md contains "Prompt 575: Executed"
...
## If PASSED
Say: "✅ Prompt 575 verified successfully. Ready for Prompt 576."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 575.
