# Verification for Prompt 585

## Task: Verify that Prompt 585 executed correctly

**Folder that was processed:** `dashboard\\widgets\\ext`
...
- Does it contain "Prompt 585: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\widgets\\ext`, determine the owner:
...
- Does the feature name match or relate to "Ext"?
...
✅/❌ Progress.md contains "Prompt 585: Executed"
...
## If PASSED
Say: "✅ Prompt 585 verified successfully. Ready for Prompt 586."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 585.
