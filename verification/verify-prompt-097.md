# Verification for Prompt 97

## Task: Verify that Prompt 97 executed correctly

**Folder that was processed:** `backend\\examples\\sim-outputs`
...
- Does it contain "Prompt 97: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\examples\\sim-outputs`, determine the owner:
...
- Does the feature name match or relate to "Sim Outputs"?
...
✅/❌ Progress.md contains "Prompt 97: Executed"
...
## If PASSED
Say: "✅ Prompt 97 verified successfully. Ready for Prompt 98."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 97.
