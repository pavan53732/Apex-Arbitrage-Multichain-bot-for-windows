# Verification Prompt for Prompt 97

## Your Task: Verify Execution of Prompt 97

You are verifying that **Prompt 97** was executed correctly.

### What Prompt 97 Should Have Done:

**Folder Analyzed:** `backend\\examples\\sim-outputs`
**Expected Feature Name:** `Sim Outputs`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 97:"
```
**Expected:** Should find entry like "Prompt 97: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\examples\\sim-outputs`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Sim Outputs"
```
**Expected:** Should find feature section with name containing "Sim Outputs"
...
Confirm: "Prompt 97 executed correctly. Ready for Prompt 98."
