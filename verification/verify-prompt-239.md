# Verification for Prompt 239

## Task: Verify that Prompt 239 executed correctly

**Folder that was processed:** `benchmarks\\tools`
...
- Does it contain "Prompt 239: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `benchmarks\\tools`, determine the owner:
...
- Does the feature name match or relate to "Tools"?
...
✅/❌ Progress.md contains "Prompt 239: Executed"
...
## If PASSED
Say: "✅ Prompt 239 verified successfully. Ready for Prompt 240."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 239.
