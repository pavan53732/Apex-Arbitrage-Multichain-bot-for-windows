# Verification Prompt for Prompt 24

## Your Task: Verify Execution of Prompt 24

You are verifying that **Prompt 24** was executed correctly.

### What Prompt 24 Should Have Done:

**Folder Analyzed:** `archive\\docs\\onboarding`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 24:"
```
**Expected:** Should find entry like "Prompt 24: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\docs\\onboarding`, determine which .md file should own this feature:
...
Confirm: "Prompt 24 executed correctly. Ready for Prompt 25."
