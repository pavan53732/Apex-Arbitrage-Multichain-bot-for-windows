# Verification for Prompt 24

## Task: Verify that Prompt 24 executed correctly

**Folder that was processed:** `archive\\docs\\onboarding`
...
- Does it contain "Prompt 24: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\docs\\onboarding`, determine the owner:
...
```
VERIFICATION REPORT - PROMPT 24
==========================================

✅/❌ Progress.md contains "Prompt 24: Executed"
...
## If PASSED
Say: "✅ Prompt 24 verified successfully. Ready for Prompt 25."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 24.
