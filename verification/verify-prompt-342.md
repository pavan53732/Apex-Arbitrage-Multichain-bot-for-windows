# Verification for Prompt 342

## Task: Verify that Prompt 342 executed correctly

**Folder that was processed:** `dashboard\\ar\\components`
...
- Does it contain "Prompt 342: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\components`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 342: Executed"
...
## If PASSED
Say: "✅ Prompt 342 verified successfully. Ready for Prompt 343."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 342.
