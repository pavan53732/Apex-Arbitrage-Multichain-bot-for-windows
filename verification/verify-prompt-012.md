# Verification Prompt for Prompt 12

## Your Task: Verify Execution of Prompt 12

You are verifying that **Prompt 12** was executed correctly.

### What Prompt 12 Should Have Done:

**Folder Analyzed:** `archive`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 12:"
```
**Expected:** Should find entry like "Prompt 12: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive`, determine which .md file should own this feature:
...
Confirm: "Prompt 12 executed correctly. Ready for Prompt 13."
