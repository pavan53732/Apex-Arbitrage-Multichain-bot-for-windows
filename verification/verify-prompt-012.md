# Verification for Prompt 12

## Task: Verify that Prompt 12 executed correctly

**Folder that was processed:** `archive`
...
- Does it contain "Prompt 12: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 12: Executed"
...
## If PASSED
Say: "✅ Prompt 12 verified successfully. Ready for Prompt 13."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 12.
