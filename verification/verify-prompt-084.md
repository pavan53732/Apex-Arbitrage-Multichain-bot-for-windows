# Verification for Prompt 84

## Task: Verify that Prompt 84 executed correctly

**Folder that was processed:** `backend\\engine\\hooks`
...
- Does it contain "Prompt 84: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\engine\\hooks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 84: Executed"
...
## If PASSED
Say: "✅ Prompt 84 verified successfully. Ready for Prompt 85."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 84.
