# Verification for Prompt 716

## Task: Verify that Prompt 716 executed correctly

**Folder that was processed:** `overlays`
...
- Does it contain "Prompt 716: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `overlays`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 716: Executed"
...
## If PASSED
Say: "✅ Prompt 716 verified successfully. Ready for Prompt 717."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 716.
