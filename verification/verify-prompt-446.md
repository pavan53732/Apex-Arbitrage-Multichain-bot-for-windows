# Verification for Prompt 446

## Task: Verify that Prompt 446 executed correctly

**Folder that was processed:** `dashboard\\extensions\\core`
...
- Does it contain "Prompt 446: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\extensions\\core`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 446: Executed"
...
## If PASSED
Say: "✅ Prompt 446 verified successfully. Ready for Prompt 447."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 446.
