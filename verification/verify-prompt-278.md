# Verification for Prompt 278

## Task: Verify that Prompt 278 executed correctly

**Folder that was processed:** `config\\migrations`
...
- Does it contain "Prompt 278: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\migrations`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 278: Executed"
...
## If PASSED
Say: "✅ Prompt 278 verified successfully. Ready for Prompt 279."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 278.
