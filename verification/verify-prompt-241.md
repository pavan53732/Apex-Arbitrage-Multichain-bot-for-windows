# Verification for Prompt 241

## Task: Verify that Prompt 241 executed correctly

**Folder that was processed:** `ci\\badges`
...
- Does it contain "Prompt 241: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\badges`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 241: Executed"
...
## If PASSED
Say: "✅ Prompt 241 verified successfully. Ready for Prompt 242."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 241.
