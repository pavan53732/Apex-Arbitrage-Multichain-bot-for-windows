# Verification for Prompt 350

## Task: Verify that Prompt 350 executed correctly

**Folder that was processed:** `dashboard\\ar\\pages`
...
- Does it contain "Prompt 350: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\pages`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 350: Executed"
...
## If PASSED
Say: "✅ Prompt 350 verified successfully. Ready for Prompt 351."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 350.
