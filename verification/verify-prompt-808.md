# Verification for Prompt 808

## Task: Verify that Prompt 808 executed correctly

**Folder that was processed:** `third-party\\sdk`
...
- Does it contain "Prompt 808: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `third-party\\sdk`, determine the owner:
...
- Does the feature name match or relate to "Sdk"?
...
✅/❌ Progress.md contains "Prompt 808: Executed"
...
## If PASSED
Say: "✅ Prompt 808 verified successfully. Ready for Prompt 809."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 808.
