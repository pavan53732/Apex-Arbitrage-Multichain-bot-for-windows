# Verification Prompt for Prompt 707

## Your Task: Verify Execution of Prompt 707

You are verifying that **Prompt 707** was executed correctly.

### What Prompt 707 Should Have Done:

**Folder Analyzed:** `migrations\\backup`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 707:"
```
**Expected:** Should find entry like "Prompt 707: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `migrations\\backup`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 707
================================
...
Confirm: "Prompt 707 executed correctly. Ready for Prompt 708."
