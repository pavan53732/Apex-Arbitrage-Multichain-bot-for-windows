# Verification for Prompt 707

## Task: Verify that Prompt 707 executed correctly

**Folder that was processed:** `migrations\\backup`
...
- Does it contain "Prompt 707: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `migrations\\backup`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 707: Executed"
...
## If PASSED
Say: "✅ Prompt 707 verified successfully. Ready for Prompt 708."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 707.
