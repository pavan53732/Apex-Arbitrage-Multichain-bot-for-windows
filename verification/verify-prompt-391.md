# Verification for Prompt 391

## Task: Verify that Prompt 391 executed correctly

**Folder that was processed:** `dashboard\\deploy\\ansible`
...
- Does it contain "Prompt 391: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\ansible`, determine the owner:
...
- Does the feature name match or relate to "Ansible"?
...
✅/❌ Progress.md contains "Prompt 391: Executed"
...
## If PASSED
Say: "✅ Prompt 391 verified successfully. Ready for Prompt 392."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 391.
