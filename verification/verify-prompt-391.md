# Verification Prompt for Prompt 391

## Your Task: Verify Execution of Prompt 391

You are verifying that **Prompt 391** was executed correctly.

### What Prompt 391 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\ansible`
**Expected Feature Name:** `Ansible`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 391:"
```
**Expected:** Should find entry like "Prompt 391: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\ansible`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Ansible"
```
**Expected:** Should find feature section with name containing "Ansible"
...
```
VERIFICATION REPORT - PROMPT 391
================================
...
Confirm: "Prompt 391 executed correctly. Ready for Prompt 392."
