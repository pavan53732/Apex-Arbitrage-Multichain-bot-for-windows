# Verification for Prompt 832

## Task: Verify that Prompt 832 executed correctly

**Folder that was processed:** `vendor\\datasets`
...
- Does it contain "Prompt 832: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `vendor\\datasets`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 832: Executed"
...
## If PASSED
Say: "✅ Prompt 832 verified successfully. Ready for Prompt 833."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 832.
