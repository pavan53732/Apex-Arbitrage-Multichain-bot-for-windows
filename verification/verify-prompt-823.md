# Verification Prompt for Prompt 823

## Your Task: Verify Execution of Prompt 823

You are verifying that **Prompt 823** was executed correctly.

### What Prompt 823 Should Have Done:

**Folder Analyzed:** `utils\\math`
**Expected Feature Name:** `Math`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 823:"
```
**Expected:** Should find entry like "Prompt 823: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `utils\\math`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Math"
```
**Expected:** Should find feature section with name containing "Math"
...
```
VERIFICATION REPORT - PROMPT 823
================================
...
Confirm: "Prompt 823 executed correctly. Ready for Prompt 824."
