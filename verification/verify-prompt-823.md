# Verification for Prompt 823

## Task: Verify that Prompt 823 executed correctly

**Folder that was processed:** `utils\\math`
...
- Does it contain "Prompt 823: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `utils\\math`, determine the owner:
...
- Does the feature name match or relate to "Math"?
...
✅/❌ Progress.md contains "Prompt 823: Executed"
...
## If PASSED
Say: "✅ Prompt 823 verified successfully. Ready for Prompt 824."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 823.
