# Verification for Prompt 510

## Task: Verify that Prompt 510 executed correctly

**Folder that was processed:** `dashboard\\plugins\\samples`
...
- Does it contain "Prompt 510: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\samples`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 510: Executed"
...
## If PASSED
Say: "✅ Prompt 510 verified successfully. Ready for Prompt 511."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 510.
