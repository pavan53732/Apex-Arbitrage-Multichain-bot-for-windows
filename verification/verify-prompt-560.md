# Verification for Prompt 560

## Task: Verify that Prompt 560 executed correctly

**Folder that was processed:** `dashboard\\tests\\performance`
...
- Does it contain "Prompt 560: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\performance`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 560: Executed"
...
## If PASSED
Say: "✅ Prompt 560 verified successfully. Ready for Prompt 561."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 560.
