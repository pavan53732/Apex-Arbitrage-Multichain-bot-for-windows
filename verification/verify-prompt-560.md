# Verification Prompt for Prompt 560

## Your Task: Verify Execution of Prompt 560

You are verifying that **Prompt 560** was executed correctly.

### What Prompt 560 Should Have Done:

**Folder Analyzed:** `dashboard\\tests\\performance`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 560:"
```
**Expected:** Should find entry like "Prompt 560: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\tests\\performance`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 560
================================
...
Confirm: "Prompt 560 executed correctly. Ready for Prompt 561."
