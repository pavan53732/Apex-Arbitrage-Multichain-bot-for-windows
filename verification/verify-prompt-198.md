# Verification for Prompt 198

## Task: Verify that Prompt 198 executed correctly

**Folder that was processed:** `backend\\tests\\contracts`
...
- Does it contain "Prompt 198: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\tests\\contracts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 198: Executed"
...
## If PASSED
Say: "✅ Prompt 198 verified successfully. Ready for Prompt 199."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 198.
