# Verification for Prompt 232

## Task: Verify that Prompt 232 executed correctly

**Folder that was processed:** `benchmarks\\datasets`
...
- Does it contain "Prompt 232: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `benchmarks\\datasets`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 232: Executed"
...
## If PASSED
Say: "✅ Prompt 232 verified successfully. Ready for Prompt 233."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 232.
