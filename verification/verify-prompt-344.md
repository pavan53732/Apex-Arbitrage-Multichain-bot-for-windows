# Verification for Prompt 344

## Task: Verify that Prompt 344 executed correctly

**Folder that was processed:** `dashboard\\ar\\context`
...
- Does it contain "Prompt 344: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\context`, determine the owner:
...
- Does the feature name match or relate to "Context"?
...
✅/❌ Progress.md contains "Prompt 344: Executed"
...
## If PASSED
Say: "✅ Prompt 344 verified successfully. Ready for Prompt 345."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 344.
