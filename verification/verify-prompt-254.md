# Verification for Prompt 254

## Task: Verify that Prompt 254 executed correctly

**Folder that was processed:** `ci\\jenkins\\scripts`
...
- Does it contain "Prompt 254: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\jenkins\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 254: Executed"
...
## If PASSED
Say: "✅ Prompt 254 verified successfully. Ready for Prompt 255."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 254.
