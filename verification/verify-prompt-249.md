# Verification Prompt for Prompt 249

## Your Task: Verify Execution of Prompt 249

You are verifying that **Prompt 249** was executed correctly.

### What Prompt 249 Should Have Done:

**Folder Analyzed:** `ci\\github\\actions`
**Expected Feature Name:** `Actions`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 249:"
```
**Expected:** Should find entry like "Prompt 249: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ci\\github\\actions`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Actions"
```
**Expected:** Should find feature section with name containing "Actions"
...
```
VERIFICATION REPORT - PROMPT 249
================================
...
Confirm: "Prompt 249 executed correctly. Ready for Prompt 250."
