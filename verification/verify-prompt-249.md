# Verification for Prompt 249

## Task: Verify that Prompt 249 executed correctly

**Folder that was processed:** `ci\\github\\actions`
...
- Does it contain "Prompt 249: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\github\\actions`, determine the owner:
...
- Does the feature name match or relate to "Actions"?
...
✅/❌ Progress.md contains "Prompt 249: Executed"
...
## If PASSED
Say: "✅ Prompt 249 verified successfully. Ready for Prompt 250."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 249.
