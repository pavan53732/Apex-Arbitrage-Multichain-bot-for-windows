# Verification for Prompt 237

## Task: Verify that Prompt 237 executed correctly

**Folder that was processed:** `benchmarks\\regression`
...
- Does it contain "Prompt 237: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `benchmarks\\regression`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 237: Executed"
...
## If PASSED
Say: "✅ Prompt 237 verified successfully. Ready for Prompt 238."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 237.
