# Verification Prompt for Prompt 14

## Your Task: Verify Execution of Prompt 14

You are verifying that **Prompt 14** was executed correctly.

### What Prompt 14 Should Have Done:

**Folder Analyzed:** `archive\\archived-tests\\archived-output-logs`
**Expected Feature Name:** `Archived Output Logs`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 14:"
```
**Expected:** Should find entry like "Prompt 14: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\archived-tests\\archived-output-logs`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Archived Output Logs"
```
**Expected:** Should find feature section with name containing "Archived Output Logs"
...
Confirm: "Prompt 14 executed correctly. Ready for Prompt 15."
