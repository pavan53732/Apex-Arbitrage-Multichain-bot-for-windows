# Verification for Prompt 769

## Task: Verify that Prompt 769 executed correctly

**Folder that was processed:** `research\\swarm`
...
- Does it contain "Prompt 769: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `research\\swarm`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 769: Executed"
...
## If PASSED
Say: "✅ Prompt 769 verified successfully. Ready for Prompt 770."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 769.
