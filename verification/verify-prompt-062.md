# Verification for Prompt 62

## Task: Verify that Prompt 62 executed correctly

**Folder that was processed:** `backend\\data\\simulation-snapshots`
...
- Does it contain "Prompt 62: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\data\\simulation-snapshots`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 62: Executed"
...
## If PASSED
Say: "✅ Prompt 62 verified successfully. Ready for Prompt 63."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 62.
