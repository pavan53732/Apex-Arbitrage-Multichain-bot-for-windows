# Verification for Prompt 651

## Task: Verify that Prompt 651 executed correctly

**Folder that was processed:** `deploy\\kubernetes\\overlays\\prod`
...
- Does it contain "Prompt 651: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\kubernetes\\overlays\\prod`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 651: Executed"
...
## If PASSED
Say: "✅ Prompt 651 verified successfully. Ready for Prompt 652."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 651.
