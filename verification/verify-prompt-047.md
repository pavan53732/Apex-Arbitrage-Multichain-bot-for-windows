# Verification for Prompt 47

## Task: Verify that Prompt 47 executed correctly

**Folder that was processed:** `backend\\core\\docs`
...
- Does it contain "Prompt 47: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\core\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 47: Executed"
...
## If PASSED
Say: "✅ Prompt 47 verified successfully. Ready for Prompt 48."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 47.
