# Verification Prompt for Prompt 565

## Your Task: Verify Execution of Prompt 565

You are verifying that **Prompt 565** was executed correctly.

### What Prompt 565 Should Have Done:

**Folder Analyzed:** `dashboard\\tests\\snapshot`
**Expected Feature Name:** `Snapshot`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 565:"
```
**Expected:** Should find entry like "Prompt 565: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\tests\\snapshot`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Snapshot"
```
**Expected:** Should find feature section with name containing "Snapshot"
...
```
VERIFICATION REPORT - PROMPT 565
================================
...
Confirm: "Prompt 565 executed correctly. Ready for Prompt 566."
