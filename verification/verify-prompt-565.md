# Verification for Prompt 565

## Task: Verify that Prompt 565 executed correctly

**Folder that was processed:** `dashboard\\tests\\snapshot`
...
- Does it contain "Prompt 565: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\snapshot`, determine the owner:
...
- Does the feature name match or relate to "Snapshot"?
...
✅/❌ Progress.md contains "Prompt 565: Executed"
...
## If PASSED
Say: "✅ Prompt 565 verified successfully. Ready for Prompt 566."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 565.
