# Verification for Prompt 664

## Task: Verify that Prompt 664 executed correctly

**Folder that was processed:** `deploy\\terraform\\scripts`
...
- Does it contain "Prompt 664: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\terraform\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 664: Executed"
...
## If PASSED
Say: "✅ Prompt 664 verified successfully. Ready for Prompt 665."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 664.
