# Verification for Prompt 444

## Task: Verify that Prompt 444 executed correctly

**Folder that was processed:** `dashboard\\extensions\\assets`
...
- Does it contain "Prompt 444: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\extensions\\assets`, determine the owner:
...
- Does the feature name match or relate to "Assets"?
...
✅/❌ Progress.md contains "Prompt 444: Executed"
...
## If PASSED
Say: "✅ Prompt 444 verified successfully. Ready for Prompt 445."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 444.
