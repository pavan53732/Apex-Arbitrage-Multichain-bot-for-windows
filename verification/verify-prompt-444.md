# Verification Prompt for Prompt 444

## Your Task: Verify Execution of Prompt 444

You are verifying that **Prompt 444** was executed correctly.

### What Prompt 444 Should Have Done:

**Folder Analyzed:** `dashboard\\extensions\\assets`
**Expected Feature Name:** `Assets`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 444:"
```
**Expected:** Should find entry like "Prompt 444: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\extensions\\assets`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Assets"
```
**Expected:** Should find feature section with name containing "Assets"
...
```
VERIFICATION REPORT - PROMPT 444
================================
...
Confirm: "Prompt 444 executed correctly. Ready for Prompt 445."
