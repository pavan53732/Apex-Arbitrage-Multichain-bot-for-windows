# Verification for Prompt 277

## Task: Verify that Prompt 277 executed correctly

**Folder that was processed:** `config\\locales`
...
- Does it contain "Prompt 277: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\locales`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 277: Executed"
...
## If PASSED
Say: "✅ Prompt 277 verified successfully. Ready for Prompt 278."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 277.
