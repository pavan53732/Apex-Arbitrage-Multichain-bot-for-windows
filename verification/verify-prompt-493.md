# Verification for Prompt 493

## Task: Verify that Prompt 493 executed correctly

**Folder that was processed:** `dashboard\\plugins\\dex-adapters\\tests`
...
- Does it contain "Prompt 493: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\dex-adapters\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 493: Executed"
...
## If PASSED
Say: "✅ Prompt 493 verified successfully. Ready for Prompt 494."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 493.
