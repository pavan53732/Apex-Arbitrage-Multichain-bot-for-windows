# Verification Prompt for Prompt 706

## Your Task: Verify Execution of Prompt 706

You are verifying that **Prompt 706** was executed correctly.

### What Prompt 706 Should Have Done:

**Folder Analyzed:** `migrations`
**Expected Feature Name:** `Migrations`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 706:"
```
**Expected:** Should find entry like "Prompt 706: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `migrations`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Migrations"
```
**Expected:** Should find feature section with name containing "Migrations"
...
```
VERIFICATION REPORT - PROMPT 706
================================
...
Confirm: "Prompt 706 executed correctly. Ready for Prompt 707."
