# Verification for Prompt 706

## Task: Verify that Prompt 706 executed correctly

**Folder that was processed:** `migrations`
...
- Does it contain "Prompt 706: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `migrations`, determine the owner:
...
- Does the feature name match or relate to "Migrations"?
...
✅/❌ Progress.md contains "Prompt 706: Executed"
...
## If PASSED
Say: "✅ Prompt 706 verified successfully. Ready for Prompt 707."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 706.
