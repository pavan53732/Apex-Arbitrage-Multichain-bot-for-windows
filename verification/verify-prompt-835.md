# Verification for Prompt 835

## Task: Verify that Prompt 835 executed correctly

**Folder that was processed:** `vendor\\patches`
...
- Does it contain "Prompt 835: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `vendor\\patches`, determine the owner:
...
```
VERIFICATION REPORT - PROMPT 835
==========================================

✅/❌ Progress.md contains "Prompt 835: Executed"
...
## If PASSED
Say: "✅ Prompt 835 verified successfully. Ready for Prompt 836."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 835.
