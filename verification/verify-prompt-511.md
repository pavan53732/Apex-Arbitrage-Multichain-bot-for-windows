# Verification Prompt for Prompt 511

## Your Task: Verify Execution of Prompt 511

You are verifying that **Prompt 511** was executed correctly.

### What Prompt 511 Should Have Done:

**Folder Analyzed:** `dashboard\\plugins\\social-impact`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 511:"
```
**Expected:** Should find entry like "Prompt 511: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\plugins\\social-impact`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Social Impact"
```
**Expected:** Should find feature section with name containing "Social Impact"
...
Confirm: "Prompt 511 executed correctly. Ready for Prompt 512."
