# Verification for Prompt 758

## Task: Verify that Prompt 758 executed correctly

**Folder that was processed:** `research`
...
- Does it contain "Prompt 758: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `research`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 758: Executed"
...
## If PASSED
Say: "✅ Prompt 758 verified successfully. Ready for Prompt 759."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 758.
