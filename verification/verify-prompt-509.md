# Verification for Prompt 509

## Task: Verify that Prompt 509 executed correctly

**Folder that was processed:** `dashboard\\plugins\\oracles\\tests`
...
- Does it contain "Prompt 509: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\oracles\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 509: Executed"
...
## If PASSED
Say: "✅ Prompt 509 verified successfully. Ready for Prompt 510."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 509.
