# Verification Prompt for Prompt 538

## Your Task: Verify Execution of Prompt 538

You are verifying that **Prompt 538** was executed correctly.

### What Prompt 538 Should Have Done:

**Folder Analyzed:** `dashboard\\styles\\animations`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 538:"
```
**Expected:** Should find entry like "Prompt 538: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\styles\\animations`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Animations"
```
**Expected:** Should find feature section with name containing "Animations"
...
Confirm: "Prompt 538 executed correctly. Ready for Prompt 539."
