# Verification for Prompt 538

## Task: Verify that Prompt 538 executed correctly

**Folder that was processed:** `dashboard\\styles\\animations`
**Expected feature name:** `Animations`
...
- Does it contain "Prompt 538: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\styles\\animations`, determine the owner:
...
- Does the feature name match or relate to "Animations"?
...
```
VERIFICATION REPORT - PROMPT 538
==========================================

✅/❌ Progress.md contains "Prompt 538: Executed"
...
## If PASSED
Say: "✅ Prompt 538 verified successfully. Ready for Prompt 539."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 538.
