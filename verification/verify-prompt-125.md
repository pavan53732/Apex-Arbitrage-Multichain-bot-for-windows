# Verification Prompt for Prompt 125

## Your Task: Verify Execution of Prompt 125

You are verifying that **Prompt 125** was executed correctly.

### What Prompt 125 Should Have Done:

**Folder Analyzed:** `backend\\onboarding`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 125:"
```
**Expected:** Should find entry like "Prompt 125: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\onboarding`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 125
================================
...
Confirm: "Prompt 125 executed correctly. Ready for Prompt 126."
