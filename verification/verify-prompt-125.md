# Verification for Prompt 125

## Task: Verify that Prompt 125 executed correctly

**Folder that was processed:** `backend\\onboarding`
...
- Does it contain "Prompt 125: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\onboarding`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 125: Executed"
...
## If PASSED
Say: "✅ Prompt 125 verified successfully. Ready for Prompt 126."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 125.
