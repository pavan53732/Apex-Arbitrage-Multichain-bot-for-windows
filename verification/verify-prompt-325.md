# Verification Prompt for Prompt 325

## Your Task: Verify Execution of Prompt 325

You are verifying that **Prompt 325** was executed correctly.

### What Prompt 325 Should Have Done:

**Folder Analyzed:** `dashboard\\analytics\\reports`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 325:"
```
**Expected:** Should find entry like "Prompt 325: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\analytics\\reports`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 325
================================
...
Confirm: "Prompt 325 executed correctly. Ready for Prompt 326."
