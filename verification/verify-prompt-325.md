# Verification for Prompt 325

## Task: Verify that Prompt 325 executed correctly

**Folder that was processed:** `dashboard\\analytics\\reports`
...
- Does it contain "Prompt 325: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\reports`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 325: Executed"
...
## If PASSED
Say: "✅ Prompt 325 verified successfully. Ready for Prompt 326."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 325.
