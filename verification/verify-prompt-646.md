# Verification for Prompt 646

## Task: Verify that Prompt 646 executed correctly

**Folder that was processed:** `deploy\\kubernetes`
...
- Does it contain "Prompt 646: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\kubernetes`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 646: Executed"
...
## If PASSED
Say: "✅ Prompt 646 verified successfully. Ready for Prompt 647."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 646.
