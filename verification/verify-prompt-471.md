# Verification for Prompt 471

## Task: Verify that Prompt 471 executed correctly

**Folder that was processed:** `dashboard\\mock\\api-responses`
...
- Does it contain "Prompt 471: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\mock\\api-responses`, determine the owner:
...
- Does the feature name match or relate to "Api Responses"?
...
✅/❌ Progress.md contains "Prompt 471: Executed"
...
## If PASSED
Say: "✅ Prompt 471 verified successfully. Ready for Prompt 472."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 471.
