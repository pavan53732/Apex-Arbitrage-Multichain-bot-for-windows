# Verification for Prompt 680

## Task: Verify that Prompt 680 executed correctly

**Folder that was processed:** `examples\\onboarding`
...
- Does it contain "Prompt 680: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `examples\\onboarding`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 680: Executed"
...
## If PASSED
Say: "✅ Prompt 680 verified successfully. Ready for Prompt 681."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 680.
