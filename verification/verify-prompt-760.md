# Verification for Prompt 760

## Task: Verify that Prompt 760 executed correctly

**Folder that was processed:** `research\\compliance`
...
- Does it contain "Prompt 760: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `research\\compliance`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 760: Executed"
...
## If PASSED
Say: "✅ Prompt 760 verified successfully. Ready for Prompt 761."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 760.
