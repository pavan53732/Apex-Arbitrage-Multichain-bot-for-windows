# Verification Prompt for Prompt 398

## Your Task: Verify Execution of Prompt 398

You are verifying that **Prompt 398** was executed correctly.

### What Prompt 398 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\ansible\\roles\\backend`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 398:"
```
**Expected:** Should find entry like "Prompt 398: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\ansible\\roles\\backend`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 398
================================
...
Confirm: "Prompt 398 executed correctly. Ready for Prompt 399."
