# Verification for Prompt 398

## Task: Verify that Prompt 398 executed correctly

**Folder that was processed:** `dashboard\\deploy\\ansible\\roles\\backend`
...
- Does it contain "Prompt 398: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\ansible\\roles\\backend`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 398: Executed"
...
## If PASSED
Say: "✅ Prompt 398 verified successfully. Ready for Prompt 399."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 398.
