# Verification for Prompt 570

## Task: Verify that Prompt 570 executed correctly

**Folder that was processed:** `dashboard\\theme\\demo`
...
- Does it contain "Prompt 570: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\theme\\demo`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 570: Executed"
...
## If PASSED
Say: "✅ Prompt 570 verified successfully. Ready for Prompt 571."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 570.
