# Verification for Prompt 527

## Task: Verify that Prompt 527 executed correctly

**Folder that was processed:** `dashboard\\public\\onboarding`
...
- Does it contain "Prompt 527: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\public\\onboarding`, determine the owner:
...
- Does the feature name match or relate to "Onboarding"?
...
✅/❌ Progress.md contains "Prompt 527: Executed"
...
## If PASSED
Say: "✅ Prompt 527 verified successfully. Ready for Prompt 528."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 527.
