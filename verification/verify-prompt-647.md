# Verification for Prompt 647

## Task: Verify that Prompt 647 executed correctly

**Folder that was processed:** `deploy\\kubernetes\\base`
...
- Does it contain "Prompt 647: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\kubernetes\\base`, determine the owner:
...
- Does the feature name match or relate to "Base"?
...
✅/❌ Progress.md contains "Prompt 647: Executed"
...
## If PASSED
Say: "✅ Prompt 647 verified successfully. Ready for Prompt 648."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 647.
