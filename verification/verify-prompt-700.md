# Verification for Prompt 700

## Task: Verify that Prompt 700 executed correctly

**Folder that was processed:** `manifest\\generator`
**Expected feature name:** `Generator`
...
- Does it contain "Prompt 700: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `manifest\\generator`, determine the owner:
...
- Does the feature name match or relate to "Generator"?
...
```
VERIFICATION REPORT - PROMPT 700
==========================================

✅/❌ Progress.md contains "Prompt 700: Executed"
...
## If PASSED
Say: "✅ Prompt 700 verified successfully. Ready for Prompt 701."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 700.
