# Verification for Prompt 534

## Task: Verify that Prompt 534 executed correctly

**Folder that was processed:** `dashboard\\state`
...
- Does it contain "Prompt 534: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\state`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 534: Executed"
...
## If PASSED
Say: "✅ Prompt 534 verified successfully. Ready for Prompt 535."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 534.
