# Verification for Prompt 659

## Task: Verify that Prompt 659 executed correctly

**Folder that was processed:** `deploy\\terraform\\modules`
...
- Does it contain "Prompt 659: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\terraform\\modules`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 659: Executed"
...
## If PASSED
Say: "✅ Prompt 659 verified successfully. Ready for Prompt 660."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 659.
