# Verification for Prompt 698

## Task: Verify that Prompt 698 executed correctly

**Folder that was processed:** `manifest\\checksums`
...
- Does it contain "Prompt 698: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `manifest\\checksums`, determine the owner:
...
- Does the feature name match or relate to "Checksums"?
...
✅/❌ Progress.md contains "Prompt 698: Executed"
...
## If PASSED
Say: "✅ Prompt 698 verified successfully. Ready for Prompt 699."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 698.
