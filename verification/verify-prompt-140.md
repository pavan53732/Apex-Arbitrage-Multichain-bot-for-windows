# Verification for Prompt 140

## Task: Verify that Prompt 140 executed correctly

**Folder that was processed:** `backend\\plugins\\bridge-adapters\\docs`
...
- Does it contain "Prompt 140: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\plugins\\bridge-adapters\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 140: Executed"
...
## If PASSED
Say: "✅ Prompt 140 verified successfully. Ready for Prompt 141."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 140.
