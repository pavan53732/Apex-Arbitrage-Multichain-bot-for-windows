# Verification for Prompt 793

## Task: Verify that Prompt 793 executed correctly

**Folder that was processed:** `tests\\mocks`
...
- Does it contain "Prompt 793: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `tests\\mocks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 793: Executed"
...
## If PASSED
Say: "✅ Prompt 793 verified successfully. Ready for Prompt 794."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 793.
