# Verification Prompt for Prompt 306

## Your Task: Verify Execution of Prompt 306

You are verifying that **Prompt 306** was executed correctly.

### What Prompt 306 Should Have Done:

**Folder Analyzed:** `dashboard\\ai\\hooks`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 306:"
```
**Expected:** Should find entry like "Prompt 306: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\ai\\hooks`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 306
================================
...
Confirm: "Prompt 306 executed correctly. Ready for Prompt 307."
