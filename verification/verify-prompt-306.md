# Verification for Prompt 306

## Task: Verify that Prompt 306 executed correctly

**Folder that was processed:** `dashboard\\ai\\hooks`
...
- Does it contain "Prompt 306: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\hooks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 306: Executed"
...
## If PASSED
Say: "✅ Prompt 306 verified successfully. Ready for Prompt 307."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 306.
