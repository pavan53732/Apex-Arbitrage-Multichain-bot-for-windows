# Verification Prompt for Prompt 771

## Your Task: Verify Execution of Prompt 771

You are verifying that **Prompt 771** was executed correctly.

### What Prompt 771 Should Have Done:

**Folder Analyzed:** `scripts\\automation`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 771:"
```
**Expected:** Should find entry like "Prompt 771: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `scripts\\automation`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 771
================================
...
Confirm: "Prompt 771 executed correctly. Ready for Prompt 772."
