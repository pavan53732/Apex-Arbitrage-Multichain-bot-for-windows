# Verification for Prompt 771

## Task: Verify that Prompt 771 executed correctly

**Folder that was processed:** `scripts\\automation`
...
- Does it contain "Prompt 771: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `scripts\\automation`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 771: Executed"
...
## If PASSED
Say: "✅ Prompt 771 verified successfully. Ready for Prompt 772."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 771.
