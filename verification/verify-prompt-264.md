# Verification for Prompt 264

## Task: Verify that Prompt 264 executed correctly

**Folder that was processed:** `config\\analytics`
...
- Does it contain "Prompt 264: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\analytics`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 264: Executed"
...
## If PASSED
Say: "✅ Prompt 264 verified successfully. Ready for Prompt 265."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 264.
