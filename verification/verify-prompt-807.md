# Verification for Prompt 807

## Task: Verify that Prompt 807 executed correctly

**Folder that was processed:** `third-party\\schemas`
...
- Does it contain "Prompt 807: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `third-party\\schemas`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 807: Executed"
...
## If PASSED
Say: "✅ Prompt 807 verified successfully. Ready for Prompt 808."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 807.
