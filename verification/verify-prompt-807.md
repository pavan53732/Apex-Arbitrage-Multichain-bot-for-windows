# Verification Prompt for Prompt 807

## Your Task: Verify Execution of Prompt 807

You are verifying that **Prompt 807** was executed correctly.

### What Prompt 807 Should Have Done:

**Folder Analyzed:** `third-party\\schemas`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 807:"
```
**Expected:** Should find entry like "Prompt 807: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `third-party\\schemas`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 807
================================
...
Confirm: "Prompt 807 executed correctly. Ready for Prompt 808."
