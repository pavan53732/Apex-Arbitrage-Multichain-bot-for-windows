# Verification Prompt for Prompt 16

## Your Task: Verify Execution of Prompt 16

You are verifying that **Prompt 16** was executed correctly.

### What Prompt 16 Should Have Done:

**Folder Analyzed:** `archive\\deprecated-modules\\ui-backup-2023-12`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 16:"
```
**Expected:** Should find entry like "Prompt 16: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\deprecated-modules\\ui-backup-2023-12`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Ui Backup 2023 12"
```
**Expected:** Should find feature section with name containing "Ui Backup 2023 12"
...
Confirm: "Prompt 16 executed correctly. Ready for Prompt 17."
