# Verification for Prompt 327

## Task: Verify that Prompt 327 executed correctly

**Folder that was processed:** `dashboard\\analytics\\tests`
...
- Does it contain "Prompt 327: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 327: Executed"
...
## If PASSED
Say: "✅ Prompt 327 verified successfully. Ready for Prompt 328."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 327.
