# Verification for Prompt 152

## Task: Verify that Prompt 152 executed correctly

**Folder that was processed:** `backend\\plugins\\insurance`
...
- Does it contain "Prompt 152: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\plugins\\insurance`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 152: Executed"
...
## If PASSED
Say: "✅ Prompt 152 verified successfully. Ready for Prompt 153."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 152.
