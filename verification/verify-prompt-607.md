# Verification Prompt for Prompt 607

## Your Task: Verify Execution of Prompt 607

You are verifying that **Prompt 607** was executed correctly.

### What Prompt 607 Should Have Done:

**Folder Analyzed:** `data\\backups\\db-dumps`
**Expected Feature Name:** `Db Dumps`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 607:"
```
**Expected:** Should find entry like "Prompt 607: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\backups\\db-dumps`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Db Dumps"
```
**Expected:** Should find feature section with name containing "Db Dumps"
...
```
VERIFICATION REPORT - PROMPT 607
================================
...
Confirm: "Prompt 607 executed correctly. Ready for Prompt 608."
