# Verification for Prompt 607

## Task: Verify that Prompt 607 executed correctly

**Folder that was processed:** `data\\backups\\db-dumps`
...
- Does it contain "Prompt 607: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\backups\\db-dumps`, determine the owner:
...
- Does the feature name match or relate to "Db Dumps"?
...
✅/❌ Progress.md contains "Prompt 607: Executed"
...
## If PASSED
Say: "✅ Prompt 607 verified successfully. Ready for Prompt 608."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 607.
