# Verification for Prompt 71

## Task: Verify that Prompt 71 executed correctly

**Folder that was processed:** `backend\\docs\\formal`
...
- Does it contain "Prompt 71: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\docs\\formal`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 71: Executed"
...
## If PASSED
Say: "✅ Prompt 71 verified successfully. Ready for Prompt 72."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 71.
