# Verification for Prompt 38

## Task: Verify that Prompt 38 executed correctly

**Folder that was processed:** `backend\\contracts\\src\\governance`
**Expected feature name:** `Governance`
...
- Does it contain "Prompt 38: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\contracts\\src\\governance`, determine the owner:
...
- Does the feature name match or relate to "Governance"?
...
```
VERIFICATION REPORT - PROMPT 38
==========================================

✅/❌ Progress.md contains "Prompt 38: Executed"
...
## If PASSED
Say: "✅ Prompt 38 verified successfully. Ready for Prompt 39."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 38.
