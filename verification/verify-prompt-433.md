# Verification for Prompt 433

## Task: Verify that Prompt 433 executed correctly

**Folder that was processed:** `dashboard\\docs\\dashboard`
...
- Does it contain "Prompt 433: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\docs\\dashboard`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 433: Executed"
...
## If PASSED
Say: "✅ Prompt 433 verified successfully. Ready for Prompt 434."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 433.
