...
## Task: Verify that Prompt 4 executed correctly

**Folder that was processed:** `ai-modules\\integration`
...
- Does it contain "Prompt 4: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules\\integration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 4: Executed"
...
## If PASSED
Say: "✅ Prompt 4 verified successfully. Ready for Prompt 5."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 4.
