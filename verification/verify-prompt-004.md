# Verification Prompt for Prompt 4

## Your Task: Verify Execution of Prompt 4

You are verifying that **Prompt 4** was executed correctly.

### What Prompt 4 Should Have Done:

**Folder Analyzed:** `ai-modules\\integration`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 4:"
```
**Expected:** Should find entry like "Prompt 4: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ai-modules\\integration`, determine which .md file should own this feature:
...
Confirm: "Prompt 4 executed correctly. Ready for Prompt 5."
