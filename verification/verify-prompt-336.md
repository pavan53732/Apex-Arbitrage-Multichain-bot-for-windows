# Verification Prompt for Prompt 336

## Your Task: Verify Execution of Prompt 336

You are verifying that **Prompt 336** was executed correctly.

### What Prompt 336 Should Have Done:

**Folder Analyzed:** `dashboard\\api\\schemas`
**Expected Feature Name:** `Schemas`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 336:"
```
**Expected:** Should find entry like "Prompt 336: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\api\\schemas`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Schemas"
```
**Expected:** Should find feature section with name containing "Schemas"
...
```
VERIFICATION REPORT - PROMPT 336
================================
...
Confirm: "Prompt 336 executed correctly. Ready for Prompt 337."
