# Verification for Prompt 336

## Task: Verify that Prompt 336 executed correctly

**Folder that was processed:** `dashboard\\api\\schemas`
...
- Does it contain "Prompt 336: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\api\\schemas`, determine the owner:
...
- Does the feature name match or relate to "Schemas"?
...
✅/❌ Progress.md contains "Prompt 336: Executed"
...
## If PASSED
Say: "✅ Prompt 336 verified successfully. Ready for Prompt 337."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 336.
