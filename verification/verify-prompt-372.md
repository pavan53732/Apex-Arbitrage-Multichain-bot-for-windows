# Verification for Prompt 372

## Task: Verify that Prompt 372 executed correctly

**Folder that was processed:** `dashboard\\components\\sandbox`
...
- Does it contain "Prompt 372: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\sandbox`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 372: Executed"
...
## If PASSED
Say: "✅ Prompt 372 verified successfully. Ready for Prompt 373."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 372.
