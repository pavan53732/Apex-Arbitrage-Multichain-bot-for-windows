# Verification for Prompt 767

## Task: Verify that Prompt 767 executed correctly

**Folder that was processed:** `research\\quantum`
...
- Does it contain "Prompt 767: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `research\\quantum`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 767: Executed"
...
## If PASSED
Say: "✅ Prompt 767 verified successfully. Ready for Prompt 768."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 767.
