# Verification Prompt for Prompt 596

## Your Task: Verify Execution of Prompt 596

You are verifying that **Prompt 596** was executed correctly.

### What Prompt 596 Should Have Done:

**Folder Analyzed:** `data\\analytics\\dashboards`
**Expected Feature Name:** `Dashboards`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 596:"
```
**Expected:** Should find entry like "Prompt 596: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\analytics\\dashboards`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Dashboards"
```
**Expected:** Should find feature section with name containing "Dashboards"
...
```
VERIFICATION REPORT - PROMPT 596
================================
...
Confirm: "Prompt 596 executed correctly. Ready for Prompt 597."
