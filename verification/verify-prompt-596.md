# Verification for Prompt 596

## Task: Verify that Prompt 596 executed correctly

**Folder that was processed:** `data\\analytics\\dashboards`
...
- Does it contain "Prompt 596: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\analytics\\dashboards`, determine the owner:
...
- Does the feature name match or relate to "Dashboards"?
...
✅/❌ Progress.md contains "Prompt 596: Executed"
...
## If PASSED
Say: "✅ Prompt 596 verified successfully. Ready for Prompt 597."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 596.
