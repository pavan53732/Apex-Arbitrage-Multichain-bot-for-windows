# Verification for Prompt 390

## Task: Verify that Prompt 390 executed correctly

**Folder that was processed:** `dashboard\\deploy`
...
- Does it contain "Prompt 390: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy`, determine the owner:
...
- Does the feature name match or relate to "Deploy"?
...
✅/❌ Progress.md contains "Prompt 390: Executed"
...
## If PASSED
Say: "✅ Prompt 390 verified successfully. Ready for Prompt 391."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 390.
