# Verification Prompt for Prompt 390

## Your Task: Verify Execution of Prompt 390

You are verifying that **Prompt 390** was executed correctly.

### What Prompt 390 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy`
**Expected Feature Name:** `Deploy`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 390:"
```
**Expected:** Should find entry like "Prompt 390: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Deploy"
```
**Expected:** Should find feature section with name containing "Deploy"
...
```
VERIFICATION REPORT - PROMPT 390
================================
...
Confirm: "Prompt 390 executed correctly. Ready for Prompt 391."
