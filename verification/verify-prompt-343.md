# Verification for Prompt 343

## Task: Verify that Prompt 343 executed correctly

**Folder that was processed:** `dashboard\\ar\\config`
...
- Does it contain "Prompt 343: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\config`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 343: Executed"
...
## If PASSED
Say: "✅ Prompt 343 verified successfully. Ready for Prompt 344."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 343.
