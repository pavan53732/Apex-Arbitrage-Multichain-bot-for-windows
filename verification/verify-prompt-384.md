# Verification Prompt for Prompt 384

## Your Task: Verify Execution of Prompt 384

You are verifying that **Prompt 384** was executed correctly.

### What Prompt 384 Should Have Done:

**Folder Analyzed:** `dashboard\\data\\forensics`
**Expected Feature Name:** `Forensics`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 384:"
```
**Expected:** Should find entry like "Prompt 384: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\data\\forensics`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Forensics"
```
**Expected:** Should find feature section with name containing "Forensics"
...
```
VERIFICATION REPORT - PROMPT 384
================================
...
Confirm: "Prompt 384 executed correctly. Ready for Prompt 385."
