# Verification for Prompt 384

## Task: Verify that Prompt 384 executed correctly

**Folder that was processed:** `dashboard\\data\\forensics`
...
- Does it contain "Prompt 384: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\forensics`, determine the owner:
...
- Does the feature name match or relate to "Forensics"?
...
✅/❌ Progress.md contains "Prompt 384: Executed"
...
## If PASSED
Say: "✅ Prompt 384 verified successfully. Ready for Prompt 385."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 384.
