# Verification for Prompt 656

## Task: Verify that Prompt 656 executed correctly

**Folder that was processed:** `deploy\\scripts`
...
- Does it contain "Prompt 656: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 656: Executed"
...
## If PASSED
Say: "✅ Prompt 656 verified successfully. Ready for Prompt 657."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 656.
