# Verification Prompt for Prompt 621

## Your Task: Verify Execution of Prompt 621

You are verifying that **Prompt 621** was executed correctly.

### What Prompt 621 Should Have Done:

**Folder Analyzed:** `data\\simulation-results`
**Expected Feature Name:** `Simulation Results`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 621:"
```
**Expected:** Should find entry like "Prompt 621: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\simulation-results`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Simulation Results"
```
**Expected:** Should find feature section with name containing "Simulation Results"
...
```
VERIFICATION REPORT - PROMPT 621
================================
...
Confirm: "Prompt 621 executed correctly. Ready for Prompt 622."
