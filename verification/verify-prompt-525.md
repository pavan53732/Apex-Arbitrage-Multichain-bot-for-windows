# Verification for Prompt 525

## Task: Verify that Prompt 525 executed correctly

**Folder that was processed:** `dashboard\\public\\fonts`
...
- Does it contain "Prompt 525: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\public\\fonts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 525: Executed"
...
## If PASSED
Say: "✅ Prompt 525 verified successfully. Ready for Prompt 526."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 525.
