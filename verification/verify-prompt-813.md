# Verification Prompt for Prompt 813

## Your Task: Verify Execution of Prompt 813

You are verifying that **Prompt 813** was executed correctly.

### What Prompt 813 Should Have Done:

**Folder Analyzed:** `types\\schema`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 813:"
```
**Expected:** Should find entry like "Prompt 813: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `types\\schema`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 813
================================
...
Confirm: "Prompt 813 executed correctly. Ready for Prompt 814."
