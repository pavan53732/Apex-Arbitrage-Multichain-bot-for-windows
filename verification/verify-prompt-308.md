# Verification for Prompt 308

## Task: Verify that Prompt 308 executed correctly

**Folder that was processed:** `dashboard\\ai\\models\\weights`
...
- Does it contain "Prompt 308: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\models\\weights`, determine the owner:
...
- Does the feature name match or relate to "Weights"?
...
✅/❌ Progress.md contains "Prompt 308: Executed"
...
## If PASSED
Say: "✅ Prompt 308 verified successfully. Ready for Prompt 309."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 308.
