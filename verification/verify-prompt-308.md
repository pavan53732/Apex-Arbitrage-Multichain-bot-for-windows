# Verification Prompt for Prompt 308

## Your Task: Verify Execution of Prompt 308

You are verifying that **Prompt 308** was executed correctly.

### What Prompt 308 Should Have Done:

**Folder Analyzed:** `dashboard\\ai\\models\\weights`
**Expected Feature Name:** `Weights`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 308:"
```
**Expected:** Should find entry like "Prompt 308: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\ai\\models\\weights`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Weights"
```
**Expected:** Should find feature section with name containing "Weights"
...
```
VERIFICATION REPORT - PROMPT 308
================================
...
Confirm: "Prompt 308 executed correctly. Ready for Prompt 309."
