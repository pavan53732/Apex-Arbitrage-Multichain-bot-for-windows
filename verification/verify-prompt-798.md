# Verification for Prompt 798

## Task: Verify that Prompt 798 executed correctly

**Folder that was processed:** `tests\\unit`
...
- Does it contain "Prompt 798: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `tests\\unit`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 798: Executed"
...
## If PASSED
Say: "✅ Prompt 798 verified successfully. Ready for Prompt 799."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 798.
