# Verification for Prompt 671

## Task: Verify that Prompt 671 executed correctly

**Folder that was processed:** `docs\\legal`
...
- Does it contain "Prompt 671: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `docs\\legal`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 671: Executed"
...
## If PASSED
Say: "✅ Prompt 671 verified successfully. Ready for Prompt 672."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 671.
