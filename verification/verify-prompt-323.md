# Verification Prompt for Prompt 323

## Your Task: Verify Execution of Prompt 323

You are verifying that **Prompt 323** was executed correctly.

### What Prompt 323 Should Have Done:

**Folder Analyzed:** `dashboard\\analytics\\pages`
**Expected Feature Name:** `Pages`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 323:"
```
**Expected:** Should find entry like "Prompt 323: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\analytics\\pages`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Pages"
```
**Expected:** Should find feature section with name containing "Pages"
...
```
VERIFICATION REPORT - PROMPT 323
================================
...
Confirm: "Prompt 323 executed correctly. Ready for Prompt 324."
