# Verification for Prompt 323

## Task: Verify that Prompt 323 executed correctly

**Folder that was processed:** `dashboard\\analytics\\pages`
...
- Does it contain "Prompt 323: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\pages`, determine the owner:
...
- Does the feature name match or relate to "Pages"?
...
✅/❌ Progress.md contains "Prompt 323: Executed"
...
## If PASSED
Say: "✅ Prompt 323 verified successfully. Ready for Prompt 324."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 323.
