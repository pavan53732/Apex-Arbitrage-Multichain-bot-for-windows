# Verification for Prompt 320

## Task: Verify that Prompt 320 executed correctly

**Folder that was processed:** `dashboard\\analytics\\explainability`
...
- Does it contain "Prompt 320: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\explainability`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 320: Executed"
...
## If PASSED
Say: "✅ Prompt 320 verified successfully. Ready for Prompt 321."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 320.
