# Verification Prompt for Prompt 3

## Your Task: Verify Execution of Prompt 3

You are verifying that **Prompt 3** was executed correctly.

### What Prompt 3 Should Have Done:

**Folder Analyzed:** `ai-modules\\features`
**Expected Feature Name:** `Features`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 3:"
```
**Expected:** Should find entry like "Prompt 3: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ai-modules\\features`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Features"
```
**Expected:** Should find feature section with name containing "Features"
...
Confirm: "Prompt 3 executed correctly. Ready for Prompt 4."
