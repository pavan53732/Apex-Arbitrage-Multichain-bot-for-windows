...
## Task: Verify that Prompt 3 executed correctly

**Folder that was processed:** `ai-modules\\features`
...
- Does it contain "Prompt 3: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules\\features`, determine the owner:
...
- Does the feature name match or relate to "Features"?
...
✅/❌ Progress.md contains "Prompt 3: Executed"
...
## If PASSED
Say: "✅ Prompt 3 verified successfully. Ready for Prompt 4."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 3.
