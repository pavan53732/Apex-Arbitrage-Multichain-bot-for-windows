# Verification for Prompt 535

## Task: Verify that Prompt 535 executed correctly

**Folder that was processed:** `dashboard\\state\\demo`
...
- Does it contain "Prompt 535: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\state\\demo`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 535: Executed"
...
## If PASSED
Say: "✅ Prompt 535 verified successfully. Ready for Prompt 536."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 535.
