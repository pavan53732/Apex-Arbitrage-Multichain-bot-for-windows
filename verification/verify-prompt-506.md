# Verification for Prompt 506

## Task: Verify that Prompt 506 executed correctly

**Folder that was processed:** `dashboard\\plugins\\model-marketplace`
...
- Does it contain "Prompt 506: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\model-marketplace`, determine the owner:
...
- Does the feature name match or relate to "Model Marketplace"?
...
✅/❌ Progress.md contains "Prompt 506: Executed"
...
## If PASSED
Say: "✅ Prompt 506 verified successfully. Ready for Prompt 507."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 506.
