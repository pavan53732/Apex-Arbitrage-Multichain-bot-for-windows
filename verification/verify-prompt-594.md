# Verification for Prompt 594

## Task: Verify that Prompt 594 executed correctly

**Folder that was processed:** `data\\analytics\\ai-explainer`
...
- Does it contain "Prompt 594: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\analytics\\ai-explainer`, determine the owner:
...
- Does the feature name match or relate to "Ai Explainer"?
...
✅/❌ Progress.md contains "Prompt 594: Executed"
...
## If PASSED
Say: "✅ Prompt 594 verified successfully. Ready for Prompt 595."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 594.
