# Verification for Prompt 369

## Task: Verify that Prompt 369 executed correctly

**Folder that was processed:** `dashboard\\components\\operator`
...
- Does it contain "Prompt 369: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\operator`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 369: Executed"
...
## If PASSED
Say: "✅ Prompt 369 verified successfully. Ready for Prompt 370."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 369.
