# Verification for Prompt 733

## Task: Verify that Prompt 733 executed correctly

**Folder that was processed:** `presets\\ai`
...
- Does it contain "Prompt 733: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `presets\\ai`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 733: Executed"
...
## If PASSED
Say: "✅ Prompt 733 verified successfully. Ready for Prompt 734."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 733.
