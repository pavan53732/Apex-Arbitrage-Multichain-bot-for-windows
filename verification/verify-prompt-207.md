# Verification Prompt for Prompt 207

## Your Task: Verify Execution of Prompt 207

You are verifying that **Prompt 207** was executed correctly.

### What Prompt 207 Should Have Done:

**Folder Analyzed:** `backend\\tests\\migration`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 207:"
```
**Expected:** Should find entry like "Prompt 207: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\tests\\migration`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 207
================================
...
Confirm: "Prompt 207 executed correctly. Ready for Prompt 208."
