# Verification for Prompt 207

## Task: Verify that Prompt 207 executed correctly

**Folder that was processed:** `backend\\tests\\migration`
...
- Does it contain "Prompt 207: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\tests\\migration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 207: Executed"
...
## If PASSED
Say: "✅ Prompt 207 verified successfully. Ready for Prompt 208."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 207.
