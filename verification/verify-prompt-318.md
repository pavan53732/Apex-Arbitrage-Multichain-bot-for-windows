# Verification for Prompt 318

## Task: Verify that Prompt 318 executed correctly

**Folder that was processed:** `dashboard\\analytics\\config`
...
- Does it contain "Prompt 318: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\config`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 318: Executed"
...
## If PASSED
Say: "✅ Prompt 318 verified successfully. Ready for Prompt 319."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 318.
