# Verification for Prompt 236

## Task: Verify that Prompt 236 executed correctly

**Folder that was processed:** `benchmarks\\mempool`
...
- Does it contain "Prompt 236: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `benchmarks\\mempool`, determine the owner:
...
- Does the feature name match or relate to "Mempool"?
...
✅/❌ Progress.md contains "Prompt 236: Executed"
...
## If PASSED
Say: "✅ Prompt 236 verified successfully. Ready for Prompt 237."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 236.
