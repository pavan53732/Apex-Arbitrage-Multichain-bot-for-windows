# Verification Prompt for Prompt 825

## Your Task: Verify Execution of Prompt 825

You are verifying that **Prompt 825** was executed correctly.

### What Prompt 825 Should Have Done:

**Folder Analyzed:** `utils\\sim`
**Expected Feature Name:** `Sim`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 825:"
```
**Expected:** Should find entry like "Prompt 825: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `utils\\sim`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Sim"
```
**Expected:** Should find feature section with name containing "Sim"
...
```
VERIFICATION REPORT - PROMPT 825
================================
...
Confirm: "Prompt 825 executed correctly. Ready for Prompt 826."
