# Verification for Prompt 571

## Task: Verify that Prompt 571 executed correctly

**Folder that was processed:** `dashboard\\theme\\fonts`
...
- Does it contain "Prompt 571: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\theme\\fonts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 571: Executed"
...
## If PASSED
Say: "✅ Prompt 571 verified successfully. Ready for Prompt 572."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 571.
