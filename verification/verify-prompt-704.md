# Verification for Prompt 704

## Task: Verify that Prompt 704 executed correctly

**Folder that was processed:** `manifest\\templates`
...
- Does it contain "Prompt 704: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `manifest\\templates`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 704: Executed"
...
## If PASSED
Say: "✅ Prompt 704 verified successfully. Ready for Prompt 705."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 704.
