# Verification for Prompt 321

## Task: Verify that Prompt 321 executed correctly

**Folder that was processed:** `dashboard\\analytics\\hooks`
...
- Does it contain "Prompt 321: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\hooks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 321: Executed"
...
## If PASSED
Say: "✅ Prompt 321 verified successfully. Ready for Prompt 322."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 321.
