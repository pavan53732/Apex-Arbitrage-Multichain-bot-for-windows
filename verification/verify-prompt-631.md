# Verification for Prompt 631

## Task: Verify that Prompt 631 executed correctly

**Folder that was processed:** `deploy\\ansible`
...
- Does it contain "Prompt 631: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\ansible`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 631: Executed"
...
## If PASSED
Say: "✅ Prompt 631 verified successfully. Ready for Prompt 632."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 631.
