# Verification for Prompt 500

## Task: Verify that Prompt 500 executed correctly

**Folder that was processed:** `dashboard\\plugins\\insurance\\tests`
...
- Does it contain "Prompt 500: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\insurance\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 500: Executed"
...
## If PASSED
Say: "✅ Prompt 500 verified successfully. Ready for Prompt 501."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 500.
