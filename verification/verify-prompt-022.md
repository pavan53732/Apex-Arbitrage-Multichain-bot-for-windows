# Verification for Prompt 22

## Task: Verify that Prompt 22 executed correctly

**Folder that was processed:** `archive\\docs\\migration-notes`
...
- Does it contain "Prompt 22: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\docs\\migration-notes`, determine the owner:
...
- Does the feature name match or relate to "Migration Notes"?
...
✅/❌ Progress.md contains "Prompt 22: Executed"
...
## If PASSED
Say: "✅ Prompt 22 verified successfully. Ready for Prompt 23."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 22.
