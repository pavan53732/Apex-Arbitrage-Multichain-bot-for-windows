# Verification Prompt for Prompt 22

## Your Task: Verify Execution of Prompt 22

You are verifying that **Prompt 22** was executed correctly.

### What Prompt 22 Should Have Done:

**Folder Analyzed:** `archive\\docs\\migration-notes`
**Expected Feature Name:** `Migration Notes`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 22:"
```
**Expected:** Should find entry like "Prompt 22: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\docs\\migration-notes`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Migration Notes"
```
**Expected:** Should find feature section with name containing "Migration Notes"
...
Confirm: "Prompt 22 executed correctly. Ready for Prompt 23."
