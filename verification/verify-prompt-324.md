# Verification Prompt for Prompt 324

## Your Task: Verify Execution of Prompt 324

You are verifying that **Prompt 324** was executed correctly.

### What Prompt 324 Should Have Done:

**Folder Analyzed:** `dashboard\\analytics\\panels`
**Expected Feature Name:** `Panels`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 324:"
```
**Expected:** Should find entry like "Prompt 324: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\analytics\\panels`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Panels"
```
**Expected:** Should find feature section with name containing "Panels"
...
```
VERIFICATION REPORT - PROMPT 324
================================
...
Confirm: "Prompt 324 executed correctly. Ready for Prompt 325."
