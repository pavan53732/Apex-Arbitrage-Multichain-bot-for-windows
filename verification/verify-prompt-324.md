# Verification for Prompt 324

## Task: Verify that Prompt 324 executed correctly

**Folder that was processed:** `dashboard\\analytics\\panels`
...
- Does it contain "Prompt 324: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\panels`, determine the owner:
...
- Does the feature name match or relate to "Panels"?
...
✅/❌ Progress.md contains "Prompt 324: Executed"
...
## If PASSED
Say: "✅ Prompt 324 verified successfully. Ready for Prompt 325."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 324.
