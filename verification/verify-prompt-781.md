# Verification for Prompt 781

## Task: Verify that Prompt 781 executed correctly

**Folder that was processed:** `storage\\secret-backups`
...
- Does it contain "Prompt 781: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `storage\\secret-backups`, determine the owner:
...
- Does the feature name match or relate to "Secret Backups"?
...
✅/❌ Progress.md contains "Prompt 781: Executed"
...
## If PASSED
Say: "✅ Prompt 781 verified successfully. Ready for Prompt 782."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 781.
