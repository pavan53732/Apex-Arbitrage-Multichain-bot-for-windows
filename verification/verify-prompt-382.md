# Verification for Prompt 382

## Task: Verify that Prompt 382 executed correctly

**Folder that was processed:** `dashboard\\data\\compliance-archive`
...
- Does it contain "Prompt 382: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\compliance-archive`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 382: Executed"
...
## If PASSED
Say: "✅ Prompt 382 verified successfully. Ready for Prompt 383."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 382.
