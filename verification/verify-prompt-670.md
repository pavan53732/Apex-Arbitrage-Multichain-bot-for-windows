# Verification for Prompt 670

## Task: Verify that Prompt 670 executed correctly

**Folder that was processed:** `docs\\dashboard`
...
- Does it contain "Prompt 670: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `docs\\dashboard`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 670: Executed"
...
## If PASSED
Say: "✅ Prompt 670 verified successfully. Ready for Prompt 671."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 670.
