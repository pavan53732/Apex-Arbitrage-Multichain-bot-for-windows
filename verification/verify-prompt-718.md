# Verification for Prompt 718

## Task: Verify that Prompt 718 executed correctly

**Folder that was processed:** `overlays\\ar\\demo`
...
- Does it contain "Prompt 718: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `overlays\\ar\\demo`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 718: Executed"
...
## If PASSED
Say: "✅ Prompt 718 verified successfully. Ready for Prompt 719."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 718.
