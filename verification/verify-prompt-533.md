# Verification for Prompt 533

## Task: Verify that Prompt 533 executed correctly

**Folder that was processed:** `dashboard\\src`
...
- Does it contain "Prompt 533: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\src`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 533: Executed"
...
## If PASSED
Say: "✅ Prompt 533 verified successfully. Ready for Prompt 534."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 533.
