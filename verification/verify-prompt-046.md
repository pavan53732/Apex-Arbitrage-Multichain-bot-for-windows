# Verification for Prompt 46

## Task: Verify that Prompt 46 executed correctly

**Folder that was processed:** `backend\\core\\data\\simulation-snapshots`
...
- Does it contain "Prompt 46: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\core\\data\\simulation-snapshots`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 46: Executed"
...
## If PASSED
Say: "✅ Prompt 46 verified successfully. Ready for Prompt 47."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 46.
