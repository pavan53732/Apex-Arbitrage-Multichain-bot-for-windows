# Verification for Prompt 744

## Task: Verify that Prompt 744 executed correctly

**Folder that was processed:** `public\\brand`
...
- Does it contain "Prompt 744: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `public\\brand`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 744: Executed"
...
## If PASSED
Say: "✅ Prompt 744 verified successfully. Ready for Prompt 745."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 744.
