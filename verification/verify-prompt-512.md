# Verification for Prompt 512

## Task: Verify that Prompt 512 executed correctly

**Folder that was processed:** `dashboard\\plugins\\social-impact\\docs`
...
- Does it contain "Prompt 512: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\social-impact\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 512: Executed"
...
## If PASSED
Say: "✅ Prompt 512 verified successfully. Ready for Prompt 513."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 512.
