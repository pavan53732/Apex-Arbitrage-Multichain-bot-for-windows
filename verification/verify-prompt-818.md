# Verification for Prompt 818

## Task: Verify that Prompt 818 executed correctly

**Folder that was processed:** `utils\\devtools`
...
- Does it contain "Prompt 818: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `utils\\devtools`, determine the owner:
...
- Does the feature name match or relate to "Devtools"?
...
✅/❌ Progress.md contains "Prompt 818: Executed"
...
## If PASSED
Say: "✅ Prompt 818 verified successfully. Ready for Prompt 819."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 818.
