# Verification for Prompt 717

## Task: Verify that Prompt 717 executed correctly

**Folder that was processed:** `overlays\\ar`
...
- Does it contain "Prompt 717: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `overlays\\ar`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 717: Executed"
...
## If PASSED
Say: "✅ Prompt 717 verified successfully. Ready for Prompt 718."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 717.
