# Verification for Prompt 265

## Task: Verify that Prompt 265 executed correctly

**Folder that was processed:** `config\\api-snapshots`
...
- Does it contain "Prompt 265: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\api-snapshots`, determine the owner:
...
- Does the feature name match or relate to "Api Snapshots"?
...
✅/❌ Progress.md contains "Prompt 265: Executed"
...
## If PASSED
Say: "✅ Prompt 265 verified successfully. Ready for Prompt 266."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 265.
