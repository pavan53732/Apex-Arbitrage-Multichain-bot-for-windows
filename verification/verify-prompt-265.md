# Verification Prompt for Prompt 265

## Your Task: Verify Execution of Prompt 265

You are verifying that **Prompt 265** was executed correctly.

### What Prompt 265 Should Have Done:

**Folder Analyzed:** `config\\api-snapshots`
**Expected Feature Name:** `Api Snapshots`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 265:"
```
**Expected:** Should find entry like "Prompt 265: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `config\\api-snapshots`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Api Snapshots"
```
**Expected:** Should find feature section with name containing "Api Snapshots"
...
```
VERIFICATION REPORT - PROMPT 265
================================
...
Confirm: "Prompt 265 executed correctly. Ready for Prompt 266."
