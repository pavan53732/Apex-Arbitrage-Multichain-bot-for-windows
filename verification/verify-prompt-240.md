# Verification Prompt for Prompt 240

## Your Task: Verify Execution of Prompt 240

You are verifying that **Prompt 240** was executed correctly.

### What Prompt 240 Should Have Done:

**Folder Analyzed:** `ci`
**Expected Feature Name:** `Ci`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 240:"
```
**Expected:** Should find entry like "Prompt 240: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ci`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Ci"
```
**Expected:** Should find feature section with name containing "Ci"
...
```
VERIFICATION REPORT - PROMPT 240
================================
...
Confirm: "Prompt 240 executed correctly. Ready for Prompt 241."
