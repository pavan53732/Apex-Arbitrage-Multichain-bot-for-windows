# Verification for Prompt 240

## Task: Verify that Prompt 240 executed correctly

**Folder that was processed:** `ci`
...
- Does the feature name match or relate to "Ci"?
...
✅/❌ Progress.md contains "Prompt 240: Executed"
...
## If PASSED
Say: "✅ Prompt 240 verified successfully. Ready for Prompt 241."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 240.
