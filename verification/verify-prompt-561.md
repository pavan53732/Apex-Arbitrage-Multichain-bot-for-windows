# Verification for Prompt 561

## Task: Verify that Prompt 561 executed correctly

**Folder that was processed:** `dashboard\\tests\\plugin`
...
- Does it contain "Prompt 561: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\plugin`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 561: Executed"
...
## If PASSED
Say: "✅ Prompt 561 verified successfully. Ready for Prompt 562."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 561.
