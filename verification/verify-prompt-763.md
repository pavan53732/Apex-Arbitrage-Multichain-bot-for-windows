# Verification Prompt for Prompt 763

## Your Task: Verify Execution of Prompt 763

You are verifying that **Prompt 763** was executed correctly.

### What Prompt 763 Should Have Done:

**Folder Analyzed:** `research\\experiments`
**Expected Feature Name:** `Experiments`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 763:"
```
**Expected:** Should find entry like "Prompt 763: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `research\\experiments`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Experiments"
```
**Expected:** Should find feature section with name containing "Experiments"
...
```
VERIFICATION REPORT - PROMPT 763
================================
...
Confirm: "Prompt 763 executed correctly. Ready for Prompt 764."
