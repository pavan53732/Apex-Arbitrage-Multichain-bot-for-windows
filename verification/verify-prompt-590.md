# Verification for Prompt 590

## Task: Verify that Prompt 590 executed correctly

**Folder that was processed:** `data`
...
- Does it contain "Prompt 590: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 590: Executed"
...
## If PASSED
Say: "✅ Prompt 590 verified successfully. Ready for Prompt 591."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 590.
