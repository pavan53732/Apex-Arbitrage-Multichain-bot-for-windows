# Verification for Prompt 385

## Task: Verify that Prompt 385 executed correctly

**Folder that was processed:** `dashboard\\data\\logs`
...
- Does it contain "Prompt 385: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\logs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 385: Executed"
...
## If PASSED
Say: "✅ Prompt 385 verified successfully. Ready for Prompt 386."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 385.
