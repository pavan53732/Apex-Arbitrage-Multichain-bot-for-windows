# Verification Prompt for Prompt 710

## Your Task: Verify Execution of Prompt 710

You are verifying that **Prompt 710** was executed correctly.

### What Prompt 710 Should Have Done:

**Folder Analyzed:** `migrations\\flyway`
**Expected Feature Name:** `Flyway`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 710:"
```
**Expected:** Should find entry like "Prompt 710: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `migrations\\flyway`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Flyway"
```
**Expected:** Should find feature section with name containing "Flyway"
...
```
VERIFICATION REPORT - PROMPT 710
================================
...
Confirm: "Prompt 710 executed correctly. Ready for Prompt 711."
