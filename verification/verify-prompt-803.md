# Verification for Prompt 803

## Task: Verify that Prompt 803 executed correctly

**Folder that was processed:** `third-party\\compliance-hooks`
**Expected feature name:** `Compliance Hooks`
...
- Does it contain "Prompt 803: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `third-party\\compliance-hooks`, determine the owner:
...
- Does the feature name match or relate to "Compliance Hooks"?
...
```
VERIFICATION REPORT - PROMPT 803
==========================================

✅/❌ Progress.md contains "Prompt 803: Executed"
...
## If PASSED
Say: "✅ Prompt 803 verified successfully. Ready for Prompt 804."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 803.
