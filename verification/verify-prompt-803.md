# Verification Prompt for Prompt 803

## Your Task: Verify Execution of Prompt 803

You are verifying that **Prompt 803** was executed correctly.

### What Prompt 803 Should Have Done:

**Folder Analyzed:** `third-party\\compliance-hooks`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 803:"
```
**Expected:** Should find entry like "Prompt 803: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `third-party\\compliance-hooks`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Compliance Hooks"
```
**Expected:** Should find feature section with name containing "Compliance Hooks"
...
Confirm: "Prompt 803 executed correctly. Ready for Prompt 804."
