# Verification for Prompt 829

## Task: Verify that Prompt 829 executed correctly

**Folder that was processed:** `vendor\\abi`
...
- Does it contain "Prompt 829: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `vendor\\abi`, determine the owner:
...
- Does the feature name match or relate to "Abi"?
...
✅/❌ Progress.md contains "Prompt 829: Executed"
...
## If PASSED
Say: "✅ Prompt 829 verified successfully. Ready for Prompt 830."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 829.
