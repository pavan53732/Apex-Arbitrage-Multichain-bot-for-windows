# Verification for Prompt 650

## Task: Verify that Prompt 650 executed correctly

**Folder that was processed:** `deploy\\kubernetes\\overlays\\local`
...
- Does it contain "Prompt 650: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\kubernetes\\overlays\\local`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 650: Executed"
...
## If PASSED
Say: "✅ Prompt 650 verified successfully. Ready for Prompt 651."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 650.
