# Verification for Prompt 720

## Task: Verify that Prompt 720 executed correctly

**Folder that was processed:** `overlays\\debug`
...
- Does it contain "Prompt 720: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `overlays\\debug`, determine the owner:
...
- Does the feature name match or relate to "Debug"?
...
✅/❌ Progress.md contains "Prompt 720: Executed"
...
## If PASSED
Say: "✅ Prompt 720 verified successfully. Ready for Prompt 721."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 720.
