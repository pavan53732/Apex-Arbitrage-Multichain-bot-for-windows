# Verification Prompt for Prompt 720

## Your Task: Verify Execution of Prompt 720

You are verifying that **Prompt 720** was executed correctly.

### What Prompt 720 Should Have Done:

**Folder Analyzed:** `overlays\\debug`
**Expected Feature Name:** `Debug`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 720:"
```
**Expected:** Should find entry like "Prompt 720: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `overlays\\debug`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Debug"
```
**Expected:** Should find feature section with name containing "Debug"
...
```
VERIFICATION REPORT - PROMPT 720
================================
...
Confirm: "Prompt 720 executed correctly. Ready for Prompt 721."
