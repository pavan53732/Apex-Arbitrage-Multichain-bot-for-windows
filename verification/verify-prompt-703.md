# Verification for Prompt 703

## Task: Verify that Prompt 703 executed correctly

**Folder that was processed:** `manifest\\stats`
...
- Does it contain "Prompt 703: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `manifest\\stats`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 703: Executed"
...
## If PASSED
Say: "✅ Prompt 703 verified successfully. Ready for Prompt 704."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 703.
