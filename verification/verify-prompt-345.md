# Verification for Prompt 345

## Task: Verify that Prompt 345 executed correctly

**Folder that was processed:** `dashboard\\ar\\fixtures`
...
- Does it contain "Prompt 345: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\fixtures`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 345: Executed"
...
## If PASSED
Say: "✅ Prompt 345 verified successfully. Ready for Prompt 346."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 345.
