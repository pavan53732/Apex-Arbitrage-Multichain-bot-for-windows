# Verification for Prompt 443

## Task: Verify that Prompt 443 executed correctly

**Folder that was processed:** `dashboard\\extensions`
...
- Does it contain "Prompt 443: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\extensions`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 443: Executed"
...
## If PASSED
Say: "✅ Prompt 443 verified successfully. Ready for Prompt 444."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 443.
