# Verification for Prompt 352

## Task: Verify that Prompt 352 executed correctly

**Folder that was processed:** `dashboard\\ar\\tests`
...
- Does it contain "Prompt 352: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 352: Executed"
...
## If PASSED
Say: "✅ Prompt 352 verified successfully. Ready for Prompt 353."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 352.
