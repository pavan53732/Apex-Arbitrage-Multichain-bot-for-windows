# Verification for Prompt 346

## Task: Verify that Prompt 346 executed correctly

**Folder that was processed:** `dashboard\\ar\\hooks`
...
- Does it contain "Prompt 346: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\hooks`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 346: Executed"
...
## If PASSED
Say: "✅ Prompt 346 verified successfully. Ready for Prompt 347."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 346.
