# Verification for Prompt 330

## Task: Verify that Prompt 330 executed correctly

**Folder that was processed:** `dashboard\\api`
...
- Does it contain "Prompt 330: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\api`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 330: Executed"
...
## If PASSED
Say: "✅ Prompt 330 verified successfully. Ready for Prompt 331."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 330.
