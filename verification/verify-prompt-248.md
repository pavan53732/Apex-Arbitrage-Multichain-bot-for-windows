# Verification Prompt for Prompt 248

## Your Task: Verify Execution of Prompt 248

You are verifying that **Prompt 248** was executed correctly.

### What Prompt 248 Should Have Done:

**Folder Analyzed:** `ci\\github`
**Expected Feature Name:** `Github`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 248:"
```
**Expected:** Should find entry like "Prompt 248: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ci\\github`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Github"
```
**Expected:** Should find feature section with name containing "Github"
...
```
VERIFICATION REPORT - PROMPT 248
================================
...
Confirm: "Prompt 248 executed correctly. Ready for Prompt 249."
