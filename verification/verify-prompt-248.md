# Verification for Prompt 248

## Task: Verify that Prompt 248 executed correctly

**Folder that was processed:** `ci\\github`
...
- Does it contain "Prompt 248: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\github`, determine the owner:
...
- Does the feature name match or relate to "Github"?
...
✅/❌ Progress.md contains "Prompt 248: Executed"
...
## If PASSED
Say: "✅ Prompt 248 verified successfully. Ready for Prompt 249."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 248.
