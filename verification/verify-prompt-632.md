# Verification for Prompt 632

## Task: Verify that Prompt 632 executed correctly

**Folder that was processed:** `deploy\\ansible\\group\_vars`
...
- Does it contain "Prompt 632: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\ansible\\group\_vars`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 632: Executed"
...
## If PASSED
Say: "✅ Prompt 632 verified successfully. Ready for Prompt 633."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 632.
