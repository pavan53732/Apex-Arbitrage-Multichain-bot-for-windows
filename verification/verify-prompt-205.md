# Verification Prompt for Prompt 205

## Your Task: Verify Execution of Prompt 205

You are verifying that **Prompt 205** was executed correctly.

### What Prompt 205 Should Have Done:

**Folder Analyzed:** `backend\\tests\\integration`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 205:"
```
**Expected:** Should find entry like "Prompt 205: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\tests\\integration`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 205
================================
...
Confirm: "Prompt 205 executed correctly. Ready for Prompt 206."
