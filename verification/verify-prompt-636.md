# Verification for Prompt 636

## Task: Verify that Prompt 636 executed correctly

**Folder that was processed:** `deploy\\ansible\\roles\\dashboard`
...
- Does it contain "Prompt 636: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\ansible\\roles\\dashboard`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 636: Executed"
...
## If PASSED
Say: "✅ Prompt 636 verified successfully. Ready for Prompt 637."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 636.
