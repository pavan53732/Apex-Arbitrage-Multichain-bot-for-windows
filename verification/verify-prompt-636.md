# Verification Prompt for Prompt 636

## Your Task: Verify Execution of Prompt 636

You are verifying that **Prompt 636** was executed correctly.

### What Prompt 636 Should Have Done:

**Folder Analyzed:** `deploy\\ansible\\roles\\dashboard`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 636:"
```
**Expected:** Should find entry like "Prompt 636: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `deploy\\ansible\\roles\\dashboard`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 636
================================
...
Confirm: "Prompt 636 executed correctly. Ready for Prompt 637."
