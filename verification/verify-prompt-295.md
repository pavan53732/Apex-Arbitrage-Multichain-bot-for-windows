# Verification Prompt for Prompt 295

## Your Task: Verify Execution of Prompt 295

You are verifying that **Prompt 295** was executed correctly.

### What Prompt 295 Should Have Done:

**Folder Analyzed:** `config\\versioning`
**Expected Feature Name:** `Versioning`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 295:"
```
**Expected:** Should find entry like "Prompt 295: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `config\\versioning`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Versioning"
```
**Expected:** Should find feature section with name containing "Versioning"
...
```
VERIFICATION REPORT - PROMPT 295
================================
...
Confirm: "Prompt 295 executed correctly. Ready for Prompt 296."
