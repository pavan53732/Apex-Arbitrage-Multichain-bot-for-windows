# Verification for Prompt 295

## Task: Verify that Prompt 295 executed correctly

**Folder that was processed:** `config\\versioning`
...
- Does it contain "Prompt 295: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\versioning`, determine the owner:
...
- Does the feature name match or relate to "Versioning"?
...
✅/❌ Progress.md contains "Prompt 295: Executed"
...
## If PASSED
Say: "✅ Prompt 295 verified successfully. Ready for Prompt 296."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 295.
