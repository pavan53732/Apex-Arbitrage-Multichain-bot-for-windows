# Verification for Prompt 626

## Task: Verify that Prompt 626 executed correctly

**Folder that was processed:** `data\\simulation-results\\shadow-fork`
...
- Does it contain "Prompt 626: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\simulation-results\\shadow-fork`, determine the owner:
...
- Does the feature name match or relate to "Shadow Fork"?
...
✅/❌ Progress.md contains "Prompt 626: Executed"
...
## If PASSED
Say: "✅ Prompt 626 verified successfully. Ready for Prompt 627."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 626.
