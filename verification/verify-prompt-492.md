# Verification for Prompt 492

## Task: Verify that Prompt 492 executed correctly

**Folder that was processed:** `dashboard\\plugins\\dex-adapters\\docs`
...
- Does it contain "Prompt 492: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\dex-adapters\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 492: Executed"
...
## If PASSED
Say: "✅ Prompt 492 verified successfully. Ready for Prompt 493."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 492.
