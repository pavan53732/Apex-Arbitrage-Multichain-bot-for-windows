# Verification for Prompt 263

## Task: Verify that Prompt 263 executed correctly

**Folder that was processed:** `config\\ai`
...
- Does it contain "Prompt 263: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\ai`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 263: Executed"
...
## If PASSED
Say: "✅ Prompt 263 verified successfully. Ready for Prompt 264."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 263.
