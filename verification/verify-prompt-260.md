# Verification for Prompt 260

## Task: Verify that Prompt 260 executed correctly

**Folder that was processed:** `ci\\workflows`
...
- Does it contain "Prompt 260: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\workflows`, determine the owner:
...
- Does the feature name match or relate to "Workflows"?
...
✅/❌ Progress.md contains "Prompt 260: Executed"
...
## If PASSED
Say: "✅ Prompt 260 verified successfully. Ready for Prompt 261."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 260.
