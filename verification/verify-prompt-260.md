# Verification Prompt for Prompt 260

## Your Task: Verify Execution of Prompt 260

You are verifying that **Prompt 260** was executed correctly.

### What Prompt 260 Should Have Done:

**Folder Analyzed:** `ci\\workflows`
**Expected Feature Name:** `Workflows`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 260:"
```
**Expected:** Should find entry like "Prompt 260: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ci\\workflows`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Workflows"
```
**Expected:** Should find feature section with name containing "Workflows"
...
```
VERIFICATION REPORT - PROMPT 260
================================
...
Confirm: "Prompt 260 executed correctly. Ready for Prompt 261."
