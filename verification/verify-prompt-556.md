# Verification for Prompt 556

## Task: Verify that Prompt 556 executed correctly

**Folder that was processed:** `dashboard\\tests\\legacy`
...
- Does it contain "Prompt 556: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\legacy`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 556: Executed"
...
## If PASSED
Say: "✅ Prompt 556 verified successfully. Ready for Prompt 557."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 556.
