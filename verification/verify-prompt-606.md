# Verification Prompt for Prompt 606

## Your Task: Verify Execution of Prompt 606

You are verifying that **Prompt 606** was executed correctly.

### What Prompt 606 Should Have Done:

**Folder Analyzed:** `data\\backups\\daily`
**Expected Feature Name:** `Daily`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 606:"
```
**Expected:** Should find entry like "Prompt 606: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\backups\\daily`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Daily"
```
**Expected:** Should find feature section with name containing "Daily"
...
```
VERIFICATION REPORT - PROMPT 606
================================
...
Confirm: "Prompt 606 executed correctly. Ready for Prompt 607."
