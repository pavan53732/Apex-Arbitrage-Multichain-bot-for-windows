# Verification for Prompt 606

## Task: Verify that Prompt 606 executed correctly

**Folder that was processed:** `data\\backups\\daily`
...
- Does it contain "Prompt 606: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\backups\\daily`, determine the owner:
...
- Does the feature name match or relate to "Daily"?
...
✅/❌ Progress.md contains "Prompt 606: Executed"
...
## If PASSED
Say: "✅ Prompt 606 verified successfully. Ready for Prompt 607."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 606.
