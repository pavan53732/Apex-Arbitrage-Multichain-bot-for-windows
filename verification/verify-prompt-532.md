# Verification for Prompt 532

## Task: Verify that Prompt 532 executed correctly

**Folder that was processed:** `dashboard\\settings`
...
- Does it contain "Prompt 532: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\settings`, determine the owner:
...
- Does the feature name match or relate to "Settings"?
...
✅/❌ Progress.md contains "Prompt 532: Executed"
...
## If PASSED
Say: "✅ Prompt 532 verified successfully. Ready for Prompt 533."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 532.
