# Verification for Prompt 470

## Task: Verify that Prompt 470 executed correctly

**Folder that was processed:** `dashboard\\mock`
...
- Does it contain "Prompt 470: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\mock`, determine the owner:
...
- Does the feature name match or relate to "Mock"?
...
✅/❌ Progress.md contains "Prompt 470: Executed"
...
## If PASSED
Say: "✅ Prompt 470 verified successfully. Ready for Prompt 471."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 470.
