# Verification for Prompt 582

## Task: Verify that Prompt 582 executed correctly

**Folder that was processed:** `dashboard\\uploads\\users\\pavan\_korukonda`
...
- Does it contain "Prompt 582: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\uploads\\users\\pavan\_korukonda`, determine the owner:
...
- Does the feature name match or relate to "Pavan\ Korukonda"?
...
✅/❌ Progress.md contains "Prompt 582: Executed"
...
## If PASSED
Say: "✅ Prompt 582 verified successfully. Ready for Prompt 583."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 582.
