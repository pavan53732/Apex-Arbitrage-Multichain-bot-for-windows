# Verification Prompt for Prompt 582

## Your Task: Verify Execution of Prompt 582

You are verifying that **Prompt 582** was executed correctly.

### What Prompt 582 Should Have Done:

**Folder Analyzed:** `dashboard\\uploads\\users\\pavan\_korukonda`
**Expected Feature Name:** `Pavan\ Korukonda`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 582:"
```
**Expected:** Should find entry like "Prompt 582: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\uploads\\users\\pavan\_korukonda`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Pavan\ Korukonda"
```
**Expected:** Should find feature section with name containing "Pavan\ Korukonda"
...
```
VERIFICATION REPORT - PROMPT 582
================================
...
Confirm: "Prompt 582 executed correctly. Ready for Prompt 583."
