# Verification for Prompt 347

## Task: Verify that Prompt 347 executed correctly

**Folder that was processed:** `dashboard\\ar\\integration`
...
- Does it contain "Prompt 347: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\integration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 347: Executed"
...
## If PASSED
Say: "✅ Prompt 347 verified successfully. Ready for Prompt 348."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 347.
