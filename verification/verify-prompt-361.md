# Verification for Prompt 361

## Task: Verify that Prompt 361 executed correctly

**Folder that was processed:** `dashboard\\components\\ai`
...
- Does it contain "Prompt 361: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\ai`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 361: Executed"
...
## If PASSED
Say: "✅ Prompt 361 verified successfully. Ready for Prompt 362."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 361.
