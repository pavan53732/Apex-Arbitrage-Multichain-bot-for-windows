# Verification for Prompt 247

## Task: Verify that Prompt 247 executed correctly

**Folder that was processed:** `ci\\config`
...
- Does it contain "Prompt 247: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\config`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 247: Executed"
...
## If PASSED
Say: "✅ Prompt 247 verified successfully. Ready for Prompt 248."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 247.
