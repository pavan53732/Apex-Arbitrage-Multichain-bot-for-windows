# Verification for Prompt 20

## Task: Verify that Prompt 20 executed correctly

**Folder that was processed:** `archive\\docs\\deprecation-notices`
...
- Does it contain "Prompt 20: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\docs\\deprecation-notices`, determine the owner:
...
- Does the feature name match or relate to "Deprecation Notices"?
...
✅/❌ Progress.md contains "Prompt 20: Executed"
...
## If PASSED
Say: "✅ Prompt 20 verified successfully. Ready for Prompt 21."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 20.
