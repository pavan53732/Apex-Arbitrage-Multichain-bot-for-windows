# Verification Prompt for Prompt 20

## Your Task: Verify Execution of Prompt 20

You are verifying that **Prompt 20** was executed correctly.

### What Prompt 20 Should Have Done:

**Folder Analyzed:** `archive\\docs\\deprecation-notices`
**Expected Feature Name:** `Deprecation Notices`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 20:"
```
**Expected:** Should find entry like "Prompt 20: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\docs\\deprecation-notices`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Deprecation Notices"
```
**Expected:** Should find feature section with name containing "Deprecation Notices"
...
Confirm: "Prompt 20 executed correctly. Ready for Prompt 21."
