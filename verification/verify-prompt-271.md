# Verification Prompt for Prompt 271

## Your Task: Verify Execution of Prompt 271

You are verifying that **Prompt 271** was executed correctly.

### What Prompt 271 Should Have Done:

**Folder Analyzed:** `config\\deprecated`
**Expected Feature Name:** `Deprecated`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 271:"
```
**Expected:** Should find entry like "Prompt 271: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `config\\deprecated`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Deprecated"
```
**Expected:** Should find feature section with name containing "Deprecated"
...
```
VERIFICATION REPORT - PROMPT 271
================================
...
Confirm: "Prompt 271 executed correctly. Ready for Prompt 272."
