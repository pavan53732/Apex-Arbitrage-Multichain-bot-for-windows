# Verification for Prompt 271

## Task: Verify that Prompt 271 executed correctly

**Folder that was processed:** `config\\deprecated`
...
- Does it contain "Prompt 271: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\deprecated`, determine the owner:
...
- Does the feature name match or relate to "Deprecated"?
...
✅/❌ Progress.md contains "Prompt 271: Executed"
...
## If PASSED
Say: "✅ Prompt 271 verified successfully. Ready for Prompt 272."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 271.
