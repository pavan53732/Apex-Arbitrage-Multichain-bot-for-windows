# Verification for Prompt 615

## Task: Verify that Prompt 615 executed correctly

**Folder that was processed:** `data\\model-weights`
...
- Does it contain "Prompt 615: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\model-weights`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 615: Executed"
...
## If PASSED
Say: "✅ Prompt 615 verified successfully. Ready for Prompt 616."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 615.
