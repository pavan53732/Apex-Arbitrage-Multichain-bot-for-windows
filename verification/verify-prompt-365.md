# Verification for Prompt 365

## Task: Verify that Prompt 365 executed correctly

**Folder that was processed:** `dashboard\\components\\forms`
...
- Does it contain "Prompt 365: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\forms`, determine the owner:
...
- Does the feature name match or relate to "Forms"?
...
✅/❌ Progress.md contains "Prompt 365: Executed"
...
## If PASSED
Say: "✅ Prompt 365 verified successfully. Ready for Prompt 366."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 365.
