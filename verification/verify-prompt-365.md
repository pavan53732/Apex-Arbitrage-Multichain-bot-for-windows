# Verification Prompt for Prompt 365

## Your Task: Verify Execution of Prompt 365

You are verifying that **Prompt 365** was executed correctly.

### What Prompt 365 Should Have Done:

**Folder Analyzed:** `dashboard\\components\\forms`
**Expected Feature Name:** `Forms`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 365:"
```
**Expected:** Should find entry like "Prompt 365: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\components\\forms`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Forms"
```
**Expected:** Should find feature section with name containing "Forms"
...
```
VERIFICATION REPORT - PROMPT 365
================================
...
Confirm: "Prompt 365 executed correctly. Ready for Prompt 366."
