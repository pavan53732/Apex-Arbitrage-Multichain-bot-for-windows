# Verification for Prompt 304

## Task: Verify that Prompt 304 executed correctly

**Folder that was processed:** `dashboard\\ai\\explainability`
...
- Does it contain "Prompt 304: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\explainability`, determine the owner:
...
- Does the feature name match or relate to "Explainability"?
...
✅/❌ Progress.md contains "Prompt 304: Executed"
...
## If PASSED
Say: "✅ Prompt 304 verified successfully. Ready for Prompt 305."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 304.
