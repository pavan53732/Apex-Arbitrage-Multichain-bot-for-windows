# Verification for Prompt 567

## Task: Verify that Prompt 567 executed correctly

**Folder that was processed:** `dashboard\\tests\\unit`
...
- Does it contain "Prompt 567: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\unit`, determine the owner:
...
- Does the feature name match or relate to "Unit"?
...
✅/❌ Progress.md contains "Prompt 567: Executed"
...
## If PASSED
Say: "✅ Prompt 567 verified successfully. Ready for Prompt 568."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 567.
