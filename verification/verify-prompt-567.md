# Verification Prompt for Prompt 567

## Your Task: Verify Execution of Prompt 567

You are verifying that **Prompt 567** was executed correctly.

### What Prompt 567 Should Have Done:

**Folder Analyzed:** `dashboard\\tests\\unit`
**Expected Feature Name:** `Unit`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 567:"
```
**Expected:** Should find entry like "Prompt 567: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\tests\\unit`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Unit"
```
**Expected:** Should find feature section with name containing "Unit"
...
```
VERIFICATION REPORT - PROMPT 567
================================
...
Confirm: "Prompt 567 executed correctly. Ready for Prompt 568."
