# Verification for Prompt 23

## Task: Verify that Prompt 23 executed correctly

**Folder that was processed:** `archive\\docs\\old-adrs`
...
- Does it contain "Prompt 23: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\docs\\old-adrs`, determine the owner:
...
- Does the feature name match or relate to "Old Adrs"?
...
✅/❌ Progress.md contains "Prompt 23: Executed"
...
## If PASSED
Say: "✅ Prompt 23 verified successfully. Ready for Prompt 24."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 23.
