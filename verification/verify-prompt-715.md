# Verification for Prompt 715

## Task: Verify that Prompt 715 executed correctly

**Folder that was processed:** `migrations\\scripts`
...
- Does it contain "Prompt 715: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `migrations\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 715: Executed"
...
## If PASSED
Say: "✅ Prompt 715 verified successfully. Ready for Prompt 716."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 715.
