# Verification for Prompt 522

## Task: Verify that Prompt 522 executed correctly

**Folder that was processed:** `dashboard\\public\\banners`
...
- Does it contain "Prompt 522: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\public\\banners`, determine the owner:
...
- Does the feature name match or relate to "Banners"?
...
✅/❌ Progress.md contains "Prompt 522: Executed"
...
## If PASSED
Say: "✅ Prompt 522 verified successfully. Ready for Prompt 523."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 522.
