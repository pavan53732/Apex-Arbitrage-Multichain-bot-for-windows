# Verification for Prompt 18

## Task: Verify that Prompt 18 executed correctly

**Folder that was processed:** `archive\\docs\\api-diffs`
...
- Does it contain "Prompt 18: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\docs\\api-diffs`, determine the owner:
...
- Does the feature name match or relate to "Api Diffs"?
...
✅/❌ Progress.md contains "Prompt 18: Executed"
...
## If PASSED
Say: "✅ Prompt 18 verified successfully. Ready for Prompt 19."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 18.
