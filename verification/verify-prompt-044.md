# Verification for Prompt 44

## Task: Verify that Prompt 44 executed correctly

**Folder that was processed:** `backend\\core`
...
- Does it contain "Prompt 44: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\core`, determine the owner:
...
- Does the feature name match or relate to "Core"?
...
✅/❌ Progress.md contains "Prompt 44: Executed"
...
## If PASSED
Say: "✅ Prompt 44 verified successfully. Ready for Prompt 45."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 44.
