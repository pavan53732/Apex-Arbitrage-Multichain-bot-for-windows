# Verification for Prompt 746

## Task: Verify that Prompt 746 executed correctly

**Folder that was processed:** `public\\extensions`
...
- Does it contain "Prompt 746: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `public\\extensions`, determine the owner:
...
- Does the feature name match or relate to "Extensions"?
...
✅/❌ Progress.md contains "Prompt 746: Executed"
...
## If PASSED
Say: "✅ Prompt 746 verified successfully. Ready for Prompt 747."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 746.
