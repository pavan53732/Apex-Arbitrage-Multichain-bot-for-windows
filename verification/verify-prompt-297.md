# Verification Prompt for Prompt 297

## Your Task: Verify Execution of Prompt 297

You are verifying that **Prompt 297** was executed correctly.

### What Prompt 297 Should Have Done:

**Folder Analyzed:** `dashboard\\admin`
**Expected Feature Name:** `Admin`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 297:"
```
**Expected:** Should find entry like "Prompt 297: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\admin`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Admin"
```
**Expected:** Should find feature section with name containing "Admin"
...
```
VERIFICATION REPORT - PROMPT 297
================================
...
Confirm: "Prompt 297 executed correctly. Ready for Prompt 298."
