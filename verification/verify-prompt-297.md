# Verification for Prompt 297

## Task: Verify that Prompt 297 executed correctly

**Folder that was processed:** `dashboard\\admin`
...
- Does it contain "Prompt 297: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\admin`, determine the owner:
...
- Does the feature name match or relate to "Admin"?
...
✅/❌ Progress.md contains "Prompt 297: Executed"
...
## If PASSED
Say: "✅ Prompt 297 verified successfully. Ready for Prompt 298."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 297.
