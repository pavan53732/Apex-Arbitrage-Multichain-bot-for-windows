# Verification for Prompt 251

## Task: Verify that Prompt 251 executed correctly

**Folder that was processed:** `ci\\gitlab\\scripts`
...
- Does it contain "Prompt 251: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\gitlab\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 251: Executed"
...
## If PASSED
Say: "✅ Prompt 251 verified successfully. Ready for Prompt 252."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 251.
