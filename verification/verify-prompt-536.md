# Verification Prompt for Prompt 536

## Your Task: Verify Execution of Prompt 536

You are verifying that **Prompt 536** was executed correctly.

### What Prompt 536 Should Have Done:

**Folder Analyzed:** `dashboard\\stats`
**Expected Feature Name:** `Stats`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 536:"
```
**Expected:** Should find entry like "Prompt 536: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\stats`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Stats"
```
**Expected:** Should find feature section with name containing "Stats"
...
```
VERIFICATION REPORT - PROMPT 536
================================
...
Confirm: "Prompt 536 executed correctly. Ready for Prompt 537."
