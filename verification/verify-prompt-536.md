# Verification for Prompt 536

## Task: Verify that Prompt 536 executed correctly

**Folder that was processed:** `dashboard\\stats`
...
- Does it contain "Prompt 536: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\stats`, determine the owner:
...
- Does the feature name match or relate to "Stats"?
...
✅/❌ Progress.md contains "Prompt 536: Executed"
...
## If PASSED
Say: "✅ Prompt 536 verified successfully. Ready for Prompt 537."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 536.
