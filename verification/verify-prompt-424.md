# Verification for Prompt 424

## Task: Verify that Prompt 424 executed correctly

**Folder that was processed:** `dashboard\\deploy\\terraform\\modules\\k8s`
...
- Does it contain "Prompt 424: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\terraform\\modules\\k8s`, determine the owner:
...
- Does the feature name match or relate to "K8s"?
...
✅/❌ Progress.md contains "Prompt 424: Executed"
...
## If PASSED
Say: "✅ Prompt 424 verified successfully. Ready for Prompt 425."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 424.
