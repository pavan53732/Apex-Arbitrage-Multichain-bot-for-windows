# Verification Prompt for Prompt 424

## Your Task: Verify Execution of Prompt 424

You are verifying that **Prompt 424** was executed correctly.

### What Prompt 424 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\terraform\\modules\\k8s`
**Expected Feature Name:** `K8s`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 424:"
```
**Expected:** Should find entry like "Prompt 424: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\terraform\\modules\\k8s`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*K8s"
```
**Expected:** Should find feature section with name containing "K8s"
...
```
VERIFICATION REPORT - PROMPT 424
================================
...
Confirm: "Prompt 424 executed correctly. Ready for Prompt 425."
