# Verification Prompt for Prompt 697

## Your Task: Verify Execution of Prompt 697

You are verifying that **Prompt 697** was executed correctly.

### What Prompt 697 Should Have Done:

**Folder Analyzed:** `manifest`
**Expected Feature Name:** `Manifest`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 697:"
```
**Expected:** Should find entry like "Prompt 697: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `manifest`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Manifest"
```
**Expected:** Should find feature section with name containing "Manifest"
...
```
VERIFICATION REPORT - PROMPT 697
================================
...
Confirm: "Prompt 697 executed correctly. Ready for Prompt 698."
