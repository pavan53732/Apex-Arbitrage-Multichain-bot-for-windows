# Verification for Prompt 697

## Task: Verify that Prompt 697 executed correctly

**Folder that was processed:** `manifest`
...
- Does it contain "Prompt 697: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `manifest`, determine the owner:
...
- Does the feature name match or relate to "Manifest"?
...
✅/❌ Progress.md contains "Prompt 697: Executed"
...
## If PASSED
Say: "✅ Prompt 697 verified successfully. Ready for Prompt 698."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 697.
