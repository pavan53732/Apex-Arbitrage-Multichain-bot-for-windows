# Verification for Prompt 375

## Task: Verify that Prompt 375 executed correctly

**Folder that was processed:** `dashboard\\components\\utils`
...
- Does it contain "Prompt 375: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\utils`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 375: Executed"
...
## If PASSED
Say: "✅ Prompt 375 verified successfully. Ready for Prompt 376."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 375.
