# Verification Prompt for Prompt 634

## Your Task: Verify Execution of Prompt 634

You are verifying that **Prompt 634** was executed correctly.

### What Prompt 634 Should Have Done:

**Folder Analyzed:** `deploy\\ansible\\roles\\ai-modules`
**Expected Feature Name:** `Ai Modules`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 634:"
```
**Expected:** Should find entry like "Prompt 634: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `deploy\\ansible\\roles\\ai-modules`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Ai Modules"
```
**Expected:** Should find feature section with name containing "Ai Modules"
...
```
VERIFICATION REPORT - PROMPT 634
================================
...
Confirm: "Prompt 634 executed correctly. Ready for Prompt 635."
