# Verification for Prompt 634

## Task: Verify that Prompt 634 executed correctly

**Folder that was processed:** `deploy\\ansible\\roles\\ai-modules`
...
- Does it contain "Prompt 634: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\ansible\\roles\\ai-modules`, determine the owner:
...
- Does the feature name match or relate to "Ai Modules"?
...
✅/❌ Progress.md contains "Prompt 634: Executed"
...
## If PASSED
Say: "✅ Prompt 634 verified successfully. Ready for Prompt 635."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 634.
