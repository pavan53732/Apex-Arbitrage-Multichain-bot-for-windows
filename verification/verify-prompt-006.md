# Verification for Prompt 6

## Task: Verify that Prompt 6 executed correctly

**Folder that was processed:** `ai-modules\\models\\modelWeights`
...
- Does it contain "Prompt 6: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules\\models\\modelWeights`, determine the owner:
...
- Does the feature name match or relate to "Modelweights"?
...
✅/❌ Progress.md contains "Prompt 6: Executed"
...
## If PASSED
Say: "✅ Prompt 6 verified successfully. Ready for Prompt 7."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 6.
