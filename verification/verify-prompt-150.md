# Verification for Prompt 150

## Task: Verify that Prompt 150 executed correctly

**Folder that was processed:** `backend\\plugins\\flashloan\\docs`
...
- Does it contain "Prompt 150: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\plugins\\flashloan\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 150: Executed"
...
## If PASSED
Say: "✅ Prompt 150 verified successfully. Ready for Prompt 151."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 150.
