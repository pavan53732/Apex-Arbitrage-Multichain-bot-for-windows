# Verification for Prompt 378

## Task: Verify that Prompt 378 executed correctly

**Folder that was processed:** `dashboard\\data`
...
- Does it contain "Prompt 378: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 378: Executed"
...
## If PASSED
Say: "✅ Prompt 378 verified successfully. Ready for Prompt 379."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 378.
