# Verification Prompt for Prompt 378

## Your Task: Verify Execution of Prompt 378

You are verifying that **Prompt 378** was executed correctly.

### What Prompt 378 Should Have Done:

**Folder Analyzed:** `dashboard\\data`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 378:"
```
**Expected:** Should find entry like "Prompt 378: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\data`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 378
================================
...
Confirm: "Prompt 378 executed correctly. Ready for Prompt 379."
