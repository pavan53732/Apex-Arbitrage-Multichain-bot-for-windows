# Verification for Prompt 765

## Task: Verify that Prompt 765 executed correctly

**Folder that was processed:** `research\\logs`
...
- Does it contain "Prompt 765: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `research\\logs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 765: Executed"
...
## If PASSED
Say: "✅ Prompt 765 verified successfully. Ready for Prompt 766."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 765.
