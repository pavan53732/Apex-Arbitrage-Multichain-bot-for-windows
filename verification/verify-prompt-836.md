# Verification Prompt for Prompt 836

## Your Task: Verify Execution of Prompt 836

You are verifying that **Prompt 836** was executed correctly.

### What Prompt 836 Should Have Done:

**Folder Analyzed:** `vendor\\scripts`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 836:"
```
**Expected:** Should find entry like "Prompt 836: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `vendor\\scripts`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 836
================================
...
Confirm: "Prompt 836 executed correctly. Ready for Prompt 837."
