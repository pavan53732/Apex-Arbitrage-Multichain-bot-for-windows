# Verification for Prompt 836

## Task: Verify that Prompt 836 executed correctly

**Folder that was processed:** `vendor\\scripts`
...
- Does it contain "Prompt 836: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `vendor\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 836: Executed"
...
## If PASSED
Say: "✅ Prompt 836 verified successfully. Ready for Prompt 837."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 836.
