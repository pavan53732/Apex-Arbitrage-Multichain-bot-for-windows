# Verification for Prompt 357

## Task: Verify that Prompt 357 executed correctly

**Folder that was processed:** `dashboard\\ar\\xr\\XRAssets`
**Expected feature name:** `Xrassets`
...
- Does it contain "Prompt 357: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\xr\\XRAssets`, determine the owner:
...
- Does the feature name match or relate to "Xrassets"?
...
```
VERIFICATION REPORT - PROMPT 357
==========================================

✅/❌ Progress.md contains "Prompt 357: Executed"
...
## If PASSED
Say: "✅ Prompt 357 verified successfully. Ready for Prompt 358."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 357.
