# Verification Prompt for Prompt 811

## Your Task: Verify Execution of Prompt 811

You are verifying that **Prompt 811** was executed correctly.

### What Prompt 811 Should Have Done:

**Folder Analyzed:** `types\\json`
**Expected Feature Name:** `Json`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 811:"
```
**Expected:** Should find entry like "Prompt 811: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `types\\json`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Json"
```
**Expected:** Should find feature section with name containing "Json"
...
```
VERIFICATION REPORT - PROMPT 811
================================
...
Confirm: "Prompt 811 executed correctly. Ready for Prompt 812."
