# Verification for Prompt 36

## Task: Verify that Prompt 36 executed correctly

**Folder that was processed:** `backend\\contracts\\src`
...
- Does it contain "Prompt 36: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\contracts\\src`, determine the owner:
...
- Does the feature name match or relate to "Src"?
...
✅/❌ Progress.md contains "Prompt 36: Executed"
...
## If PASSED
Say: "✅ Prompt 36 verified successfully. Ready for Prompt 37."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 36.
