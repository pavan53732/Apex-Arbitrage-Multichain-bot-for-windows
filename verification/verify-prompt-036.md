# Verification Prompt for Prompt 36

## Your Task: Verify Execution of Prompt 36

You are verifying that **Prompt 36** was executed correctly.

### What Prompt 36 Should Have Done:

**Folder Analyzed:** `backend\\contracts\\src`
**Expected Feature Name:** `Src`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 36:"
```
**Expected:** Should find entry like "Prompt 36: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\contracts\\src`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Src"
```
**Expected:** Should find feature section with name containing "Src"
...
Confirm: "Prompt 36 executed correctly. Ready for Prompt 37."
