# Verification Prompt for Prompt 714

## Your Task: Verify Execution of Prompt 714

You are verifying that **Prompt 714** was executed correctly.

### What Prompt 714 Should Have Done:

**Folder Analyzed:** `migrations\\schema`
**Expected Feature Name:** `Schema`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 714:"
```
**Expected:** Should find entry like "Prompt 714: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `migrations\\schema`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Schema"
```
**Expected:** Should find feature section with name containing "Schema"
...
```
VERIFICATION REPORT - PROMPT 714
================================
...
Confirm: "Prompt 714 executed correctly. Ready for Prompt 715."
