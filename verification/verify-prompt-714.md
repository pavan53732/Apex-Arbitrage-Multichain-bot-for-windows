# Verification for Prompt 714

## Task: Verify that Prompt 714 executed correctly

**Folder that was processed:** `migrations\\schema`
...
- Does it contain "Prompt 714: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `migrations\\schema`, determine the owner:
...
- Does the feature name match or relate to "Schema"?
...
✅/❌ Progress.md contains "Prompt 714: Executed"
...
## If PASSED
Say: "✅ Prompt 714 verified successfully. Ready for Prompt 715."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 714.
