# Verification for Prompt 275

## Task: Verify that Prompt 275 executed correctly

**Folder that was processed:** `config\\insurance`
...
- Does it contain "Prompt 275: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\insurance`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 275: Executed"
...
## If PASSED
Say: "✅ Prompt 275 verified successfully. Ready for Prompt 276."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 275.
