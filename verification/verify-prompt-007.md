...
## Task: Verify that Prompt 7 executed correctly

**Folder that was processed:** `ai-modules\\models\\trainingOutputs`
...
- Does it contain "Prompt 7: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules\\models\\trainingOutputs`, determine the owner:
...
- Does the feature name match or relate to "Trainingoutputs"?
...
✅/❌ Progress.md contains "Prompt 7: Executed"
...
## If PASSED
Say: "✅ Prompt 7 verified successfully. Ready for Prompt 8."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 7.
