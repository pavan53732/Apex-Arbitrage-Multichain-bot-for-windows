# Verification Prompt for Prompt 7

## Your Task: Verify Execution of Prompt 7

You are verifying that **Prompt 7** was executed correctly.

### What Prompt 7 Should Have Done:

**Folder Analyzed:** `ai-modules\\models\\trainingOutputs`
**Expected Feature Name:** `Trainingoutputs`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 7:"
```
**Expected:** Should find entry like "Prompt 7: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ai-modules\\models\\trainingOutputs`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Trainingoutputs"
```
**Expected:** Should find feature section with name containing "Trainingoutputs"
...
Confirm: "Prompt 7 executed correctly. Ready for Prompt 8."
