# Verification for Prompt 341

## Task: Verify that Prompt 341 executed correctly

**Folder that was processed:** `dashboard\\ar`
...
- Does it contain "Prompt 341: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 341: Executed"
...
## If PASSED
Say: "✅ Prompt 341 verified successfully. Ready for Prompt 342."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 341.
