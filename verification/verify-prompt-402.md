# Verification for Prompt 402

## Task: Verify that Prompt 402 executed correctly

**Folder that was processed:** `dashboard\\deploy\\audit`
...
- Does it contain "Prompt 402: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\audit`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 402: Executed"
...
## If PASSED
Say: "✅ Prompt 402 verified successfully. Ready for Prompt 403."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 402.
