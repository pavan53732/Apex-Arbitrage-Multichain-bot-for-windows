# Verification for Prompt 603

## Task: Verify that Prompt 603 executed correctly

**Folder that was processed:** `data\\backups\\ai-model-weights`
...
- Does it contain "Prompt 603: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\backups\\ai-model-weights`, determine the owner:
...
- Does the feature name match or relate to "Ai Model Weights"?
...
✅/❌ Progress.md contains "Prompt 603: Executed"
...
## If PASSED
Say: "✅ Prompt 603 verified successfully. Ready for Prompt 604."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 603.
