# Verification Prompt for Prompt 603

## Your Task: Verify Execution of Prompt 603

You are verifying that **Prompt 603** was executed correctly.

### What Prompt 603 Should Have Done:

**Folder Analyzed:** `data\\backups\\ai-model-weights`
**Expected Feature Name:** `Ai Model Weights`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 603:"
```
**Expected:** Should find entry like "Prompt 603: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\backups\\ai-model-weights`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Ai Model Weights"
```
**Expected:** Should find feature section with name containing "Ai Model Weights"
...
```
VERIFICATION REPORT - PROMPT 603
================================
...
Confirm: "Prompt 603 executed correctly. Ready for Prompt 604."
