# Verification for Prompt 477

## Task: Verify that Prompt 477 executed correctly

**Folder that was processed:** `dashboard\\operator`
...
- Does it contain "Prompt 477: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\operator`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 477: Executed"
...
## If PASSED
Say: "✅ Prompt 477 verified successfully. Ready for Prompt 478."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 477.
