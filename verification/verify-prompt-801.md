# Verification Prompt for Prompt 801

## Your Task: Verify Execution of Prompt 801

You are verifying that **Prompt 801** was executed correctly.

### What Prompt 801 Should Have Done:

**Folder Analyzed:** `third-party\\adapters`
**Expected Feature Name:** `Adapters`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 801:"
```
**Expected:** Should find entry like "Prompt 801: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `third-party\\adapters`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Adapters"
```
**Expected:** Should find feature section with name containing "Adapters"
...
```
VERIFICATION REPORT - PROMPT 801
================================
...
Confirm: "Prompt 801 executed correctly. Ready for Prompt 802."
