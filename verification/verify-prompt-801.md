# Verification for Prompt 801

## Task: Verify that Prompt 801 executed correctly

**Folder that was processed:** `third-party\\adapters`
...
- Does it contain "Prompt 801: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `third-party\\adapters`, determine the owner:
...
- Does the feature name match or relate to "Adapters"?
...
✅/❌ Progress.md contains "Prompt 801: Executed"
...
## If PASSED
Say: "✅ Prompt 801 verified successfully. Ready for Prompt 802."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 801.
