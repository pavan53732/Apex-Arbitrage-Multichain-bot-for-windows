# Verification for Prompt 359

## Task: Verify that Prompt 359 executed correctly

**Folder that was processed:** `dashboard\\charts`
...
- Does it contain "Prompt 359: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\charts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 359: Executed"
...
## If PASSED
Say: "✅ Prompt 359 verified successfully. Ready for Prompt 360."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 359.
