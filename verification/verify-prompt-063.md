# Verification Prompt for Prompt 63

## Your Task: Verify Execution of Prompt 63

You are verifying that **Prompt 63** was executed correctly.

### What Prompt 63 Should Have Done:

**Folder Analyzed:** `backend\\data\\snapshots`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 63:"
```
**Expected:** Should find entry like "Prompt 63: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\data\\snapshots`, determine which .md file should own this feature:
...
Confirm: "Prompt 63 executed correctly. Ready for Prompt 64."
