# Verification for Prompt 804

## Task: Verify that Prompt 804 executed correctly

**Folder that was processed:** `third-party\\connectors`
...
- Does it contain "Prompt 804: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `third-party\\connectors`, determine the owner:
...
- Does the feature name match or relate to "Connectors"?
...
✅/❌ Progress.md contains "Prompt 804: Executed"
...
## If PASSED
Say: "✅ Prompt 804 verified successfully. Ready for Prompt 805."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 804.
