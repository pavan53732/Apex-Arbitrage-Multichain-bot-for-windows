# Verification Prompt for Prompt 804

## Your Task: Verify Execution of Prompt 804

You are verifying that **Prompt 804** was executed correctly.

### What Prompt 804 Should Have Done:

**Folder Analyzed:** `third-party\\connectors`
**Expected Feature Name:** `Connectors`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 804:"
```
**Expected:** Should find entry like "Prompt 804: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `third-party\\connectors`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Connectors"
```
**Expected:** Should find feature section with name containing "Connectors"
...
```
VERIFICATION REPORT - PROMPT 804
================================
...
Confirm: "Prompt 804 executed correctly. Ready for Prompt 805."
