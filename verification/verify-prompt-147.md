# Verification for Prompt 147

## Task: Verify that Prompt 147 executed correctly

**Folder that was processed:** `backend\\plugins\\dex-adapters\\tests`
...
- Does it contain "Prompt 147: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\plugins\\dex-adapters\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 147: Executed"
...
## If PASSED
Say: "✅ Prompt 147 verified successfully. Ready for Prompt 148."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 147.
