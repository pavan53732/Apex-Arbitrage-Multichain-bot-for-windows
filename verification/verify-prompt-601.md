# Verification for Prompt 601

## Task: Verify that Prompt 601 executed correctly

**Folder that was processed:** `data\\audit-trails`
...
- Does it contain "Prompt 601: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\audit-trails`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 601: Executed"
...
## If PASSED
Say: "✅ Prompt 601 verified successfully. Ready for Prompt 602."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 601.
