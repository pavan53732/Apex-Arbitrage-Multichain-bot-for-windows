# Verification for Prompt 386

## Task: Verify that Prompt 386 executed correctly

**Folder that was processed:** `dashboard\\data\\operator-audit`
...
- Does it contain "Prompt 386: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\operator-audit`, determine the owner:
...
- Does the feature name match or relate to "Operator Audit"?
...
✅/❌ Progress.md contains "Prompt 386: Executed"
...
## If PASSED
Say: "✅ Prompt 386 verified successfully. Ready for Prompt 387."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 386.
