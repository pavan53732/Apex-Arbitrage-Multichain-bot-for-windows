# Verification Prompt for Prompt 386

## Your Task: Verify Execution of Prompt 386

You are verifying that **Prompt 386** was executed correctly.

### What Prompt 386 Should Have Done:

**Folder Analyzed:** `dashboard\\data\\operator-audit`
**Expected Feature Name:** `Operator Audit`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 386:"
```
**Expected:** Should find entry like "Prompt 386: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\data\\operator-audit`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Operator Audit"
```
**Expected:** Should find feature section with name containing "Operator Audit"
...
```
VERIFICATION REPORT - PROMPT 386
================================
...
Confirm: "Prompt 386 executed correctly. Ready for Prompt 387."
