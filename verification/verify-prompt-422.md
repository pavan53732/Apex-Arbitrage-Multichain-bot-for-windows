# Verification for Prompt 422

## Task: Verify that Prompt 422 executed correctly

**Folder that was processed:** `dashboard\\deploy\\terraform\\modules`
...
- Does it contain "Prompt 422: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\terraform\\modules`, determine the owner:
...
- Does the feature name match or relate to "Modules"?
...
✅/❌ Progress.md contains "Prompt 422: Executed"
...
## If PASSED
Say: "✅ Prompt 422 verified successfully. Ready for Prompt 423."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 422.
