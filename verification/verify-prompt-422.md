# Verification Prompt for Prompt 422

## Your Task: Verify Execution of Prompt 422

You are verifying that **Prompt 422** was executed correctly.

### What Prompt 422 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\terraform\\modules`
**Expected Feature Name:** `Modules`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 422:"
```
**Expected:** Should find entry like "Prompt 422: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\terraform\\modules`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Modules"
```
**Expected:** Should find feature section with name containing "Modules"
...
```
VERIFICATION REPORT - PROMPT 422
================================
...
Confirm: "Prompt 422 executed correctly. Ready for Prompt 423."
