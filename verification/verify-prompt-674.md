# Verification for Prompt 674

## Task: Verify that Prompt 674 executed correctly

**Folder that was processed:** `examples`
...
- Does it contain "Prompt 674: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `examples`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 674: Executed"
...
## If PASSED
Say: "✅ Prompt 674 verified successfully. Ready for Prompt 675."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 674.
