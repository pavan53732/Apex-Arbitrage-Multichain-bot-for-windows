# Verification for Prompt 109

## Task: Verify that Prompt 109 executed correctly

**Folder that was processed:** `backend\\migrations\\operator`
...
- Does it contain "Prompt 109: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\migrations\\operator`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 109: Executed"
...
## If PASSED
Say: "✅ Prompt 109 verified successfully. Ready for Prompt 110."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 109.
