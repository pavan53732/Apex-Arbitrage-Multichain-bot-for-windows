# Verification for Prompt 388

## Task: Verify that Prompt 388 executed correctly

**Folder that was processed:** `dashboard\\data\\snapshots`
...
- Does it contain "Prompt 388: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\snapshots`, determine the owner:
...
- Does the feature name match or relate to "Snapshots"?
...
✅/❌ Progress.md contains "Prompt 388: Executed"
...
## If PASSED
Say: "✅ Prompt 388 verified successfully. Ready for Prompt 389."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 388.
