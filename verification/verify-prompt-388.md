# Verification Prompt for Prompt 388

## Your Task: Verify Execution of Prompt 388

You are verifying that **Prompt 388** was executed correctly.

### What Prompt 388 Should Have Done:

**Folder Analyzed:** `dashboard\\data\\snapshots`
**Expected Feature Name:** `Snapshots`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 388:"
```
**Expected:** Should find entry like "Prompt 388: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\data\\snapshots`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Snapshots"
```
**Expected:** Should find feature section with name containing "Snapshots"
...
```
VERIFICATION REPORT - PROMPT 388
================================
...
Confirm: "Prompt 388 executed correctly. Ready for Prompt 389."
