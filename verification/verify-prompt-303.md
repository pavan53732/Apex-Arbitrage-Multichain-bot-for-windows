# Verification for Prompt 303

## Task: Verify that Prompt 303 executed correctly

**Folder that was processed:** `dashboard\\ai\\demo`
...
- Does it contain "Prompt 303: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\demo`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 303: Executed"
...
## If PASSED
Say: "✅ Prompt 303 verified successfully. Ready for Prompt 304."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 303.
