# Verification Prompt for Prompt 303

## Your Task: Verify Execution of Prompt 303

You are verifying that **Prompt 303** was executed correctly.

### What Prompt 303 Should Have Done:

**Folder Analyzed:** `dashboard\\ai\\demo`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 303:"
```
**Expected:** Should find entry like "Prompt 303: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\ai\\demo`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 303
================================
...
Confirm: "Prompt 303 executed correctly. Ready for Prompt 304."
