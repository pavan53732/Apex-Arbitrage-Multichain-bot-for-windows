# Verification for Prompt 21

## Task: Verify that Prompt 21 executed correctly

**Folder that was processed:** `archive\\docs\\incident-reports`
...
- Does it contain "Prompt 21: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\docs\\incident-reports`, determine the owner:
...
- Does the feature name match or relate to "Incident Reports"?
...
✅/❌ Progress.md contains "Prompt 21: Executed"
...
## If PASSED
Say: "✅ Prompt 21 verified successfully. Ready for Prompt 22."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 21.
