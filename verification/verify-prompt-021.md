# Verification Prompt for Prompt 21

## Your Task: Verify Execution of Prompt 21

You are verifying that **Prompt 21** was executed correctly.

### What Prompt 21 Should Have Done:

**Folder Analyzed:** `archive\\docs\\incident-reports`
**Expected Feature Name:** `Incident Reports`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 21:"
```
**Expected:** Should find entry like "Prompt 21: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `archive\\docs\\incident-reports`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Incident Reports"
```
**Expected:** Should find feature section with name containing "Incident Reports"
...
Confirm: "Prompt 21 executed correctly. Ready for Prompt 22."
