# Verification for Prompt 301

## Task: Verify that Prompt 301 executed correctly

**Folder that was processed:** `dashboard\\ai\\components`
...
- Does it contain "Prompt 301: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\components`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 301: Executed"
...
## If PASSED
Say: "✅ Prompt 301 verified successfully. Ready for Prompt 302."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 301.
