# Verification for Prompt 731

## Task: Verify that Prompt 731 executed correctly

**Folder that was processed:** `overlays\\xai\\ext`
...
- Does it contain "Prompt 731: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `overlays\\xai\\ext`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 731: Executed"
...
## If PASSED
Say: "✅ Prompt 731 verified successfully. Ready for Prompt 732."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 731.
