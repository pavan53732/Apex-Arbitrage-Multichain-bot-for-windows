# Verification for Prompt 400

## Task: Verify that Prompt 400 executed correctly

**Folder that was processed:** `dashboard\\deploy\\ansible\\roles\\operator`
...
- Does it contain "Prompt 400: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\ansible\\roles\\operator`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 400: Executed"
...
## If PASSED
Say: "✅ Prompt 400 verified successfully. Ready for Prompt 401."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 400.
