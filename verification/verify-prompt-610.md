# Verification for Prompt 610

## Task: Verify that Prompt 610 executed correctly

**Folder that was processed:** `data\\compliance-archive`
...
- Does it contain "Prompt 610: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\compliance-archive`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 610: Executed"
...
## If PASSED
Say: "✅ Prompt 610 verified successfully. Ready for Prompt 611."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 610.
