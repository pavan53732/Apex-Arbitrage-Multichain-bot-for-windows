# Verification for Prompt 317

## Task: Verify that Prompt 317 executed correctly

**Folder that was processed:** `dashboard\\analytics\\components`
...
- Does it contain "Prompt 317: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\components`, determine the owner:
...
- Does the feature name match or relate to "Components"?
...
✅/❌ Progress.md contains "Prompt 317: Executed"
...
## If PASSED
Say: "✅ Prompt 317 verified successfully. Ready for Prompt 318."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 317.
