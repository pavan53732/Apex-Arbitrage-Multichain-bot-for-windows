# Verification Prompt for Prompt 317

## Your Task: Verify Execution of Prompt 317

You are verifying that **Prompt 317** was executed correctly.

### What Prompt 317 Should Have Done:

**Folder Analyzed:** `dashboard\\analytics\\components`
**Expected Feature Name:** `Components`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 317:"
```
**Expected:** Should find entry like "Prompt 317: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\analytics\\components`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Components"
```
**Expected:** Should find feature section with name containing "Components"
...
```
VERIFICATION REPORT - PROMPT 317
================================
...
Confirm: "Prompt 317 executed correctly. Ready for Prompt 318."
