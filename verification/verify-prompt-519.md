# Verification for Prompt 519

## Task: Verify that Prompt 519 executed correctly

**Folder that was processed:** `dashboard\\preview`
...
- Does it contain "Prompt 519: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\preview`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 519: Executed"
...
## If PASSED
Say: "✅ Prompt 519 verified successfully. Ready for Prompt 520."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 519.
