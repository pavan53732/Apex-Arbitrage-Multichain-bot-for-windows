# Verification for Prompt 797

## Task: Verify that Prompt 797 executed correctly

**Folder that was processed:** `tests\\snapshots`
...
- Does it contain "Prompt 797: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `tests\\snapshots`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 797: Executed"
...
## If PASSED
Say: "✅ Prompt 797 verified successfully. Ready for Prompt 798."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 797.
