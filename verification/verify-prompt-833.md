# Verification for Prompt 833

## Task: Verify that Prompt 833 executed correctly

**Folder that was processed:** `vendor\\dex-liquidity-snapshots`
...
- Does it contain "Prompt 833: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `vendor\\dex-liquidity-snapshots`, determine the owner:
...
- Does the feature name match or relate to "Dex Liquidity Snapshots"?
...
✅/❌ Progress.md contains "Prompt 833: Executed"
...
## If PASSED
Say: "✅ Prompt 833 verified successfully. Ready for Prompt 834."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 833.
