# Verification for Prompt 553

## Task: Verify that Prompt 553 executed correctly

**Folder that was processed:** `dashboard\\tests\\fork`
...
- Does it contain "Prompt 553: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\fork`, determine the owner:
...
- Does the feature name match or relate to "Fork"?
...
✅/❌ Progress.md contains "Prompt 553: Executed"
...
## If PASSED
Say: "✅ Prompt 553 verified successfully. Ready for Prompt 554."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 553.
