# Verification Prompt for Prompt 31

## Your Task: Verify Execution of Prompt 31

You are verifying that **Prompt 31** was executed correctly.

### What Prompt 31 Should Have Done:

**Folder Analyzed:** `backend\\backup`
**Expected Feature Name:** `Backup`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 31:"
```
**Expected:** Should find entry like "Prompt 31: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\backup`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Backup"
```
**Expected:** Should find feature section with name containing "Backup"
...
Confirm: "Prompt 31 executed correctly. Ready for Prompt 32."
