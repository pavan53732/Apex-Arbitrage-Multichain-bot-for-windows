# Verification for Prompt 309

## Task: Verify that Prompt 309 executed correctly

**Folder that was processed:** `dashboard\\ai\\models\\weights\\old-weights`
...
- Does it contain "Prompt 309: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\models\\weights\\old-weights`, determine the owner:
...
- Does the feature name match or relate to "Old Weights"?
...
✅/❌ Progress.md contains "Prompt 309: Executed"
...
## If PASSED
Say: "✅ Prompt 309 verified successfully. Ready for Prompt 310."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 309.
