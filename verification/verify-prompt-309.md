# Verification Prompt for Prompt 309

## Your Task: Verify Execution of Prompt 309

You are verifying that **Prompt 309** was executed correctly.

### What Prompt 309 Should Have Done:

**Folder Analyzed:** `dashboard\\ai\\models\\weights\\old-weights`
**Expected Feature Name:** `Old Weights`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 309:"
```
**Expected:** Should find entry like "Prompt 309: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\ai\\models\\weights\\old-weights`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Old Weights"
```
**Expected:** Should find feature section with name containing "Old Weights"
...
```
VERIFICATION REPORT - PROMPT 309
================================
...
Confirm: "Prompt 309 executed correctly. Ready for Prompt 310."
