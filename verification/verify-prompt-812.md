# Verification for Prompt 812

## Task: Verify that Prompt 812 executed correctly

**Folder that was processed:** `types\\py`
...
- Does it contain "Prompt 812: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `types\\py`, determine the owner:
...
- Does the feature name match or relate to "Py"?
...
✅/❌ Progress.md contains "Prompt 812: Executed"
...
## If PASSED
Say: "✅ Prompt 812 verified successfully. Ready for Prompt 813."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 812.
