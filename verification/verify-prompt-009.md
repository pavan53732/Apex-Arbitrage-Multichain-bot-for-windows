# Verification Prompt for Prompt 9

## Your Task: Verify Execution of Prompt 9

You are verifying that **Prompt 9** was executed correctly.

### What Prompt 9 Should Have Done:

**Folder Analyzed:** `ai-modules\\simulation`
**Expected Feature Name:** `Simulation`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 9:"
```
**Expected:** Should find entry like "Prompt 9: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `ai-modules\\simulation`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Simulation"
```
**Expected:** Should find feature section with name containing "Simulation"
...
Confirm: "Prompt 9 executed correctly. Ready for Prompt 10."
