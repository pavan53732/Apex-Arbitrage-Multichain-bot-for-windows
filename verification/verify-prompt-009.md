# Verification for Prompt 9

## Task: Verify that Prompt 9 executed correctly

**Folder that was processed:** `ai-modules\\simulation`
...
- Does it contain "Prompt 9: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules\\simulation`, determine the owner:
...
- Does the feature name match or relate to "Simulation"?
...
✅/❌ Progress.md contains "Prompt 9: Executed"
...
## If PASSED
Say: "✅ Prompt 9 verified successfully. Ready for Prompt 10."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 9.
