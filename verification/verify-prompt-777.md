# Verification Prompt for Prompt 777

## Your Task: Verify Execution of Prompt 777

You are verifying that **Prompt 777** was executed correctly.

### What Prompt 777 Should Have Done:

**Folder Analyzed:** `scripts\\update`
**Expected Feature Name:** `Update`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 777:"
```
**Expected:** Should find entry like "Prompt 777: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `scripts\\update`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Update"
```
**Expected:** Should find feature section with name containing "Update"
...
```
VERIFICATION REPORT - PROMPT 777
================================
...
Confirm: "Prompt 777 executed correctly. Ready for Prompt 778."
