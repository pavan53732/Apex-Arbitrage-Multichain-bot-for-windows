# Verification for Prompt 777

## Task: Verify that Prompt 777 executed correctly

**Folder that was processed:** `scripts\\update`
...
- Does it contain "Prompt 777: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `scripts\\update`, determine the owner:
...
- Does the feature name match or relate to "Update"?
...
✅/❌ Progress.md contains "Prompt 777: Executed"
...
## If PASSED
Say: "✅ Prompt 777 verified successfully. Ready for Prompt 778."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 777.
