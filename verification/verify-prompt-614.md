# Verification for Prompt 614

## Task: Verify that Prompt 614 executed correctly

**Folder that was processed:** `data\\logs\\legacy`
...
- Does it contain "Prompt 614: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\logs\\legacy`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 614: Executed"
...
## If PASSED
Say: "✅ Prompt 614 verified successfully. Ready for Prompt 615."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 614.
