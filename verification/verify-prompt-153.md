# Verification for Prompt 153

## Task: Verify that Prompt 153 executed correctly

**Folder that was processed:** `backend\\plugins\\insurance\\docs`
...
- Does it contain "Prompt 153: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\plugins\\insurance\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 153: Executed"
...
## If PASSED
Say: "✅ Prompt 153 verified successfully. Ready for Prompt 154."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 153.
