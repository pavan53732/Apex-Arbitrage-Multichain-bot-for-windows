# Verification Prompt for Prompt 831

## Your Task: Verify Execution of Prompt 831

You are verifying that **Prompt 831** was executed correctly.

### What Prompt 831 Should Have Done:

**Folder Analyzed:** `vendor\\contracts`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 831:"
```
**Expected:** Should find entry like "Prompt 831: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `vendor\\contracts`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 831
================================
...
Confirm: "Prompt 831 executed correctly. Ready for Prompt 832."
