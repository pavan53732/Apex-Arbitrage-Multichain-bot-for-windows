# Verification for Prompt 831

## Task: Verify that Prompt 831 executed correctly

**Folder that was processed:** `vendor\\contracts`
...
- Does it contain "Prompt 831: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `vendor\\contracts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 831: Executed"
...
## If PASSED
Say: "✅ Prompt 831 verified successfully. Ready for Prompt 832."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 831.
