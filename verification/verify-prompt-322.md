# Verification for Prompt 322

## Task: Verify that Prompt 322 executed correctly

**Folder that was processed:** `dashboard\\analytics\\integration`
...
- Does it contain "Prompt 322: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\integration`, determine the owner:
...
- Does the feature name match or relate to "Integration"?
...
✅/❌ Progress.md contains "Prompt 322: Executed"
...
## If PASSED
Say: "✅ Prompt 322 verified successfully. Ready for Prompt 323."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 322.
