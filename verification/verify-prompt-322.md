# Verification Prompt for Prompt 322

## Your Task: Verify Execution of Prompt 322

You are verifying that **Prompt 322** was executed correctly.

### What Prompt 322 Should Have Done:

**Folder Analyzed:** `dashboard\\analytics\\integration`
**Expected Feature Name:** `Integration`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 322:"
```
**Expected:** Should find entry like "Prompt 322: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\analytics\\integration`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Integration"
```
**Expected:** Should find feature section with name containing "Integration"
...
```
VERIFICATION REPORT - PROMPT 322
================================
...
Confirm: "Prompt 322 executed correctly. Ready for Prompt 323."
