# Verification for Prompt 432

## Task: Verify that Prompt 432 executed correctly

**Folder that was processed:** `dashboard\\docs\\compliance`
...
- Does it contain "Prompt 432: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\docs\\compliance`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 432: Executed"
...
## If PASSED
Say: "✅ Prompt 432 verified successfully. Ready for Prompt 433."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 432.
