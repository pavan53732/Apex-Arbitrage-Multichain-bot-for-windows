# Verification Prompt for Prompt 364

## Your Task: Verify Execution of Prompt 364

You are verifying that **Prompt 364** was executed correctly.

### What Prompt 364 Should Have Done:

**Folder Analyzed:** `dashboard\\components\\dialogs`
**Expected Feature Name:** `Dialogs`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 364:"
```
**Expected:** Should find entry like "Prompt 364: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\components\\dialogs`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Dialogs"
```
**Expected:** Should find feature section with name containing "Dialogs"
...
```
VERIFICATION REPORT - PROMPT 364
================================
...
Confirm: "Prompt 364 executed correctly. Ready for Prompt 365."
