# Verification for Prompt 364

## Task: Verify that Prompt 364 executed correctly

**Folder that was processed:** `dashboard\\components\\dialogs`
...
- Does it contain "Prompt 364: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\dialogs`, determine the owner:
...
- Does the feature name match or relate to "Dialogs"?
...
✅/❌ Progress.md contains "Prompt 364: Executed"
...
## If PASSED
Say: "✅ Prompt 364 verified successfully. Ready for Prompt 365."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 364.
