# Verification for Prompt 652

## Task: Verify that Prompt 652 executed correctly

**Folder that was processed:** `deploy\\kubernetes\\overlays\\scripts`
...
- Does it contain "Prompt 652: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\kubernetes\\overlays\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 652: Executed"
...
## If PASSED
Say: "✅ Prompt 652 verified successfully. Ready for Prompt 653."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 652.
