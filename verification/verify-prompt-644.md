# Verification for Prompt 644

## Task: Verify that Prompt 644 executed correctly

**Folder that was processed:** `deploy\\helm\\apex-protocol`
...
- Does it contain "Prompt 644: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\helm\\apex-protocol`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 644: Executed"
...
## If PASSED
Say: "✅ Prompt 644 verified successfully. Ready for Prompt 645."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 644.
