# Verification Prompt for Prompt 440

## Your Task: Verify Execution of Prompt 440

You are verifying that **Prompt 440** was executed correctly.

### What Prompt 440 Should Have Done:

**Folder Analyzed:** `dashboard\\docs\\risk`
**Expected Feature Name:** `Risk`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 440:"
```
**Expected:** Should find entry like "Prompt 440: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\docs\\risk`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Risk"
```
**Expected:** Should find feature section with name containing "Risk"
...
```
VERIFICATION REPORT - PROMPT 440
================================
...
Confirm: "Prompt 440 executed correctly. Ready for Prompt 441."
