# Verification for Prompt 440

## Task: Verify that Prompt 440 executed correctly

**Folder that was processed:** `dashboard\\docs\\risk`
...
- Does it contain "Prompt 440: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\docs\\risk`, determine the owner:
...
- Does the feature name match or relate to "Risk"?
...
✅/❌ Progress.md contains "Prompt 440: Executed"
...
## If PASSED
Say: "✅ Prompt 440 verified successfully. Ready for Prompt 441."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 440.
