# Verification for Prompt 326

## Task: Verify that Prompt 326 executed correctly

**Folder that was processed:** `dashboard\\analytics\\state`
...
- Does it contain "Prompt 326: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\state`, determine the owner:
...
- Does the feature name match or relate to "State"?
...
✅/❌ Progress.md contains "Prompt 326: Executed"
...
## If PASSED
Say: "✅ Prompt 326 verified successfully. Ready for Prompt 327."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 326.
