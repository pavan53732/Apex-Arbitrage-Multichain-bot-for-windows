# Verification Prompt for Prompt 326

## Your Task: Verify Execution of Prompt 326

You are verifying that **Prompt 326** was executed correctly.

### What Prompt 326 Should Have Done:

**Folder Analyzed:** `dashboard\\analytics\\state`
**Expected Feature Name:** `State`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 326:"
```
**Expected:** Should find entry like "Prompt 326: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\analytics\\state`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*State"
```
**Expected:** Should find feature section with name containing "State"
...
```
VERIFICATION REPORT - PROMPT 326
================================
...
Confirm: "Prompt 326 executed correctly. Ready for Prompt 327."
