# Verification for Prompt 761

## Task: Verify that Prompt 761 executed correctly

**Folder that was processed:** `research\\datasets`
...
- Does it contain "Prompt 761: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `research\\datasets`, determine the owner:
...
- Does the feature name match or relate to "Datasets"?
...
✅/❌ Progress.md contains "Prompt 761: Executed"
...
## If PASSED
Say: "✅ Prompt 761 verified successfully. Ready for Prompt 762."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 761.
