# Verification Prompt for Prompt 761

## Your Task: Verify Execution of Prompt 761

You are verifying that **Prompt 761** was executed correctly.

### What Prompt 761 Should Have Done:

**Folder Analyzed:** `research\\datasets`
**Expected Feature Name:** `Datasets`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 761:"
```
**Expected:** Should find entry like "Prompt 761: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `research\\datasets`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Datasets"
```
**Expected:** Should find feature section with name containing "Datasets"
...
```
VERIFICATION REPORT - PROMPT 761
================================
...
Confirm: "Prompt 761 executed correctly. Ready for Prompt 762."
