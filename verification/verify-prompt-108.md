# Verification for Prompt 108

## Task: Verify that Prompt 108 executed correctly

**Folder that was processed:** `backend\\migrations\\legacy`
...
- Does it contain "Prompt 108: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\migrations\\legacy`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 108: Executed"
...
## If PASSED
Say: "✅ Prompt 108 verified successfully. Ready for Prompt 109."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 108.
