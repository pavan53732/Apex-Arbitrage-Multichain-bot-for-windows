# Verification for Prompt 838

## Task: Verify that Prompt 838 executed correctly

**Folder that was processed:** `wall-of-fame\\badges`
...
- Does it contain "Prompt 838: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `wall-of-fame\\badges`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 838: Executed"
...
## If PASSED
Say: "✅ Prompt 838 verified successfully. Ready for Prompt 839."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 838.
