# Verification for Prompt 508

## Task: Verify that Prompt 508 executed correctly

**Folder that was processed:** `dashboard\\plugins\\oracles\\docs`
...
- Does it contain "Prompt 508: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\oracles\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 508: Executed"
...
## If PASSED
Say: "✅ Prompt 508 verified successfully. Ready for Prompt 509."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 508.
