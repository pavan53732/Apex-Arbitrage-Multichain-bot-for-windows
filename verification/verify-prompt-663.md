# Verification for Prompt 663

## Task: Verify that Prompt 663 executed correctly

**Folder that was processed:** `deploy\\terraform\\modules\\vpc`
...
- Does it contain "Prompt 663: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\terraform\\modules\\vpc`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 663: Executed"
...
## If PASSED
Say: "✅ Prompt 663 verified successfully. Ready for Prompt 664."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 663.
