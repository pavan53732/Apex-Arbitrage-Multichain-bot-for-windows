# Verification for Prompt 830

## Task: Verify that Prompt 830 executed correctly

**Folder that was processed:** `vendor\\binaries`
...
- Does it contain "Prompt 830: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `vendor\\binaries`, determine the owner:
...
- Does the feature name match or relate to "Binaries"?
...
✅/❌ Progress.md contains "Prompt 830: Executed"
...
## If PASSED
Say: "✅ Prompt 830 verified successfully. Ready for Prompt 831."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 830.
