# Verification for Prompt 99

## Task: Verify that Prompt 99 executed correctly

**Folder that was processed:** `backend\\migrations`
...
- Does it contain "Prompt 99: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\migrations`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 99: Executed"
...
## If PASSED
Say: "✅ Prompt 99 verified successfully. Ready for Prompt 100."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 99.
