# Verification for Prompt 805

## Task: Verify that Prompt 805 executed correctly

**Folder that was processed:** `third-party\\oracles`
...
- Does it contain "Prompt 805: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `third-party\\oracles`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 805: Executed"
...
## If PASSED
Say: "✅ Prompt 805 verified successfully. Ready for Prompt 806."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 805.
