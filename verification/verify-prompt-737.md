# Verification Prompt for Prompt 737

## Your Task: Verify Execution of Prompt 737

You are verifying that **Prompt 737** was executed correctly.

### What Prompt 737 Should Have Done:

**Folder Analyzed:** `presets\\migration`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 737:"
```
**Expected:** Should find entry like "Prompt 737: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `presets\\migration`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 737
================================
...
Confirm: "Prompt 737 executed correctly. Ready for Prompt 738."
