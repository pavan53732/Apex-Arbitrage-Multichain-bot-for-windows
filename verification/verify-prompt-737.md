# Verification for Prompt 737

## Task: Verify that Prompt 737 executed correctly

**Folder that was processed:** `presets\\migration`
...
- Does it contain "Prompt 737: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `presets\\migration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 737: Executed"
...
## If PASSED
Say: "✅ Prompt 737 verified successfully. Ready for Prompt 738."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 737.
