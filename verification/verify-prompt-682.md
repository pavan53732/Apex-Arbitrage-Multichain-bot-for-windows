# Verification for Prompt 682

## Task: Verify that Prompt 682 executed correctly

**Folder that was processed:** `examples\\simulation-runs`
...
- Does it contain "Prompt 682: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `examples\\simulation-runs`, determine the owner:
...
- Does the feature name match or relate to "Simulation Runs"?
...
✅/❌ Progress.md contains "Prompt 682: Executed"
...
## If PASSED
Say: "✅ Prompt 682 verified successfully. Ready for Prompt 683."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 682.
