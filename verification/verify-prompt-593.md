# Verification for Prompt 593

## Task: Verify that Prompt 593 executed correctly

**Folder that was processed:** `data\\analytics\\ai-analysis`
...
- Does it contain "Prompt 593: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\analytics\\ai-analysis`, determine the owner:
...
- Does the feature name match or relate to "Ai Analysis"?
...
✅/❌ Progress.md contains "Prompt 593: Executed"
...
## If PASSED
Say: "✅ Prompt 593 verified successfully. Ready for Prompt 594."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 593.
