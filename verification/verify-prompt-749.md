# Verification for Prompt 749

## Task: Verify that Prompt 749 executed correctly

**Folder that was processed:** `public\\icons\\badges`
...
- Does it contain "Prompt 749: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `public\\icons\\badges`, determine the owner:
...
- Does the feature name match or relate to "Badges"?
...
✅/❌ Progress.md contains "Prompt 749: Executed"
...
## If PASSED
Say: "✅ Prompt 749 verified successfully. Ready for Prompt 750."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 749.
