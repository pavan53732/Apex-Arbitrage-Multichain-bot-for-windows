# Verification for Prompt 165

## Task: Verify that Prompt 165 executed correctly

**Folder that was processed:** `backend\\plugins\\social-impact\\docs`
...
- Does it contain "Prompt 165: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\plugins\\social-impact\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 165: Executed"
...
## If PASSED
Say: "✅ Prompt 165 verified successfully. Ready for Prompt 166."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 165.
