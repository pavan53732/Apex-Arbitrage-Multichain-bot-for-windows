# Verification for Prompt 513

## Task: Verify that Prompt 513 executed correctly

**Folder that was processed:** `dashboard\\plugins\\social-impact\\tests`
...
- Does it contain "Prompt 513: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\plugins\\social-impact\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 513: Executed"
...
## If PASSED
Say: "✅ Prompt 513 verified successfully. Ready for Prompt 514."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 513.
