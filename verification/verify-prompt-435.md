# Verification for Prompt 435

## Task: Verify that Prompt 435 executed correctly

**Folder that was processed:** `dashboard\\docs\\formal`
...
- Does it contain "Prompt 435: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\docs\\formal`, determine the owner:
...
- Does the feature name match or relate to "Formal"?
...
✅/❌ Progress.md contains "Prompt 435: Executed"
...
## If PASSED
Say: "✅ Prompt 435 verified successfully. Ready for Prompt 436."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 435.
