# Verification for Prompt 732

## Task: Verify that Prompt 732 executed correctly

**Folder that was processed:** `presets`
...
- Does it contain "Prompt 732: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `presets`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 732: Executed"
...
## If PASSED
Say: "✅ Prompt 732 verified successfully. Ready for Prompt 733."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 732.
