# Verification for Prompt 17

## Task: Verify that Prompt 17 executed correctly

**Folder that was processed:** `archive\\docs`
...
- Does it contain "Prompt 17: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 17: Executed"
...
## If PASSED
Say: "✅ Prompt 17 verified successfully. Ready for Prompt 18."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 17.
