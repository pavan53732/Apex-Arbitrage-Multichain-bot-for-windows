# Verification for Prompt 93

## Task: Verify that Prompt 93 executed correctly

**Folder that was processed:** `backend\\examples\\dashboard-screenshots`
...
- Does it contain "Prompt 93: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\examples\\dashboard-screenshots`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 93: Executed"
...
## If PASSED
Say: "✅ Prompt 93 verified successfully. Ready for Prompt 94."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 93.
