# Verification Prompt for Prompt 802

## Your Task: Verify Execution of Prompt 802

You are verifying that **Prompt 802** was executed correctly.

### What Prompt 802 Should Have Done:

**Folder Analyzed:** `third-party\\bots`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 802:"
```
**Expected:** Should find entry like "Prompt 802: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `third-party\\bots`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Bots"
```
**Expected:** Should find feature section with name containing "Bots"
...
Confirm: "Prompt 802 executed correctly. Ready for Prompt 803."
