# Verification for Prompt 592

## Task: Verify that Prompt 592 executed correctly

**Folder that was processed:** `data\\analytics`
...
- Does it contain "Prompt 592: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\analytics`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 592: Executed"
...
## If PASSED
Say: "✅ Prompt 592 verified successfully. Ready for Prompt 593."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 592.
