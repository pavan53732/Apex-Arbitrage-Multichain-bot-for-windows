# Verification for Prompt 380

## Task: Verify that Prompt 380 executed correctly

**Folder that was processed:** `dashboard\\data\\analytics`
...
- Does it contain "Prompt 380: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\analytics`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 380: Executed"
...
## If PASSED
Say: "✅ Prompt 380 verified successfully. Ready for Prompt 381."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 380.
