# Verification Prompt for Prompt 380

## Your Task: Verify Execution of Prompt 380

You are verifying that **Prompt 380** was executed correctly.

### What Prompt 380 Should Have Done:

**Folder Analyzed:** `dashboard\\data\\analytics`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 380:"
```
**Expected:** Should find entry like "Prompt 380: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\data\\analytics`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 380
================================
...
Confirm: "Prompt 380 executed correctly. Ready for Prompt 381."
