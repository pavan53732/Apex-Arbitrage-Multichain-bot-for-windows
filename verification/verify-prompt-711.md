# Verification for Prompt 711

## Task: Verify that Prompt 711 executed correctly

**Folder that was processed:** `migrations\\plugin`
...
- Does it contain "Prompt 711: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `migrations\\plugin`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 711: Executed"
...
## If PASSED
Say: "✅ Prompt 711 verified successfully. Ready for Prompt 712."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 711.
