# Verification Prompt for Prompt 711

## Your Task: Verify Execution of Prompt 711

You are verifying that **Prompt 711** was executed correctly.

### What Prompt 711 Should Have Done:

**Folder Analyzed:** `migrations\\plugin`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 711:"
```
**Expected:** Should find entry like "Prompt 711: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `migrations\\plugin`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 711
================================
...
Confirm: "Prompt 711 executed correctly. Ready for Prompt 712."
