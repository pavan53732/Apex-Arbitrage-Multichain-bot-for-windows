# Verification for Prompt 32

## Task: Verify that Prompt 32 executed correctly

**Folder that was processed:** `backend\\contracts`
...
- Does it contain "Prompt 32: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\contracts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 32: Executed"
...
## If PASSED
Say: "✅ Prompt 32 verified successfully. Ready for Prompt 33."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 32.
