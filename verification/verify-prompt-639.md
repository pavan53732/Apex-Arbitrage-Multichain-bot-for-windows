# Verification for Prompt 639

## Task: Verify that Prompt 639 executed correctly

**Folder that was processed:** `deploy\\audit`
...
- Does it contain "Prompt 639: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\audit`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 639: Executed"
...
## If PASSED
Say: "✅ Prompt 639 verified successfully. Ready for Prompt 640."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 639.
