# Verification for Prompt 762

## Task: Verify that Prompt 762 executed correctly

**Folder that was processed:** `research\\docs`
...
- Does it contain "Prompt 762: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `research\\docs`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 762: Executed"
...
## If PASSED
Say: "✅ Prompt 762 verified successfully. Ready for Prompt 763."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 762.
