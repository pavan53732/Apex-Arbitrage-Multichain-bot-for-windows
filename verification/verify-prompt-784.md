# Verification for Prompt 784

## Task: Verify that Prompt 784 executed correctly

**Folder that was processed:** `tests`
...
- Does it contain "Prompt 784: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 784: Executed"
...
## If PASSED
Say: "✅ Prompt 784 verified successfully. Ready for Prompt 785."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 784.
