# Verification for Prompt 667

## Task: Verify that Prompt 667 executed correctly

**Folder that was processed:** `docs\\ai`
...
- Does it contain "Prompt 667: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `docs\\ai`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 667: Executed"
...
## If PASSED
Say: "✅ Prompt 667 verified successfully. Ready for Prompt 668."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 667.
