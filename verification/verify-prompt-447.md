# Verification Prompt for Prompt 447

## Your Task: Verify Execution of Prompt 447

You are verifying that **Prompt 447** was executed correctly.

### What Prompt 447 Should Have Done:

**Folder Analyzed:** `dashboard\\extensions\\demo`
**Expected Feature Name:** `Demo`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 447:"
```
**Expected:** Should find entry like "Prompt 447: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\extensions\\demo`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Demo"
```
**Expected:** Should find feature section with name containing "Demo"
...
```
VERIFICATION REPORT - PROMPT 447
================================
...
Confirm: "Prompt 447 executed correctly. Ready for Prompt 448."
