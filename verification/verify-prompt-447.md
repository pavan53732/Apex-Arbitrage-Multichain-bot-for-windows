# Verification for Prompt 447

## Task: Verify that Prompt 447 executed correctly

**Folder that was processed:** `dashboard\\extensions\\demo`
...
- Does it contain "Prompt 447: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\extensions\\demo`, determine the owner:
...
- Does the feature name match or relate to "Demo"?
...
✅/❌ Progress.md contains "Prompt 447: Executed"
...
## If PASSED
Say: "✅ Prompt 447 verified successfully. Ready for Prompt 448."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 447.
