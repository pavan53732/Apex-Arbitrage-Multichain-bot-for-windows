# Verification for Prompt 356

## Task: Verify that Prompt 356 executed correctly

**Folder that was processed:** `dashboard\\ar\\xr`
...
- Does it contain "Prompt 356: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\xr`, determine the owner:
...
- Does the feature name match or relate to "Xr"?
...
✅/❌ Progress.md contains "Prompt 356: Executed"
...
## If PASSED
Say: "✅ Prompt 356 verified successfully. Ready for Prompt 357."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 356.
