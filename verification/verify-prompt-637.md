# Verification Prompt for Prompt 637

## Your Task: Verify Execution of Prompt 637

You are verifying that **Prompt 637** was executed correctly.

### What Prompt 637 Should Have Done:

**Folder Analyzed:** `deploy\\ansible\\roles\\operator`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 637:"
```
**Expected:** Should find entry like "Prompt 637: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `deploy\\ansible\\roles\\operator`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 637
================================
...
Confirm: "Prompt 637 executed correctly. Ready for Prompt 638."
