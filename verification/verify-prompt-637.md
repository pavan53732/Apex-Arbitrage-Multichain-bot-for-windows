# Verification for Prompt 637

## Task: Verify that Prompt 637 executed correctly

**Folder that was processed:** `deploy\\ansible\\roles\\operator`
...
- Does it contain "Prompt 637: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\ansible\\roles\\operator`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 637: Executed"
...
## If PASSED
Say: "✅ Prompt 637 verified successfully. Ready for Prompt 638."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 637.
