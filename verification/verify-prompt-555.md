# Verification for Prompt 555

## Task: Verify that Prompt 555 executed correctly

**Folder that was processed:** `dashboard\\tests\\integration`
...
- Does it contain "Prompt 555: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\tests\\integration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 555: Executed"
...
## If PASSED
Say: "✅ Prompt 555 verified successfully. Ready for Prompt 556."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 555.
