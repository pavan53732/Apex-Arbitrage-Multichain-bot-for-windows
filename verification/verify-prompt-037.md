# Verification Prompt for Prompt 37

## Your Task: Verify Execution of Prompt 37

You are verifying that **Prompt 37** was executed correctly.

### What Prompt 37 Should Have Done:

**Folder Analyzed:** `backend\\contracts\\src\\executors`
**Expected Feature Name:** `Executors`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 37:"
```
**Expected:** Should find entry like "Prompt 37: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\contracts\\src\\executors`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Executors"
```
**Expected:** Should find feature section with name containing "Executors"
...
Confirm: "Prompt 37 executed correctly. Ready for Prompt 38."
