# Verification for Prompt 669

## Task: Verify that Prompt 669 executed correctly

**Folder that was processed:** `docs\\audit`
...
- Does it contain "Prompt 669: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `docs\\audit`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 669: Executed"
...
## If PASSED
Say: "✅ Prompt 669 verified successfully. Ready for Prompt 670."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 669.
