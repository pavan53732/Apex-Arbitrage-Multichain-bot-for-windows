# Verification for Prompt 653

## Task: Verify that Prompt 653 executed correctly

**Folder that was processed:** `deploy\\kubernetes\\overlays\\staging`
...
- Does it contain "Prompt 653: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\kubernetes\\overlays\\staging`, determine the owner:
...
- Does the feature name match or relate to "Staging"?
...
✅/❌ Progress.md contains "Prompt 653: Executed"
...
## If PASSED
Say: "✅ Prompt 653 verified successfully. Ready for Prompt 654."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 653.
