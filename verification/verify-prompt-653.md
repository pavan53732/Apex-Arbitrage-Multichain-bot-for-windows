# Verification Prompt for Prompt 653

## Your Task: Verify Execution of Prompt 653

You are verifying that **Prompt 653** was executed correctly.

### What Prompt 653 Should Have Done:

**Folder Analyzed:** `deploy\\kubernetes\\overlays\\staging`
**Expected Feature Name:** `Staging`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 653:"
```
**Expected:** Should find entry like "Prompt 653: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `deploy\\kubernetes\\overlays\\staging`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Staging"
```
**Expected:** Should find feature section with name containing "Staging"
...
```
VERIFICATION REPORT - PROMPT 653
================================
...
Confirm: "Prompt 653 executed correctly. Ready for Prompt 654."
