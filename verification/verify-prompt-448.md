# Verification for Prompt 448

## Task: Verify that Prompt 448 executed correctly

**Folder that was processed:** `dashboard\\extensions\\integration`
...
- Does it contain "Prompt 448: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\extensions\\integration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 448: Executed"
...
## If PASSED
Say: "✅ Prompt 448 verified successfully. Ready for Prompt 449."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 448.
