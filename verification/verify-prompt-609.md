# Verification for Prompt 609

## Task: Verify that Prompt 609 executed correctly

**Folder that was processed:** `data\\backups\\weekly`
...
- Does it contain "Prompt 609: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\backups\\weekly`, determine the owner:
...
- Does the feature name match or relate to "Weekly"?
...
✅/❌ Progress.md contains "Prompt 609: Executed"
...
## If PASSED
Say: "✅ Prompt 609 verified successfully. Ready for Prompt 610."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 609.
