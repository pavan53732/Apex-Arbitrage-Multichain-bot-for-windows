# Verification for Prompt 255

## Task: Verify that Prompt 255 executed correctly

**Folder that was processed:** `ci\\legacy`
...
- Does it contain "Prompt 255: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\legacy`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 255: Executed"
...
## If PASSED
Say: "✅ Prompt 255 verified successfully. Ready for Prompt 256."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 255.
