# Verification for Prompt 423

## Task: Verify that Prompt 423 executed correctly

**Folder that was processed:** `dashboard\\deploy\\terraform\\modules\\db`
...
- Does it contain "Prompt 423: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\terraform\\modules\\db`, determine the owner:
...
- Does the feature name match or relate to "Db"?
...
✅/❌ Progress.md contains "Prompt 423: Executed"
...
## If PASSED
Say: "✅ Prompt 423 verified successfully. Ready for Prompt 424."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 423.
