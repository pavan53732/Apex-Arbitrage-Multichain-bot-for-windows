# Verification for Prompt 362

## Task: Verify that Prompt 362 executed correctly

**Folder that was processed:** `dashboard\\components\\atomic`
...
- Does it contain "Prompt 362: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\atomic`, determine the owner:
...
- Does the feature name match or relate to "Atomic"?
...
✅/❌ Progress.md contains "Prompt 362: Executed"
...
## If PASSED
Say: "✅ Prompt 362 verified successfully. Ready for Prompt 363."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 362.
