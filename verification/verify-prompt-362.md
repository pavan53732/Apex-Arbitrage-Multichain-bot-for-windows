# Verification Prompt for Prompt 362

## Your Task: Verify Execution of Prompt 362

You are verifying that **Prompt 362** was executed correctly.

### What Prompt 362 Should Have Done:

**Folder Analyzed:** `dashboard\\components\\atomic`
**Expected Feature Name:** `Atomic`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 362:"
```
**Expected:** Should find entry like "Prompt 362: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\components\\atomic`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Atomic"
```
**Expected:** Should find feature section with name containing "Atomic"
...
```
VERIFICATION REPORT - PROMPT 362
================================
...
Confirm: "Prompt 362 executed correctly. Ready for Prompt 363."
