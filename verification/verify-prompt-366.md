# Verification Prompt for Prompt 366

## Your Task: Verify Execution of Prompt 366

You are verifying that **Prompt 366** was executed correctly.

### What Prompt 366 Should Have Done:

**Folder Analyzed:** `dashboard\\components\\layout`
**Expected Feature Name:** `Layout`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 366:"
```
**Expected:** Should find entry like "Prompt 366: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\components\\layout`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Layout"
```
**Expected:** Should find feature section with name containing "Layout"
...
```
VERIFICATION REPORT - PROMPT 366
================================
...
Confirm: "Prompt 366 executed correctly. Ready for Prompt 367."
