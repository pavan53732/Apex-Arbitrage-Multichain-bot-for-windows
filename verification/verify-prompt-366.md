# Verification for Prompt 366

## Task: Verify that Prompt 366 executed correctly

**Folder that was processed:** `dashboard\\components\\layout`
...
- Does it contain "Prompt 366: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\components\\layout`, determine the owner:
...
- Does the feature name match or relate to "Layout"?
...
✅/❌ Progress.md contains "Prompt 366: Executed"
...
## If PASSED
Say: "✅ Prompt 366 verified successfully. Ready for Prompt 367."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 366.
