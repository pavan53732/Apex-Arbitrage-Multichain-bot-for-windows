# Verification for Prompt 39

## Task: Verify that Prompt 39 executed correctly

**Folder that was processed:** `backend\\contracts\\src\\interfaces`
...
- Does it contain "Prompt 39: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\contracts\\src\\interfaces`, determine the owner:
...
- Does the feature name match or relate to "Interfaces"?
...
✅/❌ Progress.md contains "Prompt 39: Executed"
...
## If PASSED
Say: "✅ Prompt 39 verified successfully. Ready for Prompt 40."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 39.
