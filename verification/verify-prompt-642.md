# Verification for Prompt 642

## Task: Verify that Prompt 642 executed correctly

**Folder that was processed:** `deploy\\environments`
...
- Does it contain "Prompt 642: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\environments`, determine the owner:
...
- Does the feature name match or relate to "Environments"?
...
✅/❌ Progress.md contains "Prompt 642: Executed"
...
## If PASSED
Say: "✅ Prompt 642 verified successfully. Ready for Prompt 643."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 642.
