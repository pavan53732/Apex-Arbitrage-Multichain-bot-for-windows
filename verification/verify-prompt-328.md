# Verification for Prompt 328

## Task: Verify that Prompt 328 executed correctly

**Folder that was processed:** `dashboard\\analytics\\utils`
...
- Does it contain "Prompt 328: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\analytics\\utils`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 328: Executed"
...
## If PASSED
Say: "✅ Prompt 328 verified successfully. Ready for Prompt 329."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 328.
