# Verification Prompt for Prompt 300

## Your Task: Verify Execution of Prompt 300

You are verifying that **Prompt 300** was executed correctly.

### What Prompt 300 Should Have Done:

**Folder Analyzed:** `dashboard\\ai\\chat`
**Expected Feature Name:** `Chat`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 300:"
```
**Expected:** Should find entry like "Prompt 300: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\ai\\chat`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Chat"
```
**Expected:** Should find feature section with name containing "Chat"
...
```
VERIFICATION REPORT - PROMPT 300
================================
...
Confirm: "Prompt 300 executed correctly. Ready for Prompt 301."
