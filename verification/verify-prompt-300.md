# Verification for Prompt 300

## Task: Verify that Prompt 300 executed correctly

**Folder that was processed:** `dashboard\\ai\\chat`
...
- Does it contain "Prompt 300: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ai\\chat`, determine the owner:
...
- Does the feature name match or relate to "Chat"?
...
✅/❌ Progress.md contains "Prompt 300: Executed"
...
## If PASSED
Say: "✅ Prompt 300 verified successfully. Ready for Prompt 301."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 300.
