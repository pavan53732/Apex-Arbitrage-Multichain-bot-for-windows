# Verification Prompt for Prompt 814

## Your Task: Verify Execution of Prompt 814

You are verifying that **Prompt 814** was executed correctly.

### What Prompt 814 Should Have Done:

**Folder Analyzed:** `types\\ts`
**Expected Feature Name:** `Ts`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 814:"
```
**Expected:** Should find entry like "Prompt 814: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `types\\ts`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Ts"
```
**Expected:** Should find feature section with name containing "Ts"
...
```
VERIFICATION REPORT - PROMPT 814
================================
...
Confirm: "Prompt 814 executed correctly. Ready for Prompt 815."
