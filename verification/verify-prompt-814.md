# Verification for Prompt 814

## Task: Verify that Prompt 814 executed correctly

**Folder that was processed:** `types\\ts`
...
- Does it contain "Prompt 814: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `types\\ts`, determine the owner:
...
- Does the feature name match or relate to "Ts"?
...
✅/❌ Progress.md contains "Prompt 814: Executed"
...
## If PASSED
Say: "✅ Prompt 814 verified successfully. Ready for Prompt 815."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 814.
