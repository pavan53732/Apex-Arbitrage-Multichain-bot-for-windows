# Verification Prompt for Prompt 315

## Your Task: Verify Execution of Prompt 315

You are verifying that **Prompt 315** was executed correctly.

### What Prompt 315 Should Have Done:

**Folder Analyzed:** `dashboard\\analytics\\ai`
**Expected Feature Name:** `Ai`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 315:"
```
**Expected:** Should find entry like "Prompt 315: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\analytics\\ai`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Ai"
```
**Expected:** Should find feature section with name containing "Ai"
...
```
VERIFICATION REPORT - PROMPT 315
================================
...
Confirm: "Prompt 315 executed correctly. Ready for Prompt 316."
