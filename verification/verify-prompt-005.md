# Verification for Prompt 5

## Task: Verify that Prompt 5 executed correctly

**Folder that was processed:** `ai-modules\\models`
...
- Does it contain "Prompt 5: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ai-modules\\models`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 5: Executed"
...
## If PASSED
Say: "✅ Prompt 5 verified successfully. Ready for Prompt 6."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 5.
