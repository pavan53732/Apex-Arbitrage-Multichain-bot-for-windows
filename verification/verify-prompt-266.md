# Verification for Prompt 266

## Task: Verify that Prompt 266 executed correctly

**Folder that was processed:** `config\\chains`
...
- Does it contain "Prompt 266: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\chains`, determine the owner:
...
- Does the feature name match or relate to "Chains"?
...
✅/❌ Progress.md contains "Prompt 266: Executed"
...
## If PASSED
Say: "✅ Prompt 266 verified successfully. Ready for Prompt 267."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 266.
