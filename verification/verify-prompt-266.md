# Verification Prompt for Prompt 266

## Your Task: Verify Execution of Prompt 266

You are verifying that **Prompt 266** was executed correctly.

### What Prompt 266 Should Have Done:

**Folder Analyzed:** `config\\chains`
**Expected Feature Name:** `Chains`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 266:"
```
**Expected:** Should find entry like "Prompt 266: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `config\\chains`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Chains"
```
**Expected:** Should find feature section with name containing "Chains"
...
```
VERIFICATION REPORT - PROMPT 266
================================
...
Confirm: "Prompt 266 executed correctly. Ready for Prompt 267."
