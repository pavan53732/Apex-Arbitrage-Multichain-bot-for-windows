# Verification for Prompt 628

## Task: Verify that Prompt 628 executed correctly

**Folder that was processed:** `data\\synthetic-datasets`
...
- Does it contain "Prompt 628: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\synthetic-datasets`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 628: Executed"
...
## If PASSED
Say: "✅ Prompt 628 verified successfully. Ready for Prompt 629."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 628.
