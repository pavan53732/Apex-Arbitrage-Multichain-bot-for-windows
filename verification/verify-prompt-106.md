# Verification for Prompt 106

## Task: Verify that Prompt 106 executed correctly

**Folder that was processed:** `backend\\migrations\\db`
...
- Does it contain "Prompt 106: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\migrations\\db`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 106: Executed"
...
## If PASSED
Say: "✅ Prompt 106 verified successfully. Ready for Prompt 107."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 106.
