# Verification for Prompt 466

## Task: Verify that Prompt 466 executed correctly

**Folder that was processed:** `dashboard\\integration`
...
- Does it contain "Prompt 466: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\integration`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 466: Executed"
...
## If PASSED
Say: "✅ Prompt 466 verified successfully. Ready for Prompt 467."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 466.
