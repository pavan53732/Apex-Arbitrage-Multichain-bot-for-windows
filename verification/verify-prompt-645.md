# Verification for Prompt 645

## Task: Verify that Prompt 645 executed correctly

**Folder that was processed:** `deploy\\helm\\apex-protocol\\templates`
...
- Does it contain "Prompt 645: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\helm\\apex-protocol\\templates`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 645: Executed"
...
## If PASSED
Say: "✅ Prompt 645 verified successfully. Ready for Prompt 646."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 645.
