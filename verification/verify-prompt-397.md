# Verification Prompt for Prompt 397

## Your Task: Verify Execution of Prompt 397

You are verifying that **Prompt 397** was executed correctly.

### What Prompt 397 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\ansible\\roles\\ai-modules\\operator`
**Expected Feature Name:** `Operator`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 397:"
```
**Expected:** Should find entry like "Prompt 397: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\ansible\\roles\\ai-modules\\operator`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Operator"
```
**Expected:** Should find feature section with name containing "Operator"
...
```
VERIFICATION REPORT - PROMPT 397
================================
...
Confirm: "Prompt 397 executed correctly. Ready for Prompt 398."
