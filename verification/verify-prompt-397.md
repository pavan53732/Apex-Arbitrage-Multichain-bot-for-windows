# Verification for Prompt 397

## Task: Verify that Prompt 397 executed correctly

**Folder that was processed:** `dashboard\\deploy\\ansible\\roles\\ai-modules\\operator`
...
- Does it contain "Prompt 397: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\ansible\\roles\\ai-modules\\operator`, determine the owner:
...
- Does the feature name match or relate to "Operator"?
...
✅/❌ Progress.md contains "Prompt 397: Executed"
...
## If PASSED
Say: "✅ Prompt 397 verified successfully. Ready for Prompt 398."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 397.
