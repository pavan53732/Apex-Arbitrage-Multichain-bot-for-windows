# Verification Prompt for Prompt 231

## Your Task: Verify Execution of Prompt 231

You are verifying that **Prompt 231** was executed correctly.

### What Prompt 231 Should Have Done:

**Folder Analyzed:** `benchmarks\\cpu`
**Expected Feature Name:** `Cpu`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 231:"
```
**Expected:** Should find entry like "Prompt 231: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `benchmarks\\cpu`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Cpu"
```
**Expected:** Should find feature section with name containing "Cpu"
...
```
VERIFICATION REPORT - PROMPT 231
================================
...
Confirm: "Prompt 231 executed correctly. Ready for Prompt 232."
