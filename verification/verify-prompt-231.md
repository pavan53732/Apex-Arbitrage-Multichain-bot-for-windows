# Verification for Prompt 231

## Task: Verify that Prompt 231 executed correctly

**Folder that was processed:** `benchmarks\\cpu`
...
- Does it contain "Prompt 231: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `benchmarks\\cpu`, determine the owner:
...
- Does the feature name match or relate to "Cpu"?
...
✅/❌ Progress.md contains "Prompt 231: Executed"
...
## If PASSED
Say: "✅ Prompt 231 verified successfully. Ready for Prompt 232."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 231.
