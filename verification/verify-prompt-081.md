# Verification Prompt for Prompt 81

## Your Task: Verify Execution of Prompt 81

You are verifying that **Prompt 81** was executed correctly.

### What Prompt 81 Should Have Done:

**Folder Analyzed:** `backend\\engine\\data\\sim-results`
**Expected Feature Name:** `Sim Results`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 81:"
```
**Expected:** Should find entry like "Prompt 81: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\engine\\data\\sim-results`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Sim Results"
```
**Expected:** Should find feature section with name containing "Sim Results"
...
Confirm: "Prompt 81 executed correctly. Ready for Prompt 82."
