# Verification for Prompt 167

## Task: Verify that Prompt 167 executed correctly

**Folder that was processed:** `backend\\plugins\\template`
...
- Does it contain "Prompt 167: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\plugins\\template`, determine the owner:
...
- Does the feature name match or relate to "Template"?
...
✅/❌ Progress.md contains "Prompt 167: Executed"
...
## If PASSED
Say: "✅ Prompt 167 verified successfully. Ready for Prompt 168."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 167.
