# Verification for Prompt 531

## Task: Verify that Prompt 531 executed correctly

**Folder that was processed:** `dashboard\\scripts`
...
- Does it contain "Prompt 531: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 531: Executed"
...
## If PASSED
Say: "✅ Prompt 531 verified successfully. Ready for Prompt 532."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 531.
