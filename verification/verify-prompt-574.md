# Verification for Prompt 574

## Task: Verify that Prompt 574 executed correctly

**Folder that was processed:** `dashboard\\uploads`
...
- Does it contain "Prompt 574: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\uploads`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 574: Executed"
...
## If PASSED
Say: "✅ Prompt 574 verified successfully. Ready for Prompt 575."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 574.
