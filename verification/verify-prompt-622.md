# Verification for Prompt 622

## Task: Verify that Prompt 622 executed correctly

**Folder that was processed:** `data\\simulation-results\\ai-batch`
...
- Does it contain "Prompt 622: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\simulation-results\\ai-batch`, determine the owner:
...
- Does the feature name match or relate to "Ai Batch"?
...
✅/❌ Progress.md contains "Prompt 622: Executed"
...
## If PASSED
Say: "✅ Prompt 622 verified successfully. Ready for Prompt 623."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 622.
