# Verification for Prompt 408

## Task: Verify that Prompt 408 executed correctly

**Folder that was processed:** `dashboard\\deploy\\helm\\apex-protocol\\templates`
...
- Does it contain "Prompt 408: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\helm\\apex-protocol\\templates`, determine the owner:
...
- Does the feature name match or relate to "Templates"?
...
✅/❌ Progress.md contains "Prompt 408: Executed"
...
## If PASSED
Say: "✅ Prompt 408 verified successfully. Ready for Prompt 409."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 408.
