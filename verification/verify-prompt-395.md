# Verification Prompt for Prompt 395

## Your Task: Verify Execution of Prompt 395

You are verifying that **Prompt 395** was executed correctly.

### What Prompt 395 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\ansible\\roles\\ai-modules\\backend`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 395:"
```
**Expected:** Should find entry like "Prompt 395: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\ansible\\roles\\ai-modules\\backend`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 395
================================
...
Confirm: "Prompt 395 executed correctly. Ready for Prompt 396."
