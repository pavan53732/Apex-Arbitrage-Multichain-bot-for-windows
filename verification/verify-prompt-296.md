# Verification for Prompt 296

## Task: Verify that Prompt 296 executed correctly
...
- Does it contain "Prompt 296: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 296: Executed"
...
## If PASSED
Say: "✅ Prompt 296 verified successfully. Ready for Prompt 297."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 296.
