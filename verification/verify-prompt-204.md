# Verification for Prompt 204

## Task: Verify that Prompt 204 executed correctly

**Folder that was processed:** `backend\\tests\\fuzz`
...
- Does it contain "Prompt 204: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\tests\\fuzz`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 204: Executed"
...
## If PASSED
Say: "✅ Prompt 204 verified successfully. Ready for Prompt 205."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 204.
