# Verification for Prompt 287

## Task: Verify that Prompt 287 executed correctly

**Folder that was processed:** `config\\risk`
...
- Does it contain "Prompt 287: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\risk`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 287: Executed"
...
## If PASSED
Say: "✅ Prompt 287 verified successfully. Ready for Prompt 288."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 287.
