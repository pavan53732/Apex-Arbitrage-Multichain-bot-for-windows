# Verification for Prompt 87

## Task: Verify that Prompt 87 executed correctly

**Folder that was processed:** `backend\\engine\\tests`
...
- Does it contain "Prompt 87: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\engine\\tests`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 87: Executed"
...
## If PASSED
Say: "✅ Prompt 87 verified successfully. Ready for Prompt 88."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 87.
