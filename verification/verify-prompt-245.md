# Verification for Prompt 245

## Task: Verify that Prompt 245 executed correctly

**Folder that was processed:** `ci\\circleci`
...
- Does it contain "Prompt 245: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `ci\\circleci`, determine the owner:
...
- Does the feature name match or relate to "Circleci"?
...
✅/❌ Progress.md contains "Prompt 245: Executed"
...
## If PASSED
Say: "✅ Prompt 245 verified successfully. Ready for Prompt 246."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 245.
