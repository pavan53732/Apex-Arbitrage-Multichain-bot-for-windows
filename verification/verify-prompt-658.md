# Verification for Prompt 658

## Task: Verify that Prompt 658 executed correctly

**Folder that was processed:** `deploy\\terraform`
...
- Does it contain "Prompt 658: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\terraform`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 658: Executed"
...
## If PASSED
Say: "✅ Prompt 658 verified successfully. Ready for Prompt 659."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 658.
