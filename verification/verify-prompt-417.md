# Verification for Prompt 417

## Task: Verify that Prompt 417 executed correctly

**Folder that was processed:** `dashboard\\deploy\\kubernetes\\scripts`
...
- Does it contain "Prompt 417: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\kubernetes\\scripts`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 417: Executed"
...
## If PASSED
Say: "✅ Prompt 417 verified successfully. Ready for Prompt 418."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 417.
