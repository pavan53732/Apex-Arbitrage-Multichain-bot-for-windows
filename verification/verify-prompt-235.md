# Verification Prompt for Prompt 235

## Your Task: Verify Execution of Prompt 235

You are verifying that **Prompt 235** was executed correctly.

### What Prompt 235 Should Have Done:

**Folder Analyzed:** `benchmarks\\latency`
**Expected Feature Name:** `Latency`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 235:"
```
**Expected:** Should find entry like "Prompt 235: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `benchmarks\\latency`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Latency"
```
**Expected:** Should find feature section with name containing "Latency"
...
```
VERIFICATION REPORT - PROMPT 235
================================
...
Confirm: "Prompt 235 executed correctly. Ready for Prompt 236."
