# Verification for Prompt 235

## Task: Verify that Prompt 235 executed correctly

**Folder that was processed:** `benchmarks\\latency`
...
- Does it contain "Prompt 235: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `benchmarks\\latency`, determine the owner:
...
- Does the feature name match or relate to "Latency"?
...
✅/❌ Progress.md contains "Prompt 235: Executed"
...
## If PASSED
Say: "✅ Prompt 235 verified successfully. Ready for Prompt 236."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 235.
