# Verification for Prompt 61

## Task: Verify that Prompt 61 executed correctly

**Folder that was processed:** `backend\\data\\operator-audit`
...
- Does it contain "Prompt 61: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\data\\operator-audit`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 61: Executed"
...
## If PASSED
Say: "✅ Prompt 61 verified successfully. Ready for Prompt 62."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 61.
