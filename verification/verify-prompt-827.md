# Verification for Prompt 827

## Task: Verify that Prompt 827 executed correctly

**Folder that was processed:** `utils\\watchers`
...
- Does it contain "Prompt 827: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `utils\\watchers`, determine the owner:
...
- Does the feature name match or relate to "Watchers"?
...
✅/❌ Progress.md contains "Prompt 827: Executed"
...
## If PASSED
Say: "✅ Prompt 827 verified successfully. Ready for Prompt 828."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 827.
