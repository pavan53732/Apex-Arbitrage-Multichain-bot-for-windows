# Verification for Prompt 337

## Task: Verify that Prompt 337 executed correctly

**Folder that was processed:** `dashboard\\api\\sockets`
...
- Does it contain "Prompt 337: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\api\\sockets`, determine the owner:
...
- Does the feature name match or relate to "Sockets"?
...
✅/❌ Progress.md contains "Prompt 337: Executed"
...
## If PASSED
Say: "✅ Prompt 337 verified successfully. Ready for Prompt 338."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 337.
