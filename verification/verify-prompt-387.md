# Verification for Prompt 387

## Task: Verify that Prompt 387 executed correctly

**Folder that was processed:** `dashboard\\data\\simulation-snapshots`
...
- Does it contain "Prompt 387: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\data\\simulation-snapshots`, determine the owner:
...
- Does the feature name match or relate to "Simulation Snapshots"?
...
✅/❌ Progress.md contains "Prompt 387: Executed"
...
## If PASSED
Say: "✅ Prompt 387 verified successfully. Ready for Prompt 388."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 387.
