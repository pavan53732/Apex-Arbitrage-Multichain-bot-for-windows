# Verification Prompt for Prompt 387

## Your Task: Verify Execution of Prompt 387

You are verifying that **Prompt 387** was executed correctly.

### What Prompt 387 Should Have Done:

**Folder Analyzed:** `dashboard\\data\\simulation-snapshots`
**Expected Feature Name:** `Simulation Snapshots`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 387:"
```
**Expected:** Should find entry like "Prompt 387: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\data\\simulation-snapshots`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Simulation Snapshots"
```
**Expected:** Should find feature section with name containing "Simulation Snapshots"
...
```
VERIFICATION REPORT - PROMPT 387
================================
...
Confirm: "Prompt 387 executed correctly. Ready for Prompt 388."
