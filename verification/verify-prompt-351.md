# Verification for Prompt 351

## Task: Verify that Prompt 351 executed correctly

**Folder that was processed:** `dashboard\\ar\\preview`
...
- Does it contain "Prompt 351: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\ar\\preview`, determine the owner:
...
- Does the feature name match or relate to "Preview"?
...
✅/❌ Progress.md contains "Prompt 351: Executed"
...
## If PASSED
Say: "✅ Prompt 351 verified successfully. Ready for Prompt 352."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 351.
