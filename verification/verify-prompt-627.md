# Verification Prompt for Prompt 627

## Your Task: Verify Execution of Prompt 627

You are verifying that **Prompt 627** was executed correctly.

### What Prompt 627 Should Have Done:

**Folder Analyzed:** `data\\simulation-snapshots`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 627:"
```
**Expected:** Should find entry like "Prompt 627: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `data\\simulation-snapshots`, determine which .md file should own this feature:
...
```
VERIFICATION REPORT - PROMPT 627
================================
...
Confirm: "Prompt 627 executed correctly. Ready for Prompt 628."
