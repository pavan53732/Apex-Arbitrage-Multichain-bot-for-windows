# Verification for Prompt 627

## Task: Verify that Prompt 627 executed correctly

**Folder that was processed:** `data\\simulation-snapshots`
...
- Does it contain "Prompt 627: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `data\\simulation-snapshots`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 627: Executed"
...
## If PASSED
Say: "✅ Prompt 627 verified successfully. Ready for Prompt 628."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 627.
