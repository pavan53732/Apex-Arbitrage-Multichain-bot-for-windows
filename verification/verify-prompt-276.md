# Verification for Prompt 276

## Task: Verify that Prompt 276 executed correctly

**Folder that was processed:** `config\\legacy`
...
- Does it contain "Prompt 276: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\legacy`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 276: Executed"
...
## If PASSED
Say: "✅ Prompt 276 verified successfully. Ready for Prompt 277."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 276.
