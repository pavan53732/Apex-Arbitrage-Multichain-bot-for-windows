# Verification for Prompt 630

## Task: Verify that Prompt 630 executed correctly

**Folder that was processed:** `deploy`
...
- Does it contain "Prompt 630: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 630: Executed"
...
## If PASSED
Say: "✅ Prompt 630 verified successfully. Ready for Prompt 631."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 630.
