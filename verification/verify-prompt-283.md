# Verification for Prompt 283

## Task: Verify that Prompt 283 executed correctly

**Folder that was processed:** `config\\overrides\\staging`
...
- Does it contain "Prompt 283: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `config\\overrides\\staging`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 283: Executed"
...
## If PASSED
Say: "✅ Prompt 283 verified successfully. Ready for Prompt 284."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 283.
