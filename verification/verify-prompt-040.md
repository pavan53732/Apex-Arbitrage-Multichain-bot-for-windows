# Verification Prompt for Prompt 40

## Your Task: Verify Execution of Prompt 40

You are verifying that **Prompt 40** was executed correctly.

### What Prompt 40 Should Have Done:

**Folder Analyzed:** `backend\\contracts\\src\\onchain-governance`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 40:"
```
**Expected:** Should find entry like "Prompt 40: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `backend\\contracts\\src\\onchain-governance`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Onchain Governance"
```
**Expected:** Should find feature section with name containing "Onchain Governance"
...
Confirm: "Prompt 40 executed correctly. Ready for Prompt 41."
