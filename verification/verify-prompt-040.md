# Verification for Prompt 40

## Task: Verify that Prompt 40 executed correctly

**Folder that was processed:** `backend\\contracts\\src\\onchain-governance`
**Expected feature name:** `Onchain Governance`
...
- Does it contain "Prompt 40: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `backend\\contracts\\src\\onchain-governance`, determine the owner:
...
- Does the feature name match or relate to "Onchain Governance"?
...
```
VERIFICATION REPORT - PROMPT 40
==========================================

✅/❌ Progress.md contains "Prompt 40: Executed"
...
## If PASSED
Say: "✅ Prompt 40 verified successfully. Ready for Prompt 41."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 40.
