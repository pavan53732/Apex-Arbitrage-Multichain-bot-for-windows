# Verification for Prompt 27

## Task: Verify that Prompt 27 executed correctly

**Folder that was processed:** `archive\\migrations-logs`
...
- Does it contain "Prompt 27: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `archive\\migrations-logs`, determine the owner:
...
- Does the feature name match or relate to "Migrations Logs"?
...
✅/❌ Progress.md contains "Prompt 27: Executed"
...
## If PASSED
Say: "✅ Prompt 27 verified successfully. Ready for Prompt 28."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 27.
