# Verification for Prompt 747

## Task: Verify that Prompt 747 executed correctly

**Folder that was processed:** `public\\fonts`
...
- Does it contain "Prompt 747: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `public\\fonts`, determine the owner:
...
- Does the feature name match or relate to "Fonts"?
...
✅/❌ Progress.md contains "Prompt 747: Executed"
...
## If PASSED
Say: "✅ Prompt 747 verified successfully. Ready for Prompt 748."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 747.
