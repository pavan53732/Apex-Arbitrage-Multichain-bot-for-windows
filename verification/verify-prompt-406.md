# Verification Prompt for Prompt 406

## Your Task: Verify Execution of Prompt 406

You are verifying that **Prompt 406** was executed correctly.

### What Prompt 406 Should Have Done:

**Folder Analyzed:** `dashboard\\deploy\\helm`
**Expected Feature Name:** `Helm`
...
#### 1. Check progress.md
```powershell
Get-Content "generated-prompts\progress.md" | Select-String "Prompt 406:"
```
**Expected:** Should find entry like "Prompt 406: Executed - Added 'Feature: [Name]' to features/[owner].md"

#### 2. Identify Owner File
Based on folder path `dashboard\\deploy\\helm`, determine which .md file should own this feature:
...
Get-Content $ownerFile | Select-String "## Feature.*Helm"
```
**Expected:** Should find feature section with name containing "Helm"
...
```
VERIFICATION REPORT - PROMPT 406
================================
...
Confirm: "Prompt 406 executed correctly. Ready for Prompt 407."
