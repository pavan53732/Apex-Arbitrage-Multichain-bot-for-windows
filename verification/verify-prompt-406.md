# Verification for Prompt 406

## Task: Verify that Prompt 406 executed correctly

**Folder that was processed:** `dashboard\\deploy\\helm`
...
- Does it contain "Prompt 406: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `dashboard\\deploy\\helm`, determine the owner:
...
- Does the feature name match or relate to "Helm"?
...
✅/❌ Progress.md contains "Prompt 406: Executed"
...
## If PASSED
Say: "✅ Prompt 406 verified successfully. Ready for Prompt 407."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 406.
