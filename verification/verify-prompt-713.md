# Verification for Prompt 713

## Task: Verify that Prompt 713 executed correctly

**Folder that was processed:** `migrations\\prisma\\migrations`
...
- Does it contain "Prompt 713: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `migrations\\prisma\\migrations`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 713: Executed"
...
## If PASSED
Say: "✅ Prompt 713 verified successfully. Ready for Prompt 714."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 713.
