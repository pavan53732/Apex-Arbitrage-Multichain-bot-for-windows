# Verification for Prompt 661

## Task: Verify that Prompt 661 executed correctly

**Folder that was processed:** `deploy\\terraform\\modules\\k8s`
...
- Does it contain "Prompt 661: Executed"?
- Is the completion count updated?

### Step 2: Identify which .md file should own this feature
Based on the folder path `deploy\\terraform\\modules\\k8s`, determine the owner:
...
✅/❌ Progress.md contains "Prompt 661: Executed"
...
## If PASSED
Say: "✅ Prompt 661 verified successfully. Ready for Prompt 662."

## If FAILED
List what needs to be fixed and suggest re-running Prompt 661.
