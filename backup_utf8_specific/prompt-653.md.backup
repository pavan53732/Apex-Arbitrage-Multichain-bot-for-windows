...
```
C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\deploy\kubernetes\overlays\staging
```
...
try {
    ...
    $targetPath = Join-Path $basePath "deploy\kubernetes\overlays\staging"
...
```
Feature #653: Ai Modules - Found 54 files across 10 folders
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\deploy\kubernetes\overlays\staging
