...
```
C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\ar\uploads\custom-ar-assets
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\ar\uploads\custom-ar-assets"
...
```
Feature #354: Ai Modules - Found 54 files across 10 folders
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\ar\uploads\custom-ar-assets
