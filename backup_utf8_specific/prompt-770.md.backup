...
```
C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\scripts
```
...
try {
    ...
    $targetPath = Join-Path $basePath "scripts"
...
```
Feature #770: Ai Modules - Found 54 files across 10 folders
