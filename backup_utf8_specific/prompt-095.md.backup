...
```
C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\examples\mainnet-tx-samples
```
...
try {
    ...
    $targetPath = Join-Path $basePath "backend\examples\mainnet-tx-samples"
...
```
Feature #95: Ai Modules - Found 54 files across 10 folders
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\backend\examples\mainnet-tx-samples
