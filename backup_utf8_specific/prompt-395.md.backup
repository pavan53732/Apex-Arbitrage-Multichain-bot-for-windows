...
```
C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\deploy\ansible\roles\ai-modules\backend
```
...
try {
    ...
    $targetPath = Join-Path $basePath "dashboard\deploy\ansible\roles\ai-modules\backend"
...
```
Feature #395: Ai Modules - Found 54 files across 10 folders
...
Full Path: C:\Users\Pavan pc\Desktop\Apex Arbitrage Multichain bot for windows\Apex-Arbitrage-Multichain-bot-for-windows\Apex Arbitrage Multichain bot\dashboard\deploy\ansible\roles\ai-modules\backend
